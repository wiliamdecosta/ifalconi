...
//Connection Settings @0-6F0367A0
...
//Conn_Pay Connection Class @-5090498F
class clsDBConn_Pay extends DB_Adapter
{
    function clsDBConn_Pay()
    {
        $this->Initialize();
    }
    ...
    {
        global $CCConnectionSettings;
        $this->SetProvider($CCConnectionSettings["Conn_Pay"]);
        parent::Initialize();
        $this->DateLeftDelimiter = "'";
        $this->DateRightDelimiter = "'";
        $this->query("ALTER SESSION SET NLS_DATE_FORMAT = 'YYYY-MM-DD HH24:MI:SS'");
