<?php
//Include Common Files @1-B0941194
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_cust_title.php");
...
//Operation Method @3-64E86EB5
    function Operation()
    {
        ...
        $Redirect = "lov_p_cust_title.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_cust_title.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_cust_title.html";
$BlockToParse = "main";
...
//Include events file @1-06426C92
include_once("./lov_p_cust_title_events.php");
