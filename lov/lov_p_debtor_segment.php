<?php
//Include Common Files @1-81405275
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_debtor_segment.php");
...
//Class_Initialize Event @2-E9699B67
    function clsGridP_DEBTOR_SEGMENT($RelativePath, & $Parent)
    {
        ...
        $this->P_DEBTOR_SEGMENT_ID = & new clsControl(ccsLabel, "P_DEBTOR_SEGMENT_ID", "P_DEBTOR_SEGMENT_ID", ccsText, "", CCGetRequestParam("P_DEBTOR_SEGMENT_ID", ccsGet, NULL), $this);
...
//DataSource Variables @2-6776B467
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-B650FA3B
...
//Open Method @2-9D9589F4
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT CODE, P_DEBTOR_SEGMENT_ID\n" .
        "FROM P_DEBTOR_SEGMENT\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') \n" .
        ") cnt";
        $this->SQL = "SELECT CODE, P_DEBTOR_SEGMENT_ID\n" .
        "FROM P_DEBTOR_SEGMENT\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') \n" .
        "";
...
//Class_Initialize Event @3-50B693DF
...
//Operation Method @3-28460AC5
    function Operation()
    {
        ...
        $Redirect = "lov_p_debtor_segment.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_debtor_segment.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_debtor_segment.html";
$BlockToParse = "main";
...
//Include events file @1-76F469E5
include_once("./lov_p_debtor_segment_events.php");
...
//Execute Components @1-A0B77DDB
$P_DEBTOR_SEGMENTSearch->Operation();
//End Execute Components

//Go to destination page @1-FFDD7998
if($Redirect)
{
