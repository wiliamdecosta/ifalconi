...
// -------------------------
	...
	$nilai=$P_BUSINESS_SEGMENT->P_BUSINESS_SEGMENT_ID->GetValue()."#~#".str_replace(" ","",$P_BUSINESS_SEGMENT->CODE->GetValue() );
	$P_BUSINESS_SEGMENT->Label1->SetValue("<input type=button value=PILIH class=Button onclick=clickReturn('".$nilai."')>");
