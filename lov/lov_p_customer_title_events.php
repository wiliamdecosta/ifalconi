...
// -------------------------
	...
	$nilai=$P_CUSTOMER_TITLE->P_CUSTOMER_TITLE_ID->GetValue()."#~#".str_replace(" ","_",$P_CUSTOMER_TITLE->CODE->GetValue());
	$P_CUSTOMER_TITLE->Label1->SetValue("<input type=button value=PILIH class=Button onclick=clickReturn('".$nilai."')>");
// -------------------------
//End Custom Code
