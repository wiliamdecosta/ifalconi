<?php
//Include Common Files @1-65C79542
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_bill_period.php");
...
class clsGridP_BILL_PERIOD_UNIT { //P_BILL_PERIOD_UNIT class @2-2CA16B36
...
//Class_Initialize Event @2-F6186FF3
    function clsGridP_BILL_PERIOD_UNIT($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "P_BILL_PERIOD_UNIT";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid P_BILL_PERIOD_UNIT";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsP_BILL_PERIOD_UNITDataSource($this);
...
} //End P_BILL_PERIOD_UNIT Class @2-FCB6E20C

class clsP_BILL_PERIOD_UNITDataSource extends clsDBConn {  //P_BILL_PERIOD_UNITDataSource Class @2-F2260ED3

//DataSource Variables @2-EEEC9469
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-44809CCF
    function clsP_BILL_PERIOD_UNITDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid P_BILL_PERIOD_UNIT";
        $this->Initialize();
...
} //End P_BILL_PERIOD_UNITDataSource Class @2-FCB6E20C
...
//Operation Method @3-38A0AAAB
    function Operation()
    {
        ...
        $Redirect = "lov_p_bill_period.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_bill_period.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_bill_period.html";
$BlockToParse = "main";
...
//Include events file @1-A22A3C06
include_once("./lov_p_bill_period_events.php");
...
// Controls
$P_BILL_PERIOD_UNIT = & new clsGridP_BILL_PERIOD_UNIT("", $MainPage);
$P_SERVICE_TYPESearch = & new clsRecordP_SERVICE_TYPESearch("", $MainPage);
$MainPage->P_BILL_PERIOD_UNIT = & $P_BILL_PERIOD_UNIT;
$MainPage->P_SERVICE_TYPESearch = & $P_SERVICE_TYPESearch;
$P_BILL_PERIOD_UNIT->Initialize();
...
//Go to destination page @1-14237099
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($P_BILL_PERIOD_UNIT);
...
//Show Page @1-871B7D5F
$P_BILL_PERIOD_UNIT->Show();
