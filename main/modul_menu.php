...
define("FileName", "modul_menu.php");
...
<td width="100%" style="text-align:center"><img border='0' height=64 src='<?echo $_GET["module_image"];?>'><br><b><?echo $_GET["p_application_code"]; ?></b></td>
	...
	<ul>
	<li style="text-align:left;padding:1px;border-top:1px dotted #363636"><a style="font-size:9pt;" href="../main/module.php" target="modul" style="text-decoration:none"><img border="0" src="../images/item_blue.gif"> HOME</a></li>
<?php
