...
//        $this->module_image->Page = "app_menu.php";
...
//Show Method @2-4E233F0F
    function Show()
    {
        ...
        $this->Attributes->SetValue("numberOfColumns", 5);
...
class clsModulGridDataSource extends clsDBConn {  //ModulGridDataSource Class @2-DF1BDE44
...
/*
        ...
        "FROM v_display_app) cnt";
        $this->SQL = "SELECT * \n" .
        "FROM v_display_app  {SQL_OrderBy}";
*/
