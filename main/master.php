...
class clstrbmenuDataSource extends clsDBDBConn {  //trbmenuDataSource Class @2-66851910
...
//Initialize Objects @1-ACD1B649
$DBDBConn = new clsDBDBConn();
$MainPage->Connections["DBConn"] = & $DBDBConn;
...
//Go to destination page @1-AC2F2856
if($Redirect)
{
