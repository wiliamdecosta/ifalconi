<?php
//Include Common Files @1-4B8B999E
define("RelativePath", "..");
...
//Class_Initialize Event @37-CDCE3FFD
...
//CheckErrors Method @37-86BB0C0F
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @37-71E4C8CD
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @37-420BDEA7
...
//Insert Method @37-D547AF4D
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_CUSTOMER_TITLE(P_CUSTOMER_TITLE_ID, CODE, P_TITLE_POSITION_ID, P_CUSTOMER_SEGMENT_ID, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY) \n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_CUSTOMER_TITLE','P_CUSTOMER_TITLE_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "'))," . $this->SQLValue($this->cp["P_TITLE_POSITION_ID"]->GetDBValue(), ccsFloat) . "," . $this->SQLValue($this->cp["P_CUSTOMER_SEGMENT_ID"]->GetDBValue(), ccsFloat) . ",'" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "',sysdate,'" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "',sysdate,'" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
