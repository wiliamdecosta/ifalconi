<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="p_job_type" name="P_JOB_TYPE" orderBy="P_JOB_TYPE_ID" pageSizeLimit="100" wizardCaption=" P JOB TYPE " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions">
			<Components>
				...
				<Label id="24" fieldSourceType="DBColumn" dataType="Date" html="False" name="CREATION_DATE" fieldSource="CREATION_DATE" wizardCaption="CREATION DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_JOB_TYPECREATION_DATE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="26" fieldSourceType="DBColumn" dataType="Text" html="False" name="CREATED_BY" fieldSource="CREATED_BY" wizardCaption="CREATED BY" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_JOB_TYPECREATED_BY">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="28" fieldSourceType="DBColumn" dataType="Date" html="False" name="UPDATED_DATE" fieldSource="UPDATED_DATE" wizardCaption="UPDATED DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_JOB_TYPEUPDATED_DATE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="30" fieldSourceType="DBColumn" dataType="Text" html="False" name="UPDATED_BY" fieldSource="UPDATED_BY" wizardCaption="UPDATED BY" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_JOB_TYPEUPDATED_BY">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="P_JOB_TYPE_Insert" hrefSource="../msu_msu_param/p_app_role.ccp" removeParameters="P_JOB_TYPE_ID;FLAG;s_keyword;P_JOB_TYPEPage;P_JOB_TYPEPageSize;P_JOB_TYPEOrder;P_JOB_TYPEDir" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="P_JOB_TYPEP_JOB_TYPE_Insert">
					<Components/>
					<Events>
			...
			<Events>
				<Event name="BeforeShowRow" type="Server">
					<Actions>
						<Action actionName="Set Row Style" actionCategory="General" id="59" styles="Row;AltRow" name="RowStyle"/>
			...
			<JoinLinks/>
			<Fields>
				<Field id="6" tableName="P_JOB_TYPE" fieldName="P_JOB_TYPE_ID"/>
				<Field id="19" tableName="P_JOB_TYPE" fieldName="CODE"/>
				<Field id="21" tableName="P_JOB_TYPE" fieldName="DESCRIPTION"/>
				<Field id="23" tableName="P_JOB_TYPE" fieldName="CREATION_DATE"/>
				<Field id="25" tableName="P_JOB_TYPE" fieldName="CREATED_BY"/>
				<Field id="27" tableName="P_JOB_TYPE" fieldName="UPDATED_DATE"/>
				<Field id="29" tableName="P_JOB_TYPE" fieldName="UPDATED_BY"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<SecurityGroups/>
...
WHERE  P_JOB_TYPE_ID = {P_JOB_TYPE_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_JOB_TYPE WHERE P_JOB_TYPE_ID = {P_JOB_TYPE_ID}">
			...
			<ISQLParameters>
				...
				<SQLParameter id="71" variable="CREATED_BY" parameterType="Control" dataType="Text" parameterSource="CREATED_BY"/>
				<SQLParameter id="72" variable="UPDATED_BY" parameterType="Control" dataType="Text" parameterSource="UPDATED_BY"/>
			</ISQLParameters>
			<IFormElements>
