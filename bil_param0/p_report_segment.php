<?php
//Include Common Files @1-A1209658
define("RelativePath", "..");
...
//Class_Initialize Event @2-3A4A5131
    function clsGridP_REPORT_SEGMENT($RelativePath, & $Parent)
    {
        ...
        $this->P_REPORT_SEGMENT_ID = & new clsControl(ccsHidden, "P_REPORT_SEGMENT_ID", "P_REPORT_SEGMENT_ID", ccsFloat, "", CCGetRequestParam("P_REPORT_SEGMENT_ID", ccsGet, NULL), $this);
...
//DataSourceClass_Initialize Event @2-C9A8DCA3
    function clsP_REPORT_SEGMENTDataSource(& $Parent)
    {
        ...
        $this->P_REPORT_SEGMENT_ID = new clsField("P_REPORT_SEGMENT_ID", ccsFloat, "");
        

    }
//End DataSourceClass_Initialize Event

//SetOrder Method @2-4046ED86
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "P_REPORT_SEGMENT_ID";
...
//Open Method @2-0F5FE012
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM p_report_segment";
        $this->SQL = "SELECT P_REPORT_SEGMENT_ID, CODE, REPORT_LABEL, LISTING_NO, DESCRIPTION \n\n" .
...
//SetValues Method @2-1104A0E8
    function SetValues()
    {
        ...
        $this->P_REPORT_SEGMENT_ID->SetDBValue(trim($this->f("P_REPORT_SEGMENT_ID")));
    }
...
class clsRecordp_report_segment1 { //p_report_segment1 Class @25-FDC78E29
...
//Class_Initialize Event @25-164F29BB
    function clsRecordp_report_segment1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->REPORT_LABEL = & new clsControl(ccsTextBox, "REPORT_LABEL", "REPORT LABEL", ccsText, "", CCGetRequestParam("REPORT_LABEL", $Method, NULL), $this);
            ...
            $this->P_REPORT_SEGMENT_ID = & new clsControl(ccsHidden, "P_REPORT_SEGMENT_ID", "P_REPORT_SEGMENT_ID", ccsFloat, "", CCGetRequestParam("P_REPORT_SEGMENT_ID", $Method, NULL), $this);
            if(!$this->FormSubmitted) {
...
//CheckErrors Method @25-9E904264
    function CheckErrors()
    {
        $errors = false;
...
} //End p_report_segment1 Class @25-FCB6E20C

class clsp_report_segment1DataSource extends clsDBConn {  //p_report_segment1DataSource Class @25-B727585D

//DataSource Variables @25-9F18E85F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @25-EF4BDDCE
...
//Prepare Method @25-E87E13E4
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlP_REPORT_SEGMENT_ID", ccsFloat, "", "", $this->Parameters["urlP_REPORT_SEGMENT_ID"], "", false);
...
//Insert Method @25-FE462F93
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_REPORT_SEGMENT(P_REPORT_SEGMENT_ID, CODE, REPORT_LABEL, LISTING_NO, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY)\n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_REPORT_SEGMENT','P_REPORT_SEGMENT_ID'),'" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "','" . $this->SQLValue($this->cp["REPORT_LABEL"]->GetDBValue(), ccsText) . "'," . $this->SQLValue($this->cp["LISTING_NO"]->GetDBValue(), ccsFloat) . ",'" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
...
} //End p_report_segment1DataSource Class @25-FCB6E20C
