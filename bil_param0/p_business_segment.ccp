...
<Label id="22" fieldSourceType="DBColumn" dataType="Text" html="False" name="OLD_CODE" fieldSource="OLD_CODE" wizardCaption="OLD CODE" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_BUSINESS_SEGMENTOLD_CODE">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
" errorSummator="Error" wizardCaption=" P Business Segment " wizardFormMethod="post" PathID="p_business_segment1" pasteActions="pasteActions" customInsertType="SQL" customInsert="INSERT INTO P_BUSINESS_SEGMENT (P_BUSINESS_SEGMENT_ID, CODE, OLD_CODE, P_CUSTOMER_SEGMENT_ID, DESCRIPTION, UPDATE_DATE, UPDATE_BY) 
VALUES
(GENERATE_ID('TRB','P_BUSINESS_SEGMENT','P_BUSINESS_SEGMENT_ID'),UPPER(TRIM('{CODE}')),UPPER(TRIM('{OLD_CODE}')),{P_CUSTOMER_SEGMENT_ID},INITCAP(TRIM('{DESCRIPTION}')),sysdate, '{UPDATE_BY}')" parameterTypeListName="ParameterTypeList" activeCollection="SQLParameters" customUpdateType="SQL" customUpdate="UPDATE P_BUSINESS_SEGMENT SET 
...
<TextBox id="40" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="OLD_CODE" fieldSource="OLD_CODE" required="False" caption="OLD CODE" wizardCaption="OLD CODE" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_business_segment1OLD_CODE">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
<SQLParameter id="84" variable="OLD_CODE" parameterType="Control" dataType="Text" parameterSource="OLD_CODE"/>
