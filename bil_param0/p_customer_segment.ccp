<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="p_customer_segment" name="P_CUSTOMER_SEGMENT" orderBy="P_CUSTOMER_SEGMENT_ID" pageSizeLimit="100" wizardCaption=" P CUSTOMER SEGMENT " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions">
			<Components>
				...
				<Label id="22" fieldSourceType="DBColumn" dataType="Text" html="False" name="OLD_CODE" fieldSource="OLD_CODE" wizardCaption="OLD CODE" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_CUSTOMER_SEGMENTOLD_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<JoinLinks/>
			<Fields>
				<Field id="6" tableName="P_CUSTOMER_SEGMENT" fieldName="P_CUSTOMER_SEGMENT_ID"/>
				<Field id="19" tableName="P_CUSTOMER_SEGMENT" fieldName="CODE"/>
				<Field id="21" tableName="P_CUSTOMER_SEGMENT" fieldName="OLD_CODE"/>
				<Field id="23" tableName="P_CUSTOMER_SEGMENT" fieldName="DESCRIPTION"/>
				<Field id="25" tableName="P_CUSTOMER_SEGMENT" fieldName="UPDATE_DATE"/>
				<Field id="27" tableName="P_CUSTOMER_SEGMENT" fieldName="UPDATE_BY"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<SecurityGroups/>
...
WHERE  P_CUSTOMER_SEGMENT_ID = {P_CUSTOMER_SEGMENT_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_CUSTOMER_SEGMENT WHERE P_CUSTOMER_SEGMENT_ID = {P_CUSTOMER_SEGMENT_ID}">
			<Components>
				...
				<TextBox id="38" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="OLD_CODE" fieldSource="OLD_CODE" required="False" caption="OLD CODE" wizardCaption="OLD CODE" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_customer_segment1OLD_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
