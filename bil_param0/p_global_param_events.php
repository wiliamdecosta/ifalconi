...
// -------------------------
	...
	$P_GLOBAL_PARAM->P_GLOBAL_PARAM_Insert->Parameters = CCRemoveParam($P_GLOBAL_PARAM->P_GLOBAL_PARAM_Insert->Parameters, "P_GLOBAL_PARAM_ID");
...
// -------------------------
    // Write your own code here.
	$keyId = CCGetFromGet("P_GLOBAL_PARAM_ID", "");
	$sCode = CCGetFromGet("s_keyword", "");
	global $id;
	if (empty($keyId)) {
		if (empty($id)) {
			$id = $P_GLOBAL_PARAM->P_GLOBAL_PARAM_ID->GetValue();
		}
		global $FileName;
		global $PathToCurrentPage;
		$param = CCGetQueryString("QueryString", "");
		$param = CCAddParam($param, "P_GLOBAL_PARAM_ID", $id);
	...
	if ($P_GLOBAL_PARAM->P_GLOBAL_PARAM_ID->GetValue() == $keyId) {
