...
where a.p_job_position_id=b.p_job_position_id
and a.P_ACCOUNT_REP_ID={P_ACCOUNT_REP_ID}" errorSummator="Error" wizardCaption=" P Account Rep " wizardFormMethod="post" PathID="p_account_rep1" pasteActions="pasteActions" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="SQLParameters" customInsert="INSERT INTO P_ACCOUNT_REP(P_ACCOUNT_REP_ID, ACCOUNT_NAME, EMPLOYEE_NO, P_JOB_POSITION_ID, VALID_FROM, VALID_TO, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY)
VALUES
(GENERATE_ID('TRB','P_ACCOUNT_REP','P_ACCOUNT_REP_ID'),UPPER(TRIM('{ACCOUNT_NAME}')),'{EMPLOYEE_NO}',{P_JOB_POSITION_ID},'{VALID_FROM}','{VALID_TO}','{DESCRIPTION}',sysdate, '{CREATED_BY}',sysdate, '{UPDATED_BY}')" customUpdateType="SQL" customUpdate="UPDATE P_ACCOUNT_REP SET 
