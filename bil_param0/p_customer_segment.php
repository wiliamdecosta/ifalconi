<?php
//Include Common Files @1-199EAB1B
define("RelativePath", "..");
...
//Class_Initialize Event @2-2F806A43
    function clsGridP_CUSTOMER_SEGMENT($RelativePath, & $Parent)
    {
        ...
        $this->P_CUSTOMER_SEGMENT_ID = & new clsControl(ccsLink, "P_CUSTOMER_SEGMENT_ID", "P_CUSTOMER_SEGMENT_ID", ccsFloat, "", CCGetRequestParam("P_CUSTOMER_SEGMENT_ID", ccsGet, NULL), $this);
        $this->P_CUSTOMER_SEGMENT_ID->Page = "p_customer_segment.php";
...
//DataSource Variables @2-762171C2
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-BDAC9247
...
//Open Method @2-DED1BC31
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM p_customer_segment";
        $this->SQL = "SELECT P_CUSTOMER_SEGMENT_ID, CODE, OLD_CODE, DESCRIPTION, UPDATE_DATE, UPDATE_BY \n\n" .
...
//Class_Initialize Event @3-63C929F9
...
//Class_Initialize Event @30-1661F9DF
...
//CheckErrors Method @30-DBF690E4
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @30-CDBF4179
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @30-37200EAD
...
//Insert Method @30-17792FDE
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_CUSTOMER_SEGMENT (P_CUSTOMER_SEGMENT_ID,CODE,OLD_CODE,DESCRIPTION,UPDATE_DATE, UPDATE_BY) \n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_CUSTOMER_SEGMENT','P_CUSTOMER_SEGMENT_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "')),UPPER(TRIM('" . $this->SQLValue($this->cp["OLD_CODE"]->GetDBValue(), ccsText) . "')),INITCAP(TRIM('" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "')),sysdate, '" . $this->SQLValue($this->cp["UPDATE_BY"]->GetDBValue(), ccsText) . "')";
