<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="select a.*,b.code as p_job_type_name from p_job a , p_job_type b
where a.p_job_type_id=b.p_job_type_id(+)
and upper(a.code) like upper('%{s_keyword}%')" name="P_JOB" orderBy="P_JOB_ID" pageSizeLimit="100" wizardCaption=" P JOB " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions">
			<Components>
...
where a.p_job_type_id=b.p_job_type_id(+)
and a.P_JOB_ID={P_JOB_ID}" errorSummator="Error" wizardCaption=" P Job " wizardFormMethod="post" PathID="p_job1" pasteActions="pasteActions" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="SQLParameters" customInsert="INSERT INTO P_JOB(P_JOB_ID, CODE, PROCEDURE_NAME, LISTING_NO, IS_PARALLEL, PARALLEL_DEGREE, IS_FINISH, P_JOB_TYPE_ID, IS_CANCELLED_PROCESS, IS_REPROCESS, PARENT_ID, CANCEL_PARENT_ID, CONTROL_TABLE_NAME, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY) 
VALUES
(GENERATE_ID('TRB','P_JOB','P_JOB_ID'),'{CODE}','{PROCEDURE_NAME}',{LISTING_NO},'{IS_PARALLEL}',{PARALLEL_DEGREE},'{IS_FINISH}',{P_JOB_TYPE_ID},'{IS_CANCELLED_PROCESS}','{IS_REPROCESS}',{PARENT_ID},{CANCEL_PARENT_ID},'{CONTROL_TABLE_NAME}','{DESCRIPTION}', sysdate, '{CREATED_BY}', sysdate, '{UPDATED_BY}') " customUpdateType="SQL" customUpdate="UPDATE P_JOB SET 
CODE='{CODE}',
...
<TextBox id="45" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="IS_CANCELLED_PROCESS" fieldSource="IS_CANCELLED_PROCESS" required="True" caption="IS CANCELLED PROCESS" wizardCaption="IS CANCELLED PROCESS" wizardSize="1" wizardMaxLength="1" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_job1IS_CANCELLED_PROCESS">
				...
				<TextBox id="53" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="CREATED_BY" fieldSource="CREATED_BY" required="True" caption="CREATED BY" wizardCaption="CREATED BY" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_job1CREATED_BY" defaultValue="CCGetUserLogin()">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="56" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="UPDATED_BY" fieldSource="UPDATED_BY" required="True" caption="UPDATED BY" wizardCaption="UPDATED BY" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_job1UPDATED_BY" defaultValue="CCGetUserLogin()">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<SQLParameter id="140" parameterType="URL" variable="P_JOB_ID" dataType="Float" parameterSource="P_JOB_ID"/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="93" variable="PARALLEL_DEGREE" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="PARALLEL_DEGREE"/>
				...
				<SQLParameter id="98" variable="PARENT_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="PARENT_ID"/>
				<SQLParameter id="99" variable="CANCEL_PARENT_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="CANCEL_PARENT_ID"/>
				...
				<SQLParameter id="102" variable="CREATED_BY" parameterType="Control" dataType="Text" parameterSource="CREATED_BY"/>
			...
			<USQLParameters>
				...
				<SQLParameter id="123" variable="LISTING_NO" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="LISTING_NO"/>
				...
				<SQLParameter id="130" variable="PARENT_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="PARENT_ID"/>
				<SQLParameter id="131" variable="CANCEL_PARENT_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="CANCEL_PARENT_ID"/>
				...
				<SQLParameter id="134" variable="UPDATED_BY" parameterType="Control" dataType="Text" parameterSource="UPDATED_BY"/>
