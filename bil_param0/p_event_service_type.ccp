<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="select a.*,b.code as p_service_type_name,c.code as p_event_type_name from p_event_service_type a , p_service_type b , p_event_type c
where a.p_service_type_id=b.p_service_type_id
and a.p_event_type_id=c.p_event_type_id
and ( upper(b.code) like upper('%{s_keyword}%') or upper(c.code) like upper('%{s_keyword}%') )" name="P_EVENT_SERVICE_TYPE" orderBy="P_EVENT_SERVICE_TYPE_ID" pageSizeLimit="100" wizardCaption=" P EVENT SERVICE TYPE " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions">
<Components>
<Label id="18" fieldSourceType="DBColumn" dataType="Text" html="False" name="P_SERVICE_TYPE_NAME" fieldSource="P_SERVICE_TYPE_NAME" wizardCaption="P SERVICE TYPE ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="P_EVENT_SERVICE_TYPEP_SERVICE_TYPE_NAME">
<Components/>
<Events/>
<Attributes/>
<Features/>
</Label>
<Label id="20" fieldSourceType="DBColumn" dataType="Text" html="False" name="P_EVENT_TYPE_NAME" fieldSource="P_EVENT_TYPE_NAME" wizardCaption="P EVENT TYPE ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="P_EVENT_SERVICE_TYPEP_EVENT_TYPE_NAME">
<Components/>
<Events/>
<Attributes/>
<Features/>
</Label>
<Label id="22" fieldSourceType="DBColumn" dataType="Date" html="False" name="RATED_VALID_FROM" fieldSource="RATED_VALID_FROM" wizardCaption="RATED VALID FROM" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_EVENT_SERVICE_TYPERATED_VALID_FROM">
<Components/>
<Events/>
<Attributes/>
<Features/>
</Label>
<Label id="24" fieldSourceType="DBColumn" dataType="Date" html="False" name="RATED_VALID_TO" fieldSource="RATED_VALID_TO" wizardCaption="RATED VALID TO" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_EVENT_SERVICE_TYPERATED_VALID_TO">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
<Record id="28" sourceType="SQL" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Conn" name="p_event_service_type1" dataSource="select a.*,b.code as p_service_type_name,c.code as p_event_type_name from p_event_service_type a , p_service_type b , p_event_type c
where a.p_service_type_id=b.p_service_type_id
and a.p_event_type_id=c.p_event_type_id
and a.P_EVENT_SERVICE_TYPE_ID={P_EVENT_SERVICE_TYPE_ID}" errorSummator="Error" wizardCaption=" P Event Service Type " wizardFormMethod="post" PathID="p_event_service_type1" pasteActions="pasteActions" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="SQLParameters" customInsert="INSERT INTO P_EVENT_SERVICE_TYPE(P_EVENT_SERVICE_TYPE_ID, P_SERVICE_TYPE_ID, P_EVENT_TYPE_ID, RATED_VALID_FROM, RATED_VALID_TO, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY)
VALUES
(GENERATE_ID('TRB','P_EVENT_SERVICE_TYPE','P_EVENT_SERVICE_TYPE_ID'),{P_SERVICE_TYPE_ID},{P_EVENT_TYPE_ID},'{RATED_VALID_FROM}','{RATED_VALID_TO}','{DESCRIPTION}',sysdate,'{CREATED_BY}',sysdate, '{UPDATED_BY}')" customDeleteType="SQL" customDelete="DELETE FROM P_EVENT_SERVICE_TYPE WHERE P_EVENT_SERVICE_TYPE_ID = {P_EVENT_SERVICE_TYPE_ID}" customUpdateType="SQL" customUpdate="UPDATE P_EVENT_SERVICE_TYPE SET 
P_SERVICE_TYPE_ID={P_SERVICE_TYPE_ID},
P_EVENT_TYPE_ID={P_EVENT_TYPE_ID},
RATED_VALID_FROM='{RATED_VALID_FROM}',
RATED_VALID_TO='{RATED_VALID_TO}',
DESCRIPTION=INITCAP(TRIM('{DESCRIPTION}')),
UPDATED_DATE=sysdate,
UPDATED_BY='{UPDATED_BY}'
WHERE  P_EVENT_SERVICE_TYPE_ID = {P_EVENT_SERVICE_TYPE_ID}"><Components><Hidden id="35" visible="Yes" fieldSourceType="DBColumn" dataType="Float" name="P_SERVICE_TYPE_ID" fieldSource="P_SERVICE_TYPE_ID" required="True" caption="P SERVICE TYPE ID" wizardCaption="P SERVICE TYPE ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_event_service_type1P_SERVICE_TYPE_ID">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
<TextBox id="39" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="RATED_VALID_TO" fieldSource="RATED_VALID_TO" required="False" caption="RATED VALID TO" wizardCaption="RATED VALID TO" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_event_service_type1RATED_VALID_TO">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
<SQLParameter id="74" variable="RATED_VALID_FROM" parameterType="Control" defaultValue="00-00-0000" dataType="Date" parameterSource="RATED_VALID_FROM"/>
<SQLParameter id="75" variable="RATED_VALID_TO" parameterType="Control" defaultValue="00-00-0000" dataType="Date" parameterSource="RATED_VALID_TO"/>
...
<SQLParameter id="104" variable="RATED_VALID_FROM" parameterType="Control" defaultValue="00-00-0000" dataType="Date" parameterSource="RATED_VALID_FROM"/>
<SQLParameter id="105" variable="RATED_VALID_TO" parameterType="Control" defaultValue="00-00-0000" dataType="Date" parameterSource="RATED_VALID_TO"/>
