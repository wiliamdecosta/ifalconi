<?php
//Include Common Files @1-FE3DF694
define("RelativePath", "..");
...
//Class_Initialize Event @2-6A21628F
    function clsGridP_BUSINESS_SEGMENT($RelativePath, & $Parent)
    {
        ...
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 6, tpMoving, $this);
...
//DataSource Variables @2-5804637C
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-1E8A0B35
...
//Open Method @2-87D181CE
    function Open()
    {
        ...
        "A.P_CUSTOMER_SEGMENT_ID=B.P_CUSTOMER_SEGMENT_ID and a.code like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') cnt";
        $this->SQL = "select a.*,B.CODE as p_customer_segment_name from p_business_segment a , p_customer_segment b where\n" .
        "A.P_CUSTOMER_SEGMENT_ID=B.P_CUSTOMER_SEGMENT_ID and a.code like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'";
...
//Class_Initialize Event @3-AEBAA2DC
...
//Class_Initialize Event @32-0E29F665
...
//CheckErrors Method @32-7F6F671E
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @32-5B96886F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @32-8CD033EE
...
//Insert Method @32-94961141
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_BUSINESS_SEGMENT (P_BUSINESS_SEGMENT_ID, CODE, OLD_CODE, P_CUSTOMER_SEGMENT_ID, DESCRIPTION, UPDATE_DATE, UPDATE_BY) \n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_BUSINESS_SEGMENT','P_BUSINESS_SEGMENT_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "')),UPPER(TRIM('" . $this->SQLValue($this->cp["OLD_CODE"]->GetDBValue(), ccsText) . "'))," . $this->SQLValue($this->cp["P_CUSTOMER_SEGMENT_ID"]->GetDBValue(), ccsFloat) . ",INITCAP(TRIM('" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "')),sysdate, '" . $this->SQLValue($this->cp["UPDATE_BY"]->GetDBValue(), ccsText) . "')";
