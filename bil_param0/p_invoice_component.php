<?php
//Include Common Files @1-3688EAD3
define("RelativePath", "..");
...
//Class_Initialize Event @2-37C7C14E
    function clsGridP_INVOICE_COMPONENT($RelativePath, & $Parent)
    {
        ...
        $this->ADLink->Page = "p_invoice_component.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->ADLink->Parameters = CCAddParam($this->ADLink->Parameters, "P_INVOICE_COMPONENT_ID", $this->DataSource->f("P_INVOICE_COMPONENT_ID"));
        ...
        $this->P_INVOICE_COMPONENT_Insert->Parameters = CCAddParam($this->P_INVOICE_COMPONENT_Insert->Parameters, "FLAG", "ADD");
        $this->Navigator->Show();
...
//DataSource Variables @2-A58C42ED
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-761D3ED1
...
//SetValues Method @2-8FDEA5FC
    function SetValues()
    {
        ...
        $this->DLink->SetDBValue($this->f("P_INVOICE_COMPONENT_ID"));
        $this->ADLink->SetDBValue($this->f("P_INVOICE_COMPONENT_ID"));
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_invoice_component.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
class clsRecordp_invoice_component1 { //p_invoice_component1 Class @25-015AAEE6
...
//Class_Initialize Event @25-C19C7679
    function clsRecordp_invoice_component1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->IS_RETURNABLE = & new clsControl(ccsTextBox, "IS_RETURNABLE", "IS RETURNABLE", ccsText, "", CCGetRequestParam("IS_RETURNABLE", $Method, NULL), $this);
            ...
            $this->P_INVOICE_COMPONENT_ID = & new clsControl(ccsHidden, "P_INVOICE_COMPONENT_ID", "CODE", ccsFloat, "", CCGetRequestParam("P_INVOICE_COMPONENT_ID", $Method, NULL), $this);
            if(!$this->FormSubmitted) {
...
//CheckErrors Method @25-E1489173
    function CheckErrors()
    {
        $errors = false;
...
} //End p_invoice_component1 Class @25-FCB6E20C

class clsp_invoice_component1DataSource extends clsDBConn {  //p_invoice_component1DataSource Class @25-0AF91BFB

//DataSource Variables @25-A30969CB
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @25-36E4E7BA
...
//Insert Method @25-0E200002
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_INVOICE_COMPONENT(P_INVOICE_COMPONENT_ID, CODE, PAYMENT_PRIORITY, IS_RETURNABLE, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY)\n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_INVOICE_COMPONENT','P_INVOICE_COMPONENT_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "'))," . $this->SQLValue($this->cp["PAYMENT_PRIORITY"]->GetDBValue(), ccsFloat) . ",'" . $this->SQLValue($this->cp["IS_RETURNABLE"]->GetDBValue(), ccsText) . "','" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
...
//Delete Method @25-A0C67009
    function Delete()
    {
        ...
        if (!strlen($this->cp["P_INVOICE_COMPONENT_ID"]->GetText()) and !is_bool($this->cp["P_INVOICE_COMPONENT_ID"]->GetValue(true))) 
            $this->cp["P_INVOICE_COMPONENT_ID"]->SetText(0);
        $this->SQL = "DELETE FROM P_INVOICE_COMPONENT WHERE P_INVOICE_COMPONENT_ID = " . $this->SQLValue($this->cp["P_INVOICE_COMPONENT_ID"]->GetDBValue(), ccsFloat) . "";
...
} //End p_invoice_component1DataSource Class @25-FCB6E20C
