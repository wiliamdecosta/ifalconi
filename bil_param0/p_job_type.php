<?php
//Include Common Files @1-5D655402
define("RelativePath", "..");
...
//Class_Initialize Event @2-42CDDB72
    function clsGridP_JOB_TYPE($RelativePath, & $Parent)
    {
        ...
        $this->P_JOB_TYPE_ID = & new clsControl(ccsLink, "P_JOB_TYPE_ID", "P_JOB_TYPE_ID", ccsFloat, "", CCGetRequestParam("P_JOB_TYPE_ID", ccsGet, NULL), $this);
        $this->P_JOB_TYPE_ID->Page = "p_job_type.php";
        ...
        $this->P_JOB_TYPE_Insert->Page = "p_app_role.php";
    }
...
//DataSource Variables @2-430E0717
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-B997BB57
...
//SetOrder Method @2-0C597042
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "P_JOB_TYPE_ID";
...
//Open Method @2-21881CC8
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM p_job_type";
        $this->SQL = "SELECT P_JOB_TYPE_ID, CODE, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY \n\n" .
...
//Class_Initialize Event @32-9FDA49A7
...
//CheckErrors Method @32-1E8E648F
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @32-DFE57C8E
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @32-C6D26EF0
...
//Insert Method @32-9F87D7E8
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_JOB_TYPE (P_JOB_TYPE_ID,CODE,DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY) \n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_JOB_TYPE','P_JOB_TYPE_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "')),INITCAP(TRIM('" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "')), sysdate, '" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "', sysdate, '" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
