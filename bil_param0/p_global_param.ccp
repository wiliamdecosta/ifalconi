<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="select * from p_global_param
...
<Link id="45" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="P_GLOBAL_PARAMDLink" hrefSource="p_global_param.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="P_GLOBAL_PARAM_ID">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="54" sourceType="DataField" name="P_GLOBAL_PARAM_ID" source="P_GLOBAL_PARAM_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
<Link id="55" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="P_GLOBAL_PARAMADLink" hrefSource="p_global_param.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="P_GLOBAL_PARAM_ID">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="56" sourceType="DataField" format="yyyy-mm-dd" name="P_GLOBAL_PARAM_ID" source="P_GLOBAL_PARAM_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
<Hidden id="15" visible="Yes" fieldSourceType="DBColumn" dataType="Float" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="P_GLOBAL_PARAM_ID" fieldSource="P_GLOBAL_PARAM_ID" wizardCaption="ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" hrefSource="p_global_param.ccp" wizardThemeItem="GridA" PathID="P_GLOBAL_PARAMP_GLOBAL_PARAM_ID">
<Components/>
<Events/>
<LinkParameters>
<LinkParameter id="16" sourceType="DataField" format="yyyy-mm-dd" name="P_GLOBAL_PARAM_ID" source="P_GLOBAL_PARAM_ID"/>
</LinkParameters>
<Attributes/>
<Features/>
</Hidden>
...
<Record id="28" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Conn" name="p_global_param1" dataSource="p_global_param" errorSummator="Error" wizardCaption=" P Global Param " wizardFormMethod="post" PathID="p_global_param1" pasteActions="pasteActions" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="DSQLParameters" customInsert="INSERT INTO P_GLOBAL_PARAM(P_GLOBAL_PARAM_ID, CODE, VALUE, TYPE_1, IS_RANGE, VALUE_2, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY) 
VALUES
(GENERATE_ID('TRB','P_GLOBAL_PARAM','P_GLOBAL_PARAM_ID'),'{CODE}','{VALUE}','{TYPE_1}','{IS_RANGE}','{VALUE_2}','{DESCRIPTION}', sysdate, '{CREATED_BY}', sysdate, '{UPDATED_BY}') " customUpdateType="SQL" customUpdate="UPDATE P_GLOBAL_PARAM SET 
CODE='{CODE}',
VALUE='{VALUE}',
TYPE_1='{TYPE_1}',
IS_RANGE='{IS_RANGE}',
...
WHERE  P_GLOBAL_PARAM_ID = {P_GLOBAL_PARAM_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_GLOBAL_PARAM WHERE P_GLOBAL_PARAM_ID = {P_GLOBAL_PARAM_ID}">
<Components>
...
<TextBox id="37" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="TYPE_1" fieldSource="TYPE_1" required="False" caption="TYPE 1" wizardCaption="TYPE 1" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_global_param1TYPE_1">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
<TextBox id="41" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="CREATION_DATE" fieldSource="CREATION_DATE" required="True" caption="CREATION DATE" wizardCaption="CREATION DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_global_param1CREATION_DATE" format="dd-mmm-yyyy" defaultValue="date(&quot;d-M-Y&quot;)">
<Components/>
<Events/>
<Attributes/>
<Features/>
</TextBox>
<TextBox id="44" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="UPDATED_DATE" fieldSource="UPDATED_DATE" required="True" caption="UPDATED DATE" wizardCaption="UPDATED DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_global_param1UPDATED_DATE" format="dd-mmm-yyyy" defaultValue="date(&quot;d-M-Y&quot;)">
<Components/>
<Events/>
<Attributes/>
<Features/>
</TextBox>
<Hidden id="96" visible="Yes" fieldSourceType="DBColumn" dataType="Float" name="P_GLOBAL_PARAM_ID" fieldSource="P_GLOBAL_PARAM_ID" required="False" caption="CODE" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_global_param1P_GLOBAL_PARAM_ID">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
<SQLParameter id="73" variable="TYPE_1" parameterType="Control" dataType="Text" parameterSource="TYPE_1"/>
...
<SQLParameter id="91" variable="TYPE_1" parameterType="Control" dataType="Text" parameterSource="TYPE_1"/>
...
<SQLParameter id="97" variable="P_GLOBAL_PARAM_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="P_GLOBAL_PARAM_ID"/>
</USQLParameters>
<UConditions/>
<UFormElements>
...
<DSPParameters/>
<DSQLParameters>
<SQLParameter id="98" variable="P_GLOBAL_PARAM_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="P_GLOBAL_PARAM_ID"/>
</DSQLParameters>
<DConditions/>
<SecurityGroups/>
<Attributes/>
