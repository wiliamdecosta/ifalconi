<?php
//Include Common Files @1-070F7674
define("RelativePath", "..");
...
//Class_Initialize Event @31-070BD138
...
//CheckErrors Method @31-C4708AD6
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @31-AC292826
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @31-38D59243
...
//Insert Method @31-D15C8D6D
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_ACCOUNT_REP(P_ACCOUNT_REP_ID, ACCOUNT_NAME, EMPLOYEE_NO, P_JOB_POSITION_ID, VALID_FROM, VALID_TO, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY)\n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_ACCOUNT_REP','P_ACCOUNT_REP_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["ACCOUNT_NAME"]->GetDBValue(), ccsText) . "')),'" . $this->SQLValue($this->cp["EMPLOYEE_NO"]->GetDBValue(), ccsText) . "'," . $this->SQLValue($this->cp["P_JOB_POSITION_ID"]->GetDBValue(), ccsFloat) . ",'" . $this->SQLValue($this->cp["VALID_FROM"]->GetDBValue(), ccsDate) . "','" . $this->SQLValue($this->cp["VALID_TO"]->GetDBValue(), ccsDate) . "','" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
