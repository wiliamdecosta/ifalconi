<?php
//Include Common Files @1-FC4407F9
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_data/");
define("FileName", "customer_info.php");
...
//Class_Initialize Event @2-5B47767E
    function clsGridCUSTOMER_INFOgrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "customer_info.php";
        ...
        $this->P_CUSTOMERINFO_Insert->Page = "customer_info.php";
    }
...
//Open Method @2-24AB408D
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM V_CUSTOMER_INFO\n" .
        "WHERE CUSTOMER_ID = " . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . "\n" .
        ") cnt";
...
//Operation Method @97-9805B5E4
    function Operation()
    {
        ...
        $Redirect = "customer_info.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "customer_info.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "CUSTOMER_INFO_ID"));
            if(!CCGetEvent($this->Button_Delete->CCSEvents, "OnClick", $this->Button_Delete) || !$this->DeleteRow()) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "Button_Cancel") {
            $Redirect = "customer_info.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH"));
...
//Update Method @97-57FF6FBD
    function Update()
    {
        ...
        $this->cp["INFO_DESC_2"] = new clsSQLParameter("ctrlINFO_DESC_2", ccsText, "", "", $this->INFO_DESC_2->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["INFO_DESC_3"] = new clsSQLParameter("ctrlINFO_DESC_3", ccsText, "", "", $this->INFO_DESC_3->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["INFO_TYPE_ID"] = new clsSQLParameter("ctrlINFO_TYPE_ID", ccsFloat, "", "", $this->INFO_TYPE_ID->GetValue(true), 0, false, $this->ErrorBlock);
        ...
        if (!is_null($this->cp["INFO_TYPE_ID"]->GetValue()) and !strlen($this->cp["INFO_TYPE_ID"]->GetText()) and !is_bool($this->cp["INFO_TYPE_ID"]->GetValue())) 
            $this->cp["INFO_TYPE_ID"]->SetValue($this->INFO_TYPE_ID->GetValue(true));
        if (!strlen($this->cp["INFO_TYPE_ID"]->GetText()) and !is_bool($this->cp["INFO_TYPE_ID"]->GetValue(true))) 
            $this->cp["INFO_TYPE_ID"]->SetText(0);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "customer_info.html";
$BlockToParse = "main";
...
//Include events file @1-0C3A0ACB
include_once("./customer_info_events.php");
...
//Execute Components @1-F2FE6AF1
$CUSTOMER_INFOrecord->Operation();
$Customer_Inf->Operation();
//End Execute Components

//Go to destination page @1-A2B08DD5
if($Redirect)
{
