<?php
//Include Common Files @1-0CC180BD
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_data/");
define("FileName", "customer_master.php");
...
//Class_Initialize Event @2-C1005D3C
    function clsGridV_CUSTOMER($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "customer_master.php";
        ...
        $this->P_CUSTOMER_Insert->Page = "customer_master.php";
    }
...
//Class_Initialize Event @3-BA33CD21
...
//Operation Method @3-2C1C2224
    function Operation()
    {
        ...
        $Redirect = "customer_master.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "customer_master.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Operation Method @97-89A84518
    function Operation()
    {
        ...
        $Redirect = "customer_master.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "customer_master.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH"));
            ...
            if($this->PressedButton == "Button_Insert") {
                $Redirect = "customer_master.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "s_keyword"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "customer_master.html";
$BlockToParse = "main";
...
//Include events file @1-EEE034BA
include_once("./customer_master_events.php");
