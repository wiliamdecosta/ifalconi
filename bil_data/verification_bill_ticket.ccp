...
WHERE VERIFICATION_DATE IS NULL AND (UPPER(to_char(TICKET_DATE,'dd-MON-yyyy')) LIKE UPPER('%{s_keyword}%') OR
	...
	UPPER(DESCRIPTION) LIKE UPPER('%{s_keyword}%'))">
			<Components>
				...
				<Link id="52" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="ENTRY_BILL_TICKETDLink" hrefSource="verification_bill_ticket.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="T_BILL_TICKET_ID">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="54" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="ENTRY_BILL_TICKETADLink" hrefSource="verification_bill_ticket.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="T_BILL_TICKET_ID">
					<Components/>
					<Events/>
					<LinkParameters>
...
WHERE T_BILL_TICKET_ID = {T_BILL_TICKET_ID}">
			<Components>
				...
				<ListBox id="306" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="IS_OK" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="BATCH1IS_OK" fieldSource="IS_OK" sourceType="ListOfValues" connection="Conn" _valueOfList="N" _nameOfList="NO" dataSource="Y;YES;N;NO">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="318" fieldSourceType="DBColumn" dataType="Text" html="True" name="Label1" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="BATCH1Label1">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="verification_bill_ticket_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="verification_bill_ticket.php" forShow="True" url="verification_bill_ticket.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
