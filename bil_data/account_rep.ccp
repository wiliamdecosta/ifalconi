<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_data" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="pips" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" name="Acc_RepGrid" pageSizeLimit="100" wizardCaption=" V CUSTOMER " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data tidak ditemukan." pasteActions="pasteActions" pasteAsReplace="pasteAsReplace" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList" dataSource="SELECT * FROM V_CUSTOMER_ACC_REP
WHERE CUSTOMER_ID = {CUSTOMER_ID}">
			<Components>
				<Label id="41" fieldSourceType="DBColumn" dataType="Text" html="False" name="ACCOUNT_NAME" fieldSource="ACCOUNT_NAME" wizardCaption="CUSTOMER NUMBER" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="Acc_RepGridACCOUNT_NAME">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="43" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_FROM" fieldSource="VALID_FROM" wizardCaption="LAST NAME" wizardSize="50" wizardMaxLength="64" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="Acc_RepGridVALID_FROM" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="61" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_TO" fieldSource="VALID_TO" wizardCaption="ADDRESS 1" wizardSize="50" wizardMaxLength="64" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="Acc_RepGridVALID_TO" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="85" fieldSourceType="DBColumn" dataType="Text" html="False" name="EMPLOYEE_NO" fieldSource="EMPLOYEE_NO" wizardCaption="CUSTOMER TITLE CODE" wizardSize="50" wizardMaxLength="64" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="Acc_RepGridEMPLOYEE_NO">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="91" fieldSourceType="DBColumn" dataType="Text" html="False" name="DESCRIPTION" fieldSource="DESCRIPTION" wizardCaption="REGION NAME" wizardSize="50" wizardMaxLength="64" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="Acc_RepGridDESCRIPTION">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Link id="139" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="Acc_RepGridDLink" hrefSource="account_rep.ccp" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="FLAG" html="True" wizardUseTemplateBlock="True">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="425" sourceType="DataField" name="CUSTOMER_ACC_REP_ID" source="CUSTOMER_ACC_REP_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Hidden id="141" fieldSourceType="DBColumn" dataType="Float" name="CUSTOMER_ID" PathID="Acc_RepGridCUSTOMER_ID" fieldSource="CUSTOMER_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Link id="145" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="P_ACC_REP_Insert" hrefSource="account_rep.ccp" wizardThemeItem="FooterA" wizardUseTemplateBlock="False" PathID="Acc_RepGridP_ACC_REP_Insert" removeParameters="CUSTOMER_ACC_REP_ID">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
				...
				<Hidden id="333" fieldSourceType="DBColumn" dataType="Float" name="CUSTOMER_ACC_REP_ID" PathID="Acc_RepGridCUSTOMER_ACC_REP_ID" fieldSource="CUSTOMER_ACC_REP_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="97" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="Acc_RepRecord" connection="Conn" PathID="Acc_RepRecord" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" parameterTypeListName="ParameterTypeList" activeCollection="USQLParameters" returnPage="account_rep.ccp" dataSource="V_CUSTOMER_ACC_REP" customInsertType="SQL" customInsert="INSERT INTO CUSTOMER_ACC_REP(
CUSTOMER_ACC_REP_ID,
CUSTOMER_ID, 
P_ACCOUNT_REP_ID,
VALID_FROM, 
...
'{UPDATE_BY}', 
TRIM('{DESCRIPTION}')
)" customDeleteType="SQL" customDelete="DELETE FROM CUSTOMER_ACC_REP WHERE  CUSTOMER_ACC_REP_ID = {CUSTOMER_ACC_REP_ID}" customUpdateType="SQL" customUpdate="UPDATE CUSTOMER_ACC_REP SET 
...
WHERE
CUSTOMER_ACC_REP_ID={CUSTOMER_ACC_REP_ID}">
			<Components>
				<Button id="98" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" PathID="Acc_RepRecordButton_Insert" removeParameters="TAMBAH" returnPage="account_rep.ccp">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="99" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Update" operation="Update" PathID="Acc_RepRecordButton_Update">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="100" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" PathID="Acc_RepRecordButton_Delete" removeParameters="TAMBAH;CUSTOMER_ACC_REP_ID" returnPage="account_rep.ccp">
					<Components/>
					<Events>
				...
				<Button id="102" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Cancel" operation="Cancel" PathID="Acc_RepRecordButton_Cancel" removeParameters="TAMBAH">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<TextBox id="104" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="ACCOUNT_NAME" caption="Account Name" fieldSource="ACCOUNT_NAME" required="True" PathID="Acc_RepRecordACCOUNT_NAME">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="105" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="VALID_FROM" caption="VALID_FROM" fieldSource="VALID_FROM" required="False" PathID="Acc_RepRecordVALID_FROM" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="123" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="UPDATE_DATE" caption="UPDATE DATE" fieldSource="UPDATE_DATE" format="dd-mmm-yyyy" defaultValue="CurrentDate" required="True" PathID="Acc_RepRecordUPDATE_DATE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="125" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="UPDATE_BY" caption="UPDATE BY" fieldSource="UPDATE_BY" defaultValue="CCGetUserLogin()" required="True" PathID="Acc_RepRecordUPDATE_BY">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="336" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="VALID_TO" caption="VALID_TO" fieldSource="VALID_TO" required="False" PathID="Acc_RepRecordVALID_TO" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="337" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="EMPLOYEE_NO" PathID="Acc_RepRecordEMPLOYEE_NO" fieldSource="EMPLOYEE_NO" caption="Employee No" required="True">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<DatePicker id="138" name="DatePicker_UPDATE_DATE1" style="../Styles/trb/Style.css" control="VALID_FROM" PathID="Acc_RepRecordDatePicker_UPDATE_DATE1">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</DatePicker>
				<DatePicker id="341" name="DatePicker_UPDATE_DATE2" style="../Styles/trb/Style.css" control="VALID_TO" PathID="Acc_RepRecordDatePicker_UPDATE_DATE2">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</DatePicker>
				<Hidden id="368" fieldSourceType="DBColumn" dataType="Float" name="CUSTOMER_ID" PathID="Acc_RepRecordCUSTOMER_ID" fieldSource="CUSTOMER_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="335" fieldSourceType="DBColumn" dataType="Float" name="CUSTOMER_ACC_REP_ID" PathID="Acc_RepRecordCUSTOMER_ACC_REP_ID" fieldSource="CUSTOMER_ACC_REP_ID" required="False" visible="Yes">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="407" visible="Yes" fieldSourceType="DBColumn" dataType="Float" name="P_ACCOUNT_REP_ID" PathID="Acc_RepRecordP_ACCOUNT_REP_ID" fieldSource="P_ACCOUNT_REP_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<TextArea id="211" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="DESCRIPTION" PathID="Acc_RepRecordDESCRIPTION" fieldSource="DESCRIPTION">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<Events>
				...
				<Event name="AfterExecuteInsert" type="Server">
					<Actions>
						<Action actionName="Custom Code" actionCategory="General" id="458"/>
					</Actions>
				</Event>
				...
				<Event name="BeforeExecuteDelete" type="Server">
					<Actions>
						<Action actionName="Custom Code" actionCategory="General" id="461"/>
					</Actions>
				</Event>
			...
			<TableParameters>
				<TableParameter id="406" conditionType="Parameter" useIsNull="False" field="CUSTOMER_ACC_REP_ID" dataType="Float" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="CUSTOMER_ACC_REP_ID"/>
			</TableParameters>
			<SPParameters/>
			<SQLParameters/>
			<JoinTables>
				<JoinTable id="405" tableName="V_CUSTOMER_ACC_REP" schemaName="BILLDB" posLeft="10" posTop="10" posWidth="160" posHeight="180"/>
			</JoinTables>
			<JoinLinks/>
			<Fields/>
			<ISPParameters/>
			<ISQLParameters>
				...
				<SQLParameter id="373" variable="UPDATE_BY" dataType="Text" parameterType="Control" parameterSource="UPDATE_BY"/>
				...
				<SQLParameter id="421" variable="CUSTOMER_ACC_REP_ID" dataType="Float" parameterType="URL" parameterSource="CUSTOMER_ACC_REP_ID" defaultValue="0"/>
				<SQLParameter id="422" variable="P_ACCOUNT_REP_ID" dataType="Float" parameterType="Control" parameterSource="P_ACCOUNT_REP_ID"/>
				<SQLParameter id="423" variable="ACCOUNT_NAME" dataType="Text" parameterType="Control" parameterSource="ACCOUNT_NAME"/>
				<SQLParameter id="424" variable="EMPLOYEE_NO" dataType="Text" parameterType="Control" parameterSource="EMPLOYEE_NO"/>
			</ISQLParameters>
			<IFormElements>
				<CustomParameter id="408" field="ACCOUNT_NAME" dataType="Text" parameterType="Control" parameterSource="ACCOUNT_NAME" omitIfEmpty="True"/>
				<CustomParameter id="409" field="VALID_FROM" dataType="Date" parameterType="Control" parameterSource="VALID_FROM" format="dd-mmm-yyyy" omitIfEmpty="True"/>
				<CustomParameter id="410" field="UPDATE_DATE" dataType="Date" parameterType="Control" parameterSource="UPDATE_DATE" format="dd-mmm-yyyy" omitIfEmpty="True"/>
				<CustomParameter id="411" field="UPDATE_BY" dataType="Text" parameterType="Control" parameterSource="UPDATE_BY" omitIfEmpty="True"/>
				<CustomParameter id="412" field="VALID_TO" dataType="Date" parameterType="Control" parameterSource="VALID_TO" format="dd-mmm-yyyy" omitIfEmpty="True"/>
				<CustomParameter id="413" field="EMPLOYEE_NO" dataType="Text" parameterType="Control" parameterSource="EMPLOYEE_NO" omitIfEmpty="True"/>
				<CustomParameter id="414" field="DESCRIPTION" dataType="Text" parameterType="Control" parameterSource="DESCRIPTION" omitIfEmpty="True"/>
				<CustomParameter id="415" field="CUSTOMER_ID" dataType="Float" parameterType="Control" parameterSource="CUSTOMER_ID" omitIfEmpty="True"/>
				<CustomParameter id="416" field="CUSTOMER_ACC_REP_ID" dataType="Float" parameterType="Control" parameterSource="CUSTOMER_ACC_REP_ID" omitIfEmpty="True"/>
				<CustomParameter id="417" field="P_ACCOUNT_REP_ID" dataType="Float" parameterType="Control" parameterSource="P_ACCOUNT_REP_ID" omitIfEmpty="True"/>
			</IFormElements>
			<USPParameters/>
			<USQLParameters>
				...
				<SQLParameter id="438" variable="CUSTOMER_ACC_REP_ID" dataType="Float" parameterType="Control" parameterSource="CUSTOMER_ACC_REP_ID"/>
			...
			<UFormElements>
				...
				<CustomParameter id="428" field="ACCOUNT_NAME" dataType="Text" parameterType="Control" parameterSource="ACCOUNT_NAME"/>
				<CustomParameter id="429" field="EMPLOYEE_NO" dataType="Text" parameterType="Control" parameterSource="EMPLOYEE_NO"/>
				<CustomParameter id="430" field="DESCRIPTION" dataType="Text" parameterType="Control" parameterSource="DESCRIPTION"/>
				<CustomParameter id="431" field="CUSTOMER_ACC_REP_ID" dataType="Float" parameterType="Control" parameterSource="CUSTOMER_ACC_REP_ID"/>
				<CustomParameter id="432" field="P_ACCOUNT_REP_ID" dataType="Float" parameterType="Control" parameterSource="P_ACCOUNT_REP_ID"/>
			</UFormElements>
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="427" variable="CUSTOMER_ACC_REP_ID" parameterType="Control" dataType="Float" parameterSource="CUSTOMER_ACC_REP_ID" defaultValue="0"/>
			</DSQLParameters>
			<DConditions>
				<TableParameter id="426" conditionType="Parameter" useIsNull="False" field="CUSTOMER_ACC_REP_ID" dataType="Float" parameterType="URL" parameterSource="CUSTOMER_ACC_REP_ID" searchConditionType="Equal" logicOperator="And"/>
			</DConditions>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
...
WHERE  P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_INPUT_FILE_DESC WHERE P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Label id="440" fieldSourceType="DBColumn" dataType="Text" html="False" name="LAST_NAME" PathID="Customer_InfLAST_NAME" fieldSource="LAST_NAME">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="441" fieldSourceType="DBColumn" dataType="Text" html="False" name="CUSTOMER_NUMBER" PathID="Customer_InfCUSTOMER_NUMBER" fieldSource="CUSTOMER_NUMBER">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="442" variable="P_SERVICE_TYPE_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="P_SERVICE_TYPE_ID"/>
				<SQLParameter id="92" variable="PROCEDURE_NAME" parameterType="Control" dataType="Text" parameterSource="PROCEDURE_NAME"/>
				<SQLParameter id="443" variable="START_POSITION_NAME" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="START_POSITION_NAME"/>
				...
				<SQLParameter id="445" variable="CREATED_BY" parameterType="Control" dataType="Text" parameterSource="CREATED_BY"/>
				<SQLParameter id="446" variable="UPDATED_BY" parameterType="Control" dataType="Text" parameterSource="UPDATED_BY"/>
			</ISQLParameters>
			<IFormElements>
				<CustomParameter id="447" field="P_INPUT_FILE_TYPE_ID" dataType="Float" parameterType="Control" parameterSource="P_INPUT_FILE_TYPE_ID"/>
				<CustomParameter id="101" field="P_SERVICE_TYPE_ID" dataType="Float" parameterType="Control" parameterSource="P_SERVICE_TYPE_ID"/>
				<CustomParameter id="448" field="PROCEDURE_NAME" dataType="Text" parameterType="Control" parameterSource="PROCEDURE_NAME"/>
				<CustomParameter id="449" field="START_POSITION_NAME" dataType="Float" parameterType="Control" parameterSource="START_POSITION_NAME"/>
				<CustomParameter id="450" field="END_POSITION_NAME" dataType="Float" parameterType="Control" parameterSource="END_POSITION_NAME"/>
				<CustomParameter id="451" field="PARTIAL_FILE_NAME" dataType="Text" parameterType="Control" parameterSource="PARTIAL_FILE_NAME"/>
			...
			<UFormElements>
				...
				<CustomParameter id="452" field="CREATION_DATE" dataType="Date" parameterType="Control" parameterSource="CREATION_DATE" format="dd-mmm-yyyy"/>
				<CustomParameter id="453" field="UPDATED_DATE" dataType="Date" parameterType="Control" parameterSource="UPDATED_DATE" format="dd-mmm-yyyy"/>
				<CustomParameter id="454" field="DESCRIPTION" dataType="Text" parameterType="Control" parameterSource="P_INPUT_FILE_TYPE_ID1"/>
				<CustomParameter id="137" field="DESCRIPTION" dataType="Text" parameterType="Control" parameterSource="P_SERVICE_TYPE_ID1"/>
				<CustomParameter id="455" field="P_INPUT_FILE_DESC_ID" dataType="Float" parameterType="Control" parameterSource="P_INPUT_FILE_DESC_ID"/>
			</UFormElements>
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="456" variable="P_INPUT_FILE_DESC_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="P_INPUT_FILE_DESC_ID"/>
			</DSQLParameters>
			<DConditions/>
			<SecurityGroups/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="account_rep_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="account_rep.php" forShow="True" url="account_rep.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
