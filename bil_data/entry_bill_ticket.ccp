...
WHERE
	VERIFICATION_DATE IS NULL AND( 
	UPPER(to_char(TICKET_DATE,'dd-MON-yyyy')) LIKE UPPER('%{s_keyword}%') OR
	...
	UPPER(DESCRIPTION) LIKE UPPER('%{s_keyword}%'))">
			<Components>
				...
				<Link id="52" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="ENTRY_BILL_TICKETDLink" hrefSource="entry_bill_ticket.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="T_BILL_TICKET_ID">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="54" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="ENTRY_BILL_TICKETADLink" hrefSource="entry_bill_ticket.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="T_BILL_TICKET_ID">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="BATCH_Insert" hrefSource="entry_bill_ticket.ccp" removeParameters="T_BILL_TICKET_ID;FLAG;s_keyword" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="ENTRY_BILL_TICKETBATCH_Insert">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="BATCHSearch" wizardCaption="Search P APP ROLE " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="entry_bill_ticket.ccp" PathID="BATCHSearch" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Button id="4" urlType="Relative" enableValidation="True" isDefault="False" name="Button_DoSearch" operation="Search" wizardCaption="Search" PathID="BATCHSearchButton_DoSearch">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
INSERT INTO T_BILL_TICKET (T_BILL_TICKET_ID,
     ...
     VALUES (GENERATE_ID('BILLDB','T_BILL_TICKET', 'T_BILL_TICKET_ID'),
        ...
        {TICKET_AMOUNT}, {TICKET_REASON_ID}, '{DESCRIPTION}', {TICKET_AMOUNT}, 
...
WHERE T_BILL_TICKET_ID = {T_BILL_TICKET_ID}">
			<Components>
				...
				<Button id="22" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="BATCH1Button_Delete" removeParameters="FLAG;T_BILL_TICKET_ID" returnPage="entry_bill_ticket.ccp">
					<Components/>
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="entry_bill_ticket_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="entry_bill_ticket.php" forShow="True" url="entry_bill_ticket.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
