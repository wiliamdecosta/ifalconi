<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_data" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="pips" wizardThemeVersion="3.0" pasteActions="pasteActions" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="SELECT * FROM V_SUBS_OVERRIDE_RECU_TARIFF    
WHERE 
SUBSCRIBER_ID = {SUBSCRIBER_ID}
" name="RECURRINGTARIF" pageSizeLimit="100" wizardCaption=" V SUBS OT PROMO SERVICE " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No Record" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				<Label id="18" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_TO" fieldSource="VALID_TO" wizardCaption="PROMOTION DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="RECURRINGTARIFVALID_TO" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="20" fieldSourceType="DBColumn" dataType="Text" html="False" name="DESCRIPTION" fieldSource="DESCRIPTION" wizardCaption="DESCRIPTION" wizardSize="50" wizardMaxLength="128" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="RECURRINGTARIFDESCRIPTION">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="26" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILL_COMPONENT_CODE" fieldSource="BILL_COMPONENT_CODE" wizardCaption="OT PROMO CODE" wizardSize="50" wizardMaxLength="128" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="RECURRINGTARIFBILL_COMPONENT_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ServicePromo_Insert" hrefSource="subscriber_tariff_override_form1.ccp" removeParameters="SUBS_OVERRIDE_RECU_TARIFF_ID" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="RECURRINGTARIFServicePromo_Insert">
					<Components/>
					<Events>
				...
				<Link id="29" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Editlink" PathID="RECURRINGTARIFEditlink" hrefSource="subscriber_tariff_override_form1.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="SUBSCRIBER_ID">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="163" sourceType="DataField" name="SUBS_OVERRIDE_RECU_TARIFF_ID" source="SUBS_OVERRIDE_RECU_TARIFF_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Label id="124" fieldSourceType="DBColumn" dataType="Text" html="False" name="CHARGE_AMOUNT" PathID="RECURRINGTARIFCHARGE_AMOUNT" fieldSource="CHARGE_AMOUNT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="125" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_FROM" PathID="RECURRINGTARIFVALID_FROM" fieldSource="VALID_FROM" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="126" fieldSourceType="DBColumn" dataType="Text" html="False" name="CURRENCY_CODE" PathID="RECURRINGTARIFCURRENCY_CODE" fieldSource="CURRENCY_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="132" fieldSourceType="DBColumn" dataType="Text" html="False" name="OT_PROMOTION_CODE" PathID="RECURRINGTARIFOT_PROMOTION_CODE" fieldSource="OT_PROMOTION_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="133" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILLING_UNIT" PathID="RECURRINGTARIFBILLING_UNIT" fieldSource="BILLING_UNIT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="134" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILL_PERIOD_UNIT_CODE" PathID="RECURRINGTARIFBILL_PERIOD_UNIT_CODE" fieldSource="BILL_PERIOD_UNIT_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="162" fieldSourceType="DBColumn" dataType="Text" name="SUBS_OVERRIDE_RECU_TARIFF_ID" PathID="RECURRINGTARIFSUBS_OVERRIDE_RECU_TARIFF_ID" fieldSource="SUBS_OVERRIDE_RECU_TARIFF_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE  P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_INPUT_FILE_DESC WHERE P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" PathID="SubscribInfo" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList" pasteActions="pasteActions">
		...
		<Grid id="110" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="SELECT * FROM V_SUBS_OVER_FEAT_RECU_TARIFF
WHERE 
SUBSCRIBER_ID = {SUBSCRIBER_ID}
" name="FEATURE" pageSizeLimit="100" wizardCaption=" V SUBS OT PROMO SERVICE " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No Record" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				...
				<Link id="115" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ServicePromo_Insert" hrefSource="subscriber_tariff_override_form2.ccp" removeParameters="SUBS_OVER_FEAT_RECU_TARIFF_ID" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="FEATUREServicePromo_Insert">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
				...
				<Link id="117" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Editlink" PathID="FEATUREEditlink" hrefSource="subscriber_tariff_override_form2.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="SUBSCRIBER_ID">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="165" sourceType="DataField" name="SUBS_OVER_FEAT_RECU_TARIFF_ID" source="SUBS_OVER_FEAT_RECU_TARIFF_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Label id="127" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILL_COMPONENT_CODE" PathID="FEATUREBILL_COMPONENT_CODE" fieldSource="BILL_COMPONENT_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="128" fieldSourceType="DBColumn" dataType="Text" html="False" name="CURRENCY_CODE" PathID="FEATURECURRENCY_CODE" fieldSource="CURRENCY_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="131" fieldSourceType="DBColumn" dataType="Text" html="False" name="DESCRIPTION" PathID="FEATUREDESCRIPTION" fieldSource="DESCRIPTION">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="135" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_FROM" PathID="FEATUREVALID_FROM" fieldSource="VALID_FROM" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="136" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_TO" fieldSource="VALID_TO" wizardCaption="PROMOTION DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="FEATUREVALID_TO" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="137" fieldSourceType="DBColumn" dataType="Text" html="False" name="CHARGE_AMOUNT" PathID="FEATURECHARGE_AMOUNT" fieldSource="CHARGE_AMOUNT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="138" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILL_PERIOD_UNIT_CODE" PathID="FEATUREBILL_PERIOD_UNIT_CODE" fieldSource="BILL_PERIOD_UNIT_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="139" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILLING_UNIT" PathID="FEATUREBILLING_UNIT" fieldSource="BILLING_UNIT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="140" fieldSourceType="DBColumn" dataType="Text" html="False" name="OT_FEAT_PROMOTION_CODE" PathID="FEATUREOT_FEAT_PROMOTION_CODE" fieldSource="OT_FEAT_PROMOTION_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="164" fieldSourceType="DBColumn" dataType="Text" name="SUBS_OVER_FEAT_RECU_TARIFF_ID" PathID="FEATURESUBS_OVER_FEAT_RECU_TARIFF_ID" fieldSource="SUBS_OVER_FEAT_RECU_TARIFF_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Grid id="141" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="SELECT * FROM V_SUBS_OVER_BF_RECU_TARIFF
WHERE 
SUBSCRIBER_ID = {SUBSCRIBER_ID}
" name="BUNDLEDFEATURE" pageSizeLimit="100" wizardCaption=" V SUBS OT PROMO SERVICE " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No Record" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				<Label id="142" fieldSourceType="DBColumn" dataType="Text" html="False" name="BUNDLED_FEATURE_CODE" fieldSource="BUNDLED_FEATURE_CODE" wizardCaption="OT PROMO CODE" wizardSize="50" wizardMaxLength="128" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="BUNDLEDFEATUREBUNDLED_FEATURE_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Navigator id="143" size="5" type="Centered" pageSizes="1;5;10;25;50" name="Navigator" wizardPagingType="Custom" wizardFirst="True" wizardPrev="True" wizardNext="True" wizardLast="True" wizardImages="Images" wizardPageNumbers="Centered" wizardSize="5" wizardTotalPages="False" wizardHideDisabled="False" wizardPageSize="False" wizardImagesScheme="Apricot">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Navigator>
				<Link id="144" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ServicePromo_Insert" hrefSource="subscriber_tariff_override_form3.ccp" removeParameters="SUBS_OVER_BF_RECU_TARIFF_ID" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="BUNDLEDFEATUREServicePromo_Insert">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="145" eventType="Server"/>
							</Actions>
						</Event>
					</Events>
					<LinkParameters>
				...
				<Link id="146" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Editlink" PathID="BUNDLEDFEATUREEditlink" hrefSource="subscriber_tariff_override_form3.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="SUBSCRIBER_ID">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="167" sourceType="DataField" name="SUBS_OVER_BF_RECU_TARIFF_ID" source="SUBS_OVER_BF_RECU_TARIFF_ID"/>
</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Label id="148" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILL_COMPONENT_CODE" PathID="BUNDLEDFEATUREBILL_COMPONENT_CODE" fieldSource="BILL_COMPONENT_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="149" fieldSourceType="DBColumn" dataType="Text" html="False" name="CURRENCY_CODE" PathID="BUNDLEDFEATURECURRENCY_CODE" fieldSource="CURRENCY_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="150" fieldSourceType="DBColumn" dataType="Text" html="False" name="DESCRIPTION" PathID="BUNDLEDFEATUREDESCRIPTION" fieldSource="DESCRIPTION">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="151" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_FROM" PathID="BUNDLEDFEATUREVALID_FROM" fieldSource="VALID_FROM" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="152" fieldSourceType="DBColumn" dataType="Date" html="False" name="VALID_TO" fieldSource="VALID_TO" wizardCaption="PROMOTION DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="BUNDLEDFEATUREVALID_TO" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="153" fieldSourceType="DBColumn" dataType="Text" html="False" name="CHARGE_AMOUNT" PathID="BUNDLEDFEATURECHARGE_AMOUNT" fieldSource="CHARGE_AMOUNT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="154" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILL_PERIOD_UNIT_CODE" PathID="BUNDLEDFEATUREBILL_PERIOD_UNIT_CODE" fieldSource="BILL_PERIOD_UNIT_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="155" fieldSourceType="DBColumn" dataType="Text" html="False" name="BILLING_UNIT" PathID="BUNDLEDFEATUREBILLING_UNIT" fieldSource="BILLING_UNIT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="156" fieldSourceType="DBColumn" dataType="Text" html="False" name="OT_FEAT_PROMOTION_CODE" PathID="BUNDLEDFEATUREOT_FEAT_PROMOTION_CODE" fieldSource="OT_FEAT_PROMOTION_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="166" fieldSourceType="DBColumn" dataType="Text" name="SUBS_OVER_BF_RECU_TARIFF_ID" PathID="BUNDLEDFEATURESUBS_OVER_BF_RECU_TARIFF_ID" fieldSource="SUBS_OVER_BF_RECU_TARIFF_ID">
<Components/>
<Events/>
<Attributes/>
<Features/>
			...
			<Events>
				<Event name="BeforeShowRow" type="Server">
					<Actions>
						<Action actionName="Set Row Style" actionCategory="General" id="157" styles="Row;AltRow" name="rowStyle" eventType="Server"/>
					</Actions>
				</Event>
			</Events>
			<TableParameters>
				<TableParameter id="158" conditionType="Parameter" useIsNull="False" field="OT_PROMO_CODE" parameterSource="s_keyword" dataType="Text" logicOperator="Or" searchConditionType="Contains" parameterType="URL" orderNumber="1" leftBrackets="1"/>
				<TableParameter id="159" conditionType="Parameter" useIsNull="False" field="DESCRIPTION" parameterSource="s_keyword" dataType="Text" logicOperator="Or" searchConditionType="Contains" parameterType="URL" orderNumber="2" rightBrackets="1"/>
			</TableParameters>
			<JoinTables/>
			<JoinLinks/>
			<Fields/>
			...
			<SQLParameters>
				...
				<SQLParameter id="161" variable="SUBSCRIBER_ID" parameterType="URL" defaultValue="0" dataType="Float" parameterSource="SUBSCRIBER_ID"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="subscriber_tariff_override_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="subscriber_tariff_override.php" forShow="True" url="subscriber_tariff_override.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
