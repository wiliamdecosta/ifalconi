<?php
//Include Common Files @1-A948FF32
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_data/");
define("FileName", "subscriber_tariff_override.php");
...
//Class_Initialize Event @2-9B7670CC
    function clsGridRECURRINGTARIF($RelativePath, & $Parent)
    {
        ...
        $this->Editlink->Page = "subscriber_tariff_override_form1.php";
        ...
        $this->SUBS_OVERRIDE_RECU_TARIFF_ID = & new clsControl(ccsHidden, "SUBS_OVERRIDE_RECU_TARIFF_ID", "SUBS_OVERRIDE_RECU_TARIFF_ID", ccsText, "", CCGetRequestParam("SUBS_OVERRIDE_RECU_TARIFF_ID", ccsGet, NULL), $this);
        ...
        $this->ServicePromo_Insert->Parameters = CCGetQueryString("QueryString", array("SUBS_OVERRIDE_RECU_TARIFF_ID", "ccsForm"));
        $this->ServicePromo_Insert->Page = "subscriber_tariff_override_form1.php";
    }
...
//Show Method @2-C693DCC4
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["SUBS_OVERRIDE_RECU_TARIFF_ID"] = $this->SUBS_OVERRIDE_RECU_TARIFF_ID->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->Editlink->Parameters = CCAddParam($this->Editlink->Parameters, "SUBS_OVERRIDE_RECU_TARIFF_ID", $this->DataSource->f("SUBS_OVERRIDE_RECU_TARIFF_ID"));
...
//GetErrors Method @2-FF669A75
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->SUBS_OVERRIDE_RECU_TARIFF_ID->Errors->ToString());
...
//DataSource Variables @2-2FDA27A8
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-6CD5E29E
    function clsRECURRINGTARIFDataSource(& $Parent)
    {
        ...
        $this->SUBS_OVERRIDE_RECU_TARIFF_ID = new clsField("SUBS_OVERRIDE_RECU_TARIFF_ID", ccsText, "");
...
//SetValues Method @2-28C807AA
    function SetValues()
    {
        ...
        $this->SUBS_OVERRIDE_RECU_TARIFF_ID->SetDBValue($this->f("SUBS_OVERRIDE_RECU_TARIFF_ID"));
    }
...
//Class_Initialize Event @110-8F85102C
    function clsGridFEATURE($RelativePath, & $Parent)
    {
        ...
        $this->Editlink = & new clsControl(ccsLink, "Editlink", "Editlink", ccsText, "", CCGetRequestParam("Editlink", ccsGet, NULL), $this);
        $this->Editlink->HTML = true;
        $this->Editlink->Page = "subscriber_tariff_override_form2.php";
        $this->BILL_COMPONENT_CODE = & new clsControl(ccsLabel, "BILL_COMPONENT_CODE", "BILL_COMPONENT_CODE", ccsText, "", CCGetRequestParam("BILL_COMPONENT_CODE", ccsGet, NULL), $this);
        $this->CURRENCY_CODE = & new clsControl(ccsLabel, "CURRENCY_CODE", "CURRENCY_CODE", ccsText, "", CCGetRequestParam("CURRENCY_CODE", ccsGet, NULL), $this);
        $this->DESCRIPTION = & new clsControl(ccsLabel, "DESCRIPTION", "DESCRIPTION", ccsText, "", CCGetRequestParam("DESCRIPTION", ccsGet, NULL), $this);
        $this->VALID_FROM = & new clsControl(ccsLabel, "VALID_FROM", "VALID_FROM", ccsDate, array("dd", "-", "mmm", "-", "yyyy"), CCGetRequestParam("VALID_FROM", ccsGet, NULL), $this);
        ...
        $this->SUBS_OVER_FEAT_RECU_TARIFF_ID = & new clsControl(ccsHidden, "SUBS_OVER_FEAT_RECU_TARIFF_ID", "SUBS_OVER_FEAT_RECU_TARIFF_ID", ccsText, "", CCGetRequestParam("SUBS_OVER_FEAT_RECU_TARIFF_ID", ccsGet, NULL), $this);
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 5, tpCentered, $this);
        $this->Navigator->PageSizes = array("1", "5", "10", "25", "50");
        $this->ServicePromo_Insert = & new clsControl(ccsLink, "ServicePromo_Insert", "ServicePromo_Insert", ccsText, "", CCGetRequestParam("ServicePromo_Insert", ccsGet, NULL), $this);
        $this->ServicePromo_Insert->HTML = true;
        $this->ServicePromo_Insert->Parameters = CCGetQueryString("QueryString", array("SUBS_OVER_FEAT_RECU_TARIFF_ID", "ccsForm"));
        $this->ServicePromo_Insert->Page = "subscriber_tariff_override_form2.php";
    }
//End Class_Initialize Event
...
//Show Method @110-60E6E3CA
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["SUBS_OVER_FEAT_RECU_TARIFF_ID"] = $this->SUBS_OVER_FEAT_RECU_TARIFF_ID->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                $this->RowNumber++;
                if ($this->HasRecord) {
                    $this->DataSource->next_record();
                ...
                $this->Editlink->SetValue($this->DataSource->Editlink->GetValue());
                $this->Editlink->Parameters = CCGetQueryString("QueryString", array("FLAG", "ccsForm"));
                $this->Editlink->Parameters = CCAddParam($this->Editlink->Parameters, "SUBS_OVER_FEAT_RECU_TARIFF_ID", $this->DataSource->f("SUBS_OVER_FEAT_RECU_TARIFF_ID"));
                $this->BILL_COMPONENT_CODE->SetValue($this->DataSource->BILL_COMPONENT_CODE->GetValue());
                $this->CURRENCY_CODE->SetValue($this->DataSource->CURRENCY_CODE->GetValue());
                $this->DESCRIPTION->SetValue($this->DataSource->DESCRIPTION->GetValue());
                $this->VALID_FROM->SetValue($this->DataSource->VALID_FROM->GetValue());
...
//GetErrors Method @110-7EE42FB2
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->SUBS_OVER_FEAT_RECU_TARIFF_ID->Errors->ToString());
        $errors = ComposeStrings($errors, $this->Errors->ToString());
        $errors = ComposeStrings($errors, $this->DataSource->Errors->ToString());
        return $errors;
    }
...
//DataSource Variables @110-2DCEC463
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @110-8FAEA6E8
    function clsFEATUREDataSource(& $Parent)
    {
        ...
        $this->SUBS_OVER_FEAT_RECU_TARIFF_ID = new clsField("SUBS_OVER_FEAT_RECU_TARIFF_ID", ccsText, "");
...
//SetValues Method @110-1749F9BB
    function SetValues()
    {
        ...
        $this->SUBS_OVER_FEAT_RECU_TARIFF_ID->SetDBValue($this->f("SUBS_OVER_FEAT_RECU_TARIFF_ID"));
    }
//End SetValues Method
...
//Class_Initialize Event @141-8ACFBCD8
    function clsGridBUNDLEDFEATURE($RelativePath, & $Parent)
    {
        ...
        $this->Editlink = & new clsControl(ccsLink, "Editlink", "Editlink", ccsText, "", CCGetRequestParam("Editlink", ccsGet, NULL), $this);
        $this->Editlink->HTML = true;
        $this->Editlink->Page = "subscriber_tariff_override_form3.php";
        $this->BILL_COMPONENT_CODE = & new clsControl(ccsLabel, "BILL_COMPONENT_CODE", "BILL_COMPONENT_CODE", ccsText, "", CCGetRequestParam("BILL_COMPONENT_CODE", ccsGet, NULL), $this);
        $this->CURRENCY_CODE = & new clsControl(ccsLabel, "CURRENCY_CODE", "CURRENCY_CODE", ccsText, "", CCGetRequestParam("CURRENCY_CODE", ccsGet, NULL), $this);
        $this->DESCRIPTION = & new clsControl(ccsLabel, "DESCRIPTION", "DESCRIPTION", ccsText, "", CCGetRequestParam("DESCRIPTION", ccsGet, NULL), $this);
        $this->VALID_FROM = & new clsControl(ccsLabel, "VALID_FROM", "VALID_FROM", ccsDate, array("dd", "-", "mmm", "-", "yyyy"), CCGetRequestParam("VALID_FROM", ccsGet, NULL), $this);
        ...
        $this->BILLING_UNIT = & new clsControl(ccsLabel, "BILLING_UNIT", "BILLING_UNIT", ccsText, "", CCGetRequestParam("BILLING_UNIT", ccsGet, NULL), $this);
        $this->OT_FEAT_PROMOTION_CODE = & new clsControl(ccsLabel, "OT_FEAT_PROMOTION_CODE", "OT_FEAT_PROMOTION_CODE", ccsText, "", CCGetRequestParam("OT_FEAT_PROMOTION_CODE", ccsGet, NULL), $this);
        $this->SUBS_OVER_BF_RECU_TARIFF_ID = & new clsControl(ccsHidden, "SUBS_OVER_BF_RECU_TARIFF_ID", "SUBS_OVER_BF_RECU_TARIFF_ID", ccsText, "", CCGetRequestParam("SUBS_OVER_BF_RECU_TARIFF_ID", ccsGet, NULL), $this);
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 5, tpCentered, $this);
        $this->Navigator->PageSizes = array("1", "5", "10", "25", "50");
        $this->ServicePromo_Insert = & new clsControl(ccsLink, "ServicePromo_Insert", "ServicePromo_Insert", ccsText, "", CCGetRequestParam("ServicePromo_Insert", ccsGet, NULL), $this);
        $this->ServicePromo_Insert->HTML = true;
        $this->ServicePromo_Insert->Parameters = CCGetQueryString("QueryString", array("SUBS_OVER_BF_RECU_TARIFF_ID", "ccsForm"));
        $this->ServicePromo_Insert->Page = "subscriber_tariff_override_form3.php";
    }
//End Class_Initialize Event
...
//Show Method @141-69A946E4
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["BILLING_UNIT"] = $this->BILLING_UNIT->Visible;
            $this->ControlsVisible["OT_FEAT_PROMOTION_CODE"] = $this->OT_FEAT_PROMOTION_CODE->Visible;
            $this->ControlsVisible["SUBS_OVER_BF_RECU_TARIFF_ID"] = $this->SUBS_OVER_BF_RECU_TARIFF_ID->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                $this->RowNumber++;
                if ($this->HasRecord) {
                    $this->DataSource->next_record();
                ...
                $this->Editlink->SetValue($this->DataSource->Editlink->GetValue());
                $this->Editlink->Parameters = CCGetQueryString("QueryString", array("FLAG", "ccsForm"));
                $this->Editlink->Parameters = CCAddParam($this->Editlink->Parameters, "SUBS_OVER_BF_RECU_TARIFF_ID", $this->DataSource->f("SUBS_OVER_BF_RECU_TARIFF_ID"));
                $this->BILL_COMPONENT_CODE->SetValue($this->DataSource->BILL_COMPONENT_CODE->GetValue());
                $this->CURRENCY_CODE->SetValue($this->DataSource->CURRENCY_CODE->GetValue());
                $this->DESCRIPTION->SetValue($this->DataSource->DESCRIPTION->GetValue());
                $this->VALID_FROM->SetValue($this->DataSource->VALID_FROM->GetValue());
                ...
                $this->BILLING_UNIT->SetValue($this->DataSource->BILLING_UNIT->GetValue());
                $this->OT_FEAT_PROMOTION_CODE->SetValue($this->DataSource->OT_FEAT_PROMOTION_CODE->GetValue());
                $this->SUBS_OVER_BF_RECU_TARIFF_ID->SetValue($this->DataSource->SUBS_OVER_BF_RECU_TARIFF_ID->GetValue());
                $this->Attributes->SetValue("rowNumber", $this->RowNumber);
                $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeShowRow", $this);
                $this->Attributes->Show();
                ...
                $this->BILLING_UNIT->Show();
                $this->OT_FEAT_PROMOTION_CODE->Show();
                $this->SUBS_OVER_BF_RECU_TARIFF_ID->Show();
                $Tpl->block_path = $ParentPath . "/" . $GridBlock;
                $Tpl->parse("Row", true);
            }
        }
...
//GetErrors Method @141-49B746E6
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->BILLING_UNIT->Errors->ToString());
        $errors = ComposeStrings($errors, $this->OT_FEAT_PROMOTION_CODE->Errors->ToString());
        $errors = ComposeStrings($errors, $this->SUBS_OVER_BF_RECU_TARIFF_ID->Errors->ToString());
        $errors = ComposeStrings($errors, $this->Errors->ToString());
        $errors = ComposeStrings($errors, $this->DataSource->Errors->ToString());
        return $errors;
    }
...
//DataSource Variables @141-D073DBAE
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    var $BILLING_UNIT;
    var $OT_FEAT_PROMOTION_CODE;
    var $SUBS_OVER_BF_RECU_TARIFF_ID;
//End DataSource Variables

//DataSourceClass_Initialize Event @141-67D8EFF4
    function clsBUNDLEDFEATUREDataSource(& $Parent)
    {
        ...
        $this->SUBS_OVER_BF_RECU_TARIFF_ID = new clsField("SUBS_OVER_BF_RECU_TARIFF_ID", ccsText, "");
...
//SetValues Method @141-293491E5
    function SetValues()
    {
        ...
        $this->BILLING_UNIT->SetDBValue($this->f("BILLING_UNIT"));
        $this->OT_FEAT_PROMOTION_CODE->SetDBValue($this->f("OT_FEAT_PROMOTION_CODE"));
        $this->SUBS_OVER_BF_RECU_TARIFF_ID->SetDBValue($this->f("SUBS_OVER_BF_RECU_TARIFF_ID"));
    }
//End SetValues Method

} //End BUNDLEDFEATUREDataSource Class @141-FCB6E20C

//Initialize Page @1-3E208ED6
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "subscriber_tariff_override.html";
$BlockToParse = "main";
...
//Include events file @1-93B6FAC5
include_once("./subscriber_tariff_override_events.php");
