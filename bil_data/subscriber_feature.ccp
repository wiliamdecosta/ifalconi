...
" name="BUNDLEDFEATURE" pageSizeLimit="100" wizardCaption=" V SUBS OT PROMO SERVICE " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No Record" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				...
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ServicePromo_Insert" hrefSource="subscriber_feature_bundled_form.ccp" removeParameters="SUBSCRIBER_BUNDLED_FEATURE_ID" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="BUNDLEDFEATUREServicePromo_Insert">
					<Components/>
					<Events>
				...
				<Link id="29" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Editlink" PathID="BUNDLEDFEATUREEditlink" hrefSource="subscriber_feature_bundled_form.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="SUBSCRIBER_ID">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="134" sourceType="DataField" name="SUBSCRIBER_BUNDLED_FEATURE_ID" source="SUBSCRIBER_BUNDLED_FEATURE_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				...
				<Hidden id="133" fieldSourceType="DBColumn" dataType="Text" name="SUBSCRIBER_BUNDLED_FEATURE_ID" PathID="BUNDLEDFEATURESUBSCRIBER_BUNDLED_FEATURE_ID" fieldSource="SUBSCRIBER_BUNDLED_FEATURE_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
" name="FEATURE" pageSizeLimit="100" wizardCaption=" V SUBS OT PROMO SERVICE " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No Record" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				...
				<Link id="115" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ServicePromo_Insert" hrefSource="subscriber_feature_form.ccp" removeParameters="SUBSCRIBER_FEATURE_ID" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="FEATUREServicePromo_Insert">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
				...
				<Link id="117" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Editlink" PathID="FEATUREEditlink" hrefSource="subscriber_feature_form.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="SUBSCRIBER_ID">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="136" sourceType="DataField" name="SUBSCRIBER_FEATURE_ID" source="SUBSCRIBER_FEATURE_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				...
				<Hidden id="135" fieldSourceType="DBColumn" dataType="Text" name="SUBSCRIBER_FEATURE_ID" PathID="FEATURESUBSCRIBER_FEATURE_ID" fieldSource="SUBSCRIBER_FEATURE_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<Events>
				<Event name="BeforeShowRow" type="Server">
					<Actions>
						<Action actionName="Set Row Style" actionCategory="General" id="119" styles="Row;AltRow" name="rowStyle"/>
					</Actions>
				</Event>
			</Events>
			<TableParameters>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="subscriber_feature_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="subscriber_feature.php" forShow="True" url="subscriber_feature.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
