<?php
//Include Common Files @1-709E6A34
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_data/");
define("FileName", "sub_promo.php");
...
class clsGridV_SUBS_OT_PROMO_SERVICE { //V_SUBS_OT_PROMO_SERVICE class @2-E99E1C71
...
//Class_Initialize Event @2-5D048B5E
    function clsGridV_SUBS_OT_PROMO_SERVICE($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "V_SUBS_OT_PROMO_SERVICE";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid V_SUBS_OT_PROMO_SERVICE";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsV_SUBS_OT_PROMO_SERVICEDataSource($this);
...
} //End V_SUBS_OT_PROMO_SERVICE Class @2-FCB6E20C

class clsV_SUBS_OT_PROMO_SERVICEDataSource extends clsDBConn {  //V_SUBS_OT_PROMO_SERVICEDataSource Class @2-6E4C3D90

//DataSource Variables @2-A2A6DCFE
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-A7FCEFF3
    function clsV_SUBS_OT_PROMO_SERVICEDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid V_SUBS_OT_PROMO_SERVICE";
        $this->Initialize();
...
} //End V_SUBS_OT_PROMO_SERVICEDataSource Class @2-FCB6E20C
...
class clsGridV_SUBS_OT_PROMO_SERVICE1 { //V_SUBS_OT_PROMO_SERVICE1 class @110-38A83F00
...
//Class_Initialize Event @110-A1DB500C
    function clsGridV_SUBS_OT_PROMO_SERVICE1($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid V_SUBS_OT_PROMO_SERVICE1";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
...
} //End V_SUBS_OT_PROMO_SERVICE1 Class @110-FCB6E20C

class clsV_SUBS_OT_PROMO_SERVICE1DataSource extends clsDBConn {  //V_SUBS_OT_PROMO_SERVICE1DataSource Class @110-B696900C

//DataSource Variables @110-80B50D18
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @110-2BAACF88
...
} //End V_SUBS_OT_PROMO_SERVICE1DataSource Class @110-FCB6E20C

//Initialize Page @1-227A439E
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "sub_promo.html";
$BlockToParse = "main";
...
//Include events file @1-6CB417BE
include_once("./sub_promo_events.php");
...
// Controls
$V_SUBS_OT_PROMO_SERVICE = & new clsGridV_SUBS_OT_PROMO_SERVICE("", $MainPage);
$SubscribInfo = & new clsRecordSubscribInfo("", $MainPage);
$V_SUBS_OT_PROMO_SERVICE1 = & new clsGridV_SUBS_OT_PROMO_SERVICE1("", $MainPage);
$MainPage->V_SUBS_OT_PROMO_SERVICE = & $V_SUBS_OT_PROMO_SERVICE;
$MainPage->SubscribInfo = & $SubscribInfo;
$MainPage->V_SUBS_OT_PROMO_SERVICE1 = & $V_SUBS_OT_PROMO_SERVICE1;
$V_SUBS_OT_PROMO_SERVICE->Initialize();
...
//Go to destination page @1-8F58882A
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($V_SUBS_OT_PROMO_SERVICE);
    unset($SubscribInfo);
...
//Show Page @1-CED784E7
$V_SUBS_OT_PROMO_SERVICE->Show();
$SubscribInfo->Show();
