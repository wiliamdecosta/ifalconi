...
function BindEvents()
{
    ...
    $CustomerForm->ds->CCSEvents["AfterExecuteDelete"] = "CustomerForm_ds_AfterExecuteDelete";
    $CustomerForm->ds->CCSEvents["BeforeExecuteDelete"] = "CustomerForm_ds_BeforeExecuteDelete";
...
//CustomerForm_ds_AfterExecuteDelete @97-5C5F62AF
function CustomerForm_ds_AfterExecuteDelete(& $sender)
{
    $CustomerForm_ds_AfterExecuteDelete = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $CustomerForm; //Compatibility
//End CustomerForm_ds_AfterExecuteDelete

//Custom Code @335-2A29BDB7
// -------------------------
    // Write your own code here.
	ob_end_clean();
	//exit;
...
//Close CustomerForm_ds_AfterExecuteDelete @97-0F7ED532
    return $CustomerForm_ds_AfterExecuteDelete;
}
//End Close CustomerForm_ds_AfterExecuteDelete

//CustomerForm_ds_BeforeExecuteDelete @97-ED17F813
function CustomerForm_ds_BeforeExecuteDelete(& $sender)
{
    $CustomerForm_ds_BeforeExecuteDelete = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $CustomerForm; //Compatibility
//End CustomerForm_ds_BeforeExecuteDelete
...
//Close CustomerForm_ds_BeforeExecuteDelete @97-4EB33986
    return $CustomerForm_ds_BeforeExecuteDelete;
}
//End Close CustomerForm_ds_BeforeExecuteDelete

//Page_OnInitializeView @1-15C8DC36
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $customer_master; //Compatibility
