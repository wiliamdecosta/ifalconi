<?php
//Include Common Files @1-E67E9245
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_data/");
define("FileName", "subscriber_feature.php");
...
//Class_Initialize Event @2-09CC71C9
    function clsGridBUNDLEDFEATURE($RelativePath, & $Parent)
    {
        ...
        $this->Editlink->Page = "subscriber_feature_bundled_form.php";
        ...
        $this->ServicePromo_Insert->Parameters = CCGetQueryString("QueryString", array("SUBSCRIBER_BUNDLED_FEATURE_ID", "ccsForm"));
        $this->ServicePromo_Insert->Page = "subscriber_feature_bundled_form.php";
    }
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->Editlink->Parameters = CCAddParam($this->Editlink->Parameters, "SUBSCRIBER_BUNDLED_FEATURE_ID", $this->DataSource->f("SUBSCRIBER_BUNDLED_FEATURE_ID"));
...
//DataSource Variables @2-BA165D4B
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-DC1722F9
...
//Class_Initialize Event @110-78A2305B
    function clsGridFEATURE($RelativePath, & $Parent)
    {
        ...
        $this->Editlink = & new clsControl(ccsLink, "Editlink", "Editlink", ccsText, "", CCGetRequestParam("Editlink", ccsGet, NULL), $this);
        $this->Editlink->HTML = true;
        $this->Editlink->Page = "subscriber_feature_form.php";
        $this->BUNDLED_FEATURE_CODE = & new clsControl(ccsLabel, "BUNDLED_FEATURE_CODE", "BUNDLED_FEATURE_CODE", ccsText, "", CCGetRequestParam("BUNDLED_FEATURE_CODE", ccsGet, NULL), $this);
        ...
        $this->SUBSCRIBER_FEATURE_ID = & new clsControl(ccsHidden, "SUBSCRIBER_FEATURE_ID", "SUBSCRIBER_FEATURE_ID", ccsText, "", CCGetRequestParam("SUBSCRIBER_FEATURE_ID", ccsGet, NULL), $this);
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 5, tpCentered, $this);
        $this->Navigator->PageSizes = array("1", "5", "10", "25", "50");
        $this->ServicePromo_Insert = & new clsControl(ccsLink, "ServicePromo_Insert", "ServicePromo_Insert", ccsText, "", CCGetRequestParam("ServicePromo_Insert", ccsGet, NULL), $this);
        $this->ServicePromo_Insert->HTML = true;
        $this->ServicePromo_Insert->Parameters = CCGetQueryString("QueryString", array("SUBSCRIBER_FEATURE_ID", "ccsForm"));
        $this->ServicePromo_Insert->Page = "subscriber_feature_form.php";
    }
//End Class_Initialize Event
...
//Show Method @110-BFEB07F8
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["SUBSCRIBER_FEATURE_ID"] = $this->SUBSCRIBER_FEATURE_ID->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                $this->RowNumber++;
                if ($this->HasRecord) {
                    $this->DataSource->next_record();
                ...
                $this->Editlink->SetValue($this->DataSource->Editlink->GetValue());
                $this->Editlink->Parameters = CCGetQueryString("QueryString", array("FLAG", "ccsForm"));
                $this->Editlink->Parameters = CCAddParam($this->Editlink->Parameters, "SUBSCRIBER_FEATURE_ID", $this->DataSource->f("SUBSCRIBER_FEATURE_ID"));
                $this->BUNDLED_FEATURE_CODE->SetValue($this->DataSource->BUNDLED_FEATURE_CODE->GetValue());
...
//GetErrors Method @110-A9325E36
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->SUBSCRIBER_FEATURE_ID->Errors->ToString());
        $errors = ComposeStrings($errors, $this->Errors->ToString());
        $errors = ComposeStrings($errors, $this->DataSource->Errors->ToString());
        return $errors;
    }
...
//DataSource Variables @110-559A74B3
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @110-1573A2AC
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "subscriber_feature.html";
$BlockToParse = "main";
...
//Include events file @1-0F8CE979
include_once("./subscriber_feature_events.php");
