<?php
//Include Common Files @1-8F3A753C
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_data/");
define("FileName", "entry_bill_ticket.php");
...
//Class_Initialize Event @2-DC24DFD1
    function clsGridENTRY_BILL_TICKET($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "entry_bill_ticket.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "entry_bill_ticket.php";
        ...
        $this->BATCH_Insert = & new clsControl(ccsLink, "BATCH_Insert", "BATCH_Insert", ccsText, "", CCGetRequestParam("BATCH_Insert", ccsGet, NULL), $this);
        $this->BATCH_Insert->HTML = true;
        $this->BATCH_Insert->Parameters = CCGetQueryString("QueryString", array("T_BILL_TICKET_ID", "FLAG", "s_keyword", "ccsForm"));
        $this->BATCH_Insert->Page = "entry_bill_ticket.php";
    }
...
//Prepare Method @2-8A426796
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urlT_BILL_TICKET_ID", ccsFloat, "", "", $this->Parameters["urlT_BILL_TICKET_ID"], -99, false);
    }
//End Prepare Method

//Open Method @2-A0E25BF5
    function Open()
    {
        ...
        "	UPPER(to_char(TICKET_DATE,'dd-MON-yyyy')) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') OR\n" .
...
//Operation Method @3-CA0BF07C
    function Operation()
    {
        ...
        $Redirect = "entry_bill_ticket.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "entry_bill_ticket.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @19-51FC21D5
...
//CheckErrors Method @19-B9B3CD94
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @19-68CDFADD
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "entry_bill_ticket.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "FLAG", "T_BILL_TICKET_ID"));
...
//DataSource Variables @19-9CE4CB92
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @19-92E8CAEE
...
//Insert Method @19-67E45959
    function Insert()
    {
        ...
        "        " . $this->SQLValue($this->cp["TICKET_AMOUNT"]->GetDBValue(), ccsFloat) . ", " . $this->SQLValue($this->cp["TICKET_REASON_ID"]->GetDBValue(), ccsFloat) . ", '" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "', " . $this->SQLValue($this->cp["TICKET_AMOUNT"]->GetDBValue(), ccsFloat) . ", \n" .
...
//Update Method @19-1315059F
    function Update()
    {
        ...
        "       FINAL_AMOUNT = " . $this->SQLValue($this->cp["TICKET_AMOUNT"]->GetDBValue(), ccsFloat) . ",\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "entry_bill_ticket.html";
$BlockToParse = "main";
...
//Include events file @1-BAD9E896
include_once("./entry_bill_ticket_events.php");
