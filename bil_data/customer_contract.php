<?php
//Include Common Files @1-EB7BCCE9
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_data/");
define("FileName", "customer_contract.php");
...
//Class_Initialize Event @2-C49D1FAC
    function clsGridCustomerContractGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "customer_contract.php";
        ...
        $this->CustomerContractInsert->Page = "customer_contract.php";
    }
...
//Class_Initialize Event @97-23FA958A
    function clsRecordCustomerContractRecord($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            if(!$this->FormSubmitted) {
                ...
                if(!is_array($this->CONTRACT_DATE->Value) && !strlen($this->CONTRACT_DATE->Value) && $this->CONTRACT_DATE->Value !== false)
                    $this->CONTRACT_DATE->SetValue(time());
            }
        }
    }
//End Class_Initialize Event
...
//Operation Method @97-1E3AA4DE
    function Operation()
    {
        ...
        $Redirect = "customer_contract.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "customer_contract.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "CUSTOMER_CONTRACT_ID"));
            if(!CCGetEvent($this->Button_Delete->CCSEvents, "OnClick", $this->Button_Delete) || !$this->DeleteRow()) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "Button_Cancel") {
            $Redirect = "customer_contract.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH"));
...
//Class_Initialize Event @86-8503ADAC
    function clsRecordCustomer_Inf($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->FormSubmitted = ($FormName == $this->ComponentName);
            $Method = $this->FormSubmitted ? ccsPost : ccsGet;
            $this->CUSTOMER_ID = & new clsControl(ccsLabel, "CUSTOMER_ID", "CUSTOMER_ID", ccsText, "", CCGetRequestParam("CUSTOMER_ID", $Method, NULL), $this);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "customer_contract.html";
$BlockToParse = "main";
...
//Include events file @1-C892BA58
include_once("./customer_contract_events.php");
...
//Execute Components @1-B0F7BE68
$CustomerContractRecord->Operation();
$Customer_Inf->Operation();
//End Execute Components

//Go to destination page @1-E05A46EF
if($Redirect)
{
