...
">
			<Components>
				...
				<Link id="139" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="CUSTOMER_INFOgridDLink" hrefSource="customer_info.ccp" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="FLAG" html="True" wizardUseTemplateBlock="True">
					<Components/>
					<Events/>
					<LinkParameters>
...
WHERE  CUSTOMER_INFO_ID={CUSTOMER_INFO_ID}">
			<Components>
				<Button id="98" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" PathID="CUSTOMER_INFOrecordButton_Insert" removeParameters="TAMBAH" returnPage="customer_info.ccp">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Button id="100" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" PathID="CUSTOMER_INFOrecordButton_Delete" removeParameters="TAMBAH;CUSTOMER_INFO_ID" returnPage="customer_info.ccp">
					<Components/>
					<Events>
...
<Actions>
<Action actionName="Custom Code" actionCategory="General" id="432"/>
</Actions>
</Event>
</Events>
					<Attributes/>
			...
			<Events>
				...
				<Event name="BeforeExecuteDelete" type="Server">
					<Actions>
						<Action actionName="Custom Code" actionCategory="General" id="430"/>
					</Actions>
				</Event>
				<Event name="AfterExecuteDelete" type="Server">
					<Actions>
						<Action actionName="Custom Code" actionCategory="General" id="431"/>
					</Actions>
				</Event>
			</Events>
			<TableParameters>
			...
			<USQLParameters>
				...
				<SQLParameter id="398" variable="CUSTOMER_INFO_ID" dataType="Float" parameterType="Control" parameterSource="CUSTOMER_INFO_ID" defaultValue="0"/>
				...
				<SQLParameter id="403" variable="INFO_TYPE_ID" dataType="Float" parameterType="Control" parameterSource="INFO_TYPE_ID" defaultValue="0"/>
			</USQLParameters>
			<UConditions>
			...
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="382" variable="CUSTOMER_INFO_ID" parameterType="Control" dataType="Float" parameterSource="CUSTOMER_INFO_ID" defaultValue="0"/>
			</DSQLParameters>
			<DConditions>
...
WHERE  P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_INPUT_FILE_DESC WHERE P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" pasteAsReplace="pasteAsReplace">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="customer_info_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="customer_info.php" forShow="True" url="customer_info.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
