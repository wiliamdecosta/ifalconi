<?php
//BindEvents Method @1-57578BD9
function BindEvents()
{
    global $V_SUM_AR3210Grid;
    global $CCSEvents;
    $V_SUM_AR3210Grid->CCSEvents["BeforeShowRow"] = "V_SUM_AR3210Grid_BeforeShowRow";
...
//V_SUM_AR3210Grid_BeforeShowRow @282-ADCCD077
function V_SUM_AR3210Grid_BeforeShowRow(& $sender)
{
    $V_SUM_AR3210Grid_BeforeShowRow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_SUM_AR3210Grid; //Compatibility
//End V_SUM_AR3210Grid_BeforeShowRow
...
//Close V_SUM_AR3210Grid_BeforeShowRow @282-2318C718
    return $V_SUM_AR3210Grid_BeforeShowRow;
}
//End Close V_SUM_AR3210Grid_BeforeShowRow

//Page_BeforeShow @1-6C7DBE6F
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_SUM_AR3210; //Compatibility
//End Page_BeforeShow
