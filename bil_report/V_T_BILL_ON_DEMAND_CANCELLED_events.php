<?php
//BindEvents Method @1-655C9B44
function BindEvents()
{
    global $V_T_BILL_ON_DEMAND_CANCELLEDGrid;
    global $CCSEvents;
    $V_T_BILL_ON_DEMAND_CANCELLEDGrid->CCSEvents["BeforeShowRow"] = "V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow";
...
//V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow @282-BBEEE132
function V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow(& $sender)
{
    $V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_T_BILL_ON_DEMAND_CANCELLEDGrid; //Compatibility
//End V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow
...
//Close V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow @282-D567C387
    return $V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow;
}
//End Close V_T_BILL_ON_DEMAND_CANCELLEDGrid_BeforeShowRow

//Page_BeforeShow @1-45A4F554
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_T_BILL_ON_DEMAND_CANCELLED; //Compatibility
//End Page_BeforeShow
