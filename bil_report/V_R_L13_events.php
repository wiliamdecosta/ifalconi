<?php
//BindEvents Method @1-13F89156
function BindEvents()
{
    global $V_R_L13Grid;
    global $CCSEvents;
    $V_R_L13Grid->CCSEvents["BeforeShowRow"] = "V_R_L13Grid_BeforeShowRow";
...
//V_R_L13Grid_BeforeShowRow @282-BF1B92F8
function V_R_L13Grid_BeforeShowRow(& $sender)
{
    $V_R_L13Grid_BeforeShowRow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_R_L13Grid; //Compatibility
//End V_R_L13Grid_BeforeShowRow
...
//Close V_R_L13Grid_BeforeShowRow @282-3B2A1073
    return $V_R_L13Grid_BeforeShowRow;
}
//End Close V_R_L13Grid_BeforeShowRow

//Page_BeforeShow @1-A3051442
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_R_L13; //Compatibility
//End Page_BeforeShow
