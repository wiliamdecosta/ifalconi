<?php
//Include Common Files @1-399237A4
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_report/");
define("FileName", "V_R_L13.php");
...
class clsRecordV_R_L13Search { //V_R_L13Search Class @3-C5B8C170
...
//Class_Initialize Event @3-B22A5308
    function clsRecordV_R_L13Search($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record V_R_L13Search/Error";
        $this->DataSource = new clsV_R_L13SearchDataSource($this);
        $this->ds = & $this->DataSource;
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "V_R_L13Search";
...
//Operation Method @3-21E1386C
    function Operation()
    {
        ...
        $Redirect = "V_R_L13.php" . "?" . CCGetQueryString("All", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "V_R_L13.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "TAMBAH", "BATCH_CONTROL_ID")), CCGetQueryString("QueryString", array("Invoice_date", "bill_cycle_code", "finance_period_code", "INPUT_DATA_CONTROL_ID", "CURRENCY_CODE", "ccsForm", "TAMBAH", "BATCH_CONTROL_ID")));
...
} //End V_R_L13Search Class @3-FCB6E20C

class clsV_R_L13SearchDataSource extends clsDBConn {  //V_R_L13SearchDataSource Class @3-B7521CC5
...
//DataSourceClass_Initialize Event @3-E95816FB
    function clsV_R_L13SearchDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record V_R_L13Search/Error";
        $this->Initialize();
...
} //End V_R_L13SearchDataSource Class @3-FCB6E20C

class clsGridV_R_L13Grid { //V_R_L13Grid class @282-A7632E8C
...
//Class_Initialize Event @282-C3A85847
    function clsGridV_R_L13Grid($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "V_R_L13Grid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid V_R_L13Grid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsV_R_L13GridDataSource($this);
        $this->ds = & $this->DataSource;
...
} //End V_R_L13Grid Class @282-FCB6E20C

class clsV_R_L13GridDataSource extends clsDBConn {  //V_R_L13GridDataSource Class @282-C3E5740B
...
//DataSourceClass_Initialize Event @282-A3C73E3E
    function clsV_R_L13GridDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid V_R_L13Grid";
        $this->Initialize();
...
} //End V_R_L13GridDataSource Class @282-FCB6E20C

//Initialize Page @1-7963543E
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
//Include events file @1-61D16DD6
include_once("./V_R_L13_events.php");
...
// Controls
$V_R_L13Search = & new clsRecordV_R_L13Search("", $MainPage);
$V_R_L13Grid = & new clsGridV_R_L13Grid("", $MainPage);
$Button1 = & new clsButton("Button1", ccsGet, $MainPage);
$MainPage->V_R_L13Search = & $V_R_L13Search;
$MainPage->V_R_L13Grid = & $V_R_L13Grid;
$MainPage->Button1 = & $Button1;
$V_R_L13Search->Initialize();
$V_R_L13Grid->Initialize();
...
//Execute Components @1-BEB38C36
$V_R_L13Search->Operation();
//End Execute Components

//Go to destination page @1-6C1B2207
if($Redirect)
{
