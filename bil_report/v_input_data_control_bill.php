<?php
//Include Common Files @1-190B9643
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_report/");
define("FileName", "v_input_data_control_bill.php");
...
class clsRecordv_input_data_control_billSearch { //v_input_data_control_billSearch Class @3-EA7892BD
...
//Class_Initialize Event @3-2A530E0B
    function clsRecordv_input_data_control_billSearch($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record v_input_data_control_billSearch/Error";
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "v_input_data_control_billSearch";
...
//Operation Method @3-FAFD7E7A
    function Operation()
    {
        ...
        $Redirect = "v_input_data_control_bill.php" . "?" . CCGetQueryString("All", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "v_input_data_control_bill.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "TAMBAH", "BATCH_CONTROL_ID")), CCGetQueryString("QueryString", array("s_keyword", "ccsForm", "TAMBAH", "BATCH_CONTROL_ID")));
...
} //End v_input_data_control_billSearch Class @3-FCB6E20C



class clsGridv_input_data_control_billGrid { //v_input_data_control_billGrid class @282-DB5C779F
...
//Class_Initialize Event @282-0E94CD31
    function clsGridv_input_data_control_billGrid($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "v_input_data_control_billGrid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid v_input_data_control_billGrid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsv_input_data_control_billGridDataSource($this);
        ...
        $this->DLink->Page = "v_input_data_control_bill.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "v_input_data_control_bill.php";
...
} //End v_input_data_control_billGrid Class @282-FCB6E20C

class clsv_input_data_control_billGridDataSource extends clsDBConn {  //v_input_data_control_billGridDataSource Class @282-D2E52EF4
...
//DataSourceClass_Initialize Event @282-AF951CE9
    function clsv_input_data_control_billGridDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid v_input_data_control_billGrid";
        $this->Initialize();
...
} //End v_input_data_control_billGridDataSource Class @282-FCB6E20C

//Initialize Page @1-21D6D51A
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "v_input_data_control_bill.html";
$BlockToParse = "main";
...
//Include events file @1-8B8A4CA5
include_once("./v_input_data_control_bill_events.php");
...
// Controls
$v_input_data_control_billSearch = & new clsRecordv_input_data_control_billSearch("", $MainPage);
$v_input_data_control_billGrid = & new clsGridv_input_data_control_billGrid("", $MainPage);
$MainPage->v_input_data_control_billSearch = & $v_input_data_control_billSearch;
$MainPage->v_input_data_control_billGrid = & $v_input_data_control_billGrid;
$v_input_data_control_billGrid->Initialize();
...
//Execute Components @1-E0A74885
$v_input_data_control_billSearch->Operation();
//End Execute Components

//Go to destination page @1-221E416A
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($v_input_data_control_billSearch);
    unset($v_input_data_control_billGrid);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-FFA90887
$v_input_data_control_billSearch->Show();
$v_input_data_control_billGrid->Show();
$Tpl->block_path = "";
