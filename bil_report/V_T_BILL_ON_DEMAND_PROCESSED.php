<?php
//Include Common Files @1-75108CE6
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_process/");
define("FileName", "V_T_BILL_ON_DEMAND_PROCESSED.php");
...
class clsGridV_T_BILL_ON_DEMAND_PROCESSEDGrid { //V_T_BILL_ON_DEMAND_PROCESSEDGrid class @282-E1375CC3
...
//Class_Initialize Event @282-B1E5F897
    function clsGridV_T_BILL_ON_DEMAND_PROCESSEDGrid($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "V_T_BILL_ON_DEMAND_PROCESSEDGrid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid V_T_BILL_ON_DEMAND_PROCESSEDGrid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsV_T_BILL_ON_DEMAND_PROCESSEDGridDataSource($this);
...
} //End V_T_BILL_ON_DEMAND_PROCESSEDGrid Class @282-FCB6E20C

class clsV_T_BILL_ON_DEMAND_PROCESSEDGridDataSource extends clsDBConn {  //V_T_BILL_ON_DEMAND_PROCESSEDGridDataSource Class @282-A9CB7E4A
...
//DataSourceClass_Initialize Event @282-F5EFCD07
    function clsV_T_BILL_ON_DEMAND_PROCESSEDGridDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid V_T_BILL_ON_DEMAND_PROCESSEDGrid";
        $this->Initialize();
...
//Open Method @282-D6153CEE
    function Open()
    {
        ...
        "\n" .
        "WHERE\n" .
        "IS_FINISH_PROCESSED = 'Y' {SQL_OrderBy}";
...
} //End V_T_BILL_ON_DEMAND_PROCESSEDGridDataSource Class @282-FCB6E20C

//Initialize Page @1-AB810FE3
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "V_T_BILL_ON_DEMAND_PROCESSED.html";
$BlockToParse = "main";
...
//Include events file @1-B77BFA81
include_once("./V_T_BILL_ON_DEMAND_PROCESSED_events.php");
...
// Controls
$V_T_BILL_ON_DEMAND_PROCESSEDGrid = & new clsGridV_T_BILL_ON_DEMAND_PROCESSEDGrid("", $MainPage);
$MainPage->V_T_BILL_ON_DEMAND_PROCESSEDGrid = & $V_T_BILL_ON_DEMAND_PROCESSEDGrid;
$V_T_BILL_ON_DEMAND_PROCESSEDGrid->Initialize();
...
//Go to destination page @1-AF074FC3
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($V_T_BILL_ON_DEMAND_PROCESSEDGrid);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-EADC313E
$V_T_BILL_ON_DEMAND_PROCESSEDGrid->Show();
$Tpl->block_path = "";
