...
class clsRecordV_R_L13_BILLINGSearch { //V_R_L13_BILLINGSearch Class @3-704A10D6
...
//Class_Initialize Event @3-F6E56E71
    function clsRecordV_R_L13_BILLINGSearch($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record V_R_L13_BILLINGSearch/Error";
        $this->DataSource = new clsV_R_L13_BILLINGSearchDataSource($this);
        $this->ds = & $this->DataSource;
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "V_R_L13_BILLINGSearch";
...
//Operation Method @3-5B16507B
    function Operation()
    {
        ...
        $Redirect = "V_R_L13_BILLING.php" . "?" . CCGetQueryString("All", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "V_R_L13_BILLING.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "TAMBAH", "BATCH_CONTROL_ID")), CCGetQueryString("QueryString", array("Invoice_date", "bill_cycle_code", "finance_period_code", "INPUT_DATA_CONTROL_ID", "CURRENCY_CODE", "ccsForm", "TAMBAH", "BATCH_CONTROL_ID")));
...
} //End V_R_L13_BILLINGSearch Class @3-FCB6E20C

class clsV_R_L13_BILLINGSearchDataSource extends clsDBConn {  //V_R_L13_BILLINGSearchDataSource Class @3-AE140ADB
...
//DataSourceClass_Initialize Event @3-C299039B
    function clsV_R_L13_BILLINGSearchDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record V_R_L13_BILLINGSearch/Error";
        $this->Initialize();
...
} //End V_R_L13_BILLINGSearchDataSource Class @3-FCB6E20C

class clsGridV_R_L13_BILLINGGrid { //V_R_L13_BILLINGGrid class @282-4226E6D4
...
//Class_Initialize Event @282-6CB0A412
    function clsGridV_R_L13_BILLINGGrid($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "V_R_L13_BILLINGGrid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid V_R_L13_BILLINGGrid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsV_R_L13_BILLINGGridDataSource($this);
        $this->ds = & $this->DataSource;
        ...
        $this->SUB_BUSINESS_AREA_NAME = & new clsControl(ccsLabel, "SUB_BUSINESS_AREA_NAME", "SUB_BUSINESS_AREA_NAME", ccsText, "", CCGetRequestParam("SUB_BUSINESS_AREA_NAME", ccsGet, NULL), $this);
...
//Show Method @282-AF803B2D
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["SUB_BUSINESS_AREA_NAME"] = $this->SUB_BUSINESS_AREA_NAME->Visible;
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->SUB_BUSINESS_AREA_NAME->SetValue($this->DataSource->SUB_BUSINESS_AREA_NAME->GetValue());
                ...
                $this->SUB_BUSINESS_AREA_NAME->Show();
...
//GetErrors Method @282-EDCFF0F9
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->SUB_BUSINESS_AREA_NAME->Errors->ToString());
...
} //End V_R_L13_BILLINGGrid Class @282-FCB6E20C

class clsV_R_L13_BILLINGGridDataSource extends clsDBConn {  //V_R_L13_BILLINGGridDataSource Class @282-8CA176F0

//DataSource Variables @282-D9E452D5
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    var $CHARGE_AMOUNT;
    var $SUB_BUSINESS_AREA_NAME;
    var $CUSTOMER_SEGMENT_CODE;
    var $SUBSCRIBER_SEGMENT_CODE;
    var $SERVICE_GROUP_CODE;
//End DataSource Variables

//DataSourceClass_Initialize Event @282-5458FEDC
    function clsV_R_L13_BILLINGGridDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid V_R_L13_BILLINGGrid";
        $this->Initialize();
        ...
        $this->SUB_BUSINESS_AREA_NAME = new clsField("SUB_BUSINESS_AREA_NAME", ccsText, "");
...
//SetOrder Method @282-FE201189
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "BUSINESS_AREA_NAME";
...
//SetValues Method @282-921277EF
    function SetValues()
    {
        ...
        $this->SUB_BUSINESS_AREA_NAME->SetDBValue($this->f("SUB_BUSINESS_AREA_NAME"));
...
} //End V_R_L13_BILLINGGridDataSource Class @282-FCB6E20C
...
// Controls
$V_R_L13_BILLINGSearch = & new clsRecordV_R_L13_BILLINGSearch("", $MainPage);
$V_R_L13_BILLINGGrid = & new clsGridV_R_L13_BILLINGGrid("", $MainPage);
$MainPage->V_R_L13_BILLINGSearch = & $V_R_L13_BILLINGSearch;
$MainPage->V_R_L13_BILLINGGrid = & $V_R_L13_BILLINGGrid;
$V_R_L13_BILLINGSearch->Initialize();
$V_R_L13_BILLINGGrid->Initialize();
...
//Execute Components @1-A732AAAD
$V_R_L13_BILLINGSearch->Operation();
//End Execute Components

//Go to destination page @1-10A42A9A
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($V_R_L13_BILLINGSearch);
    unset($V_R_L13_BILLINGGrid);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-2CA32CBA
$V_R_L13_BILLINGSearch->Show();
$V_R_L13_BILLINGGrid->Show();
$Tpl->block_path = "";
