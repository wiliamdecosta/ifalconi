<?php
//BindEvents Method @1-D642E394
function BindEvents()
{
    global $R_STAMP_DUTYGrid;
    global $CCSEvents;
    $R_STAMP_DUTYGrid->CCSEvents["BeforeShowRow"] = "R_STAMP_DUTYGrid_BeforeShowRow";
...
//R_STAMP_DUTYGrid_BeforeShowRow @282-7E157CAB
function R_STAMP_DUTYGrid_BeforeShowRow(& $sender)
{
    $R_STAMP_DUTYGrid_BeforeShowRow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $R_STAMP_DUTYGrid; //Compatibility
//End R_STAMP_DUTYGrid_BeforeShowRow
...
//Close R_STAMP_DUTYGrid_BeforeShowRow @282-B1455476
    return $R_STAMP_DUTYGrid_BeforeShowRow;
}
//End Close R_STAMP_DUTYGrid_BeforeShowRow

//Page_BeforeShow @1-90961B3B
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $R_STAMP_DUTY; //Compatibility
//End Page_BeforeShow
