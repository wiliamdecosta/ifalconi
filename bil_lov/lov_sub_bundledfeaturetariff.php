<?php
//Include Common Files @1-7E14CAEC
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_sub_bundledfeaturetariff.php");
...
//Operation Method @3-87D6ED9A
    function Operation()
    {
        ...
        $Redirect = "lov_sub_bundledfeaturetariff.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_sub_bundledfeaturetariff.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
//Class_Initialize Event @2-707BD8E1
...
//DataSource Variables @2-B51B8A67
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-BC50CAC6
...
//Open Method @2-D9563276
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT b.CODE,\n" .
        "    b.P_BUNDLED_FEATURE_ID\n" .
        "FROM SUBSCRIBER_BUNDLED_FEATURE a,\n" .
        "    P_BUNDLED_FEATURE b\n" .
        "WHERE a.SUBSCRIBER_ID = " . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . " AND\n" .
        "    a.P_BUNDLED_FEATURE_ID = b.P_BUNDLED_FEATURE_ID) cnt";
        $this->SQL = "SELECT b.CODE,\n" .
        "    b.P_BUNDLED_FEATURE_ID\n" .
        "FROM SUBSCRIBER_BUNDLED_FEATURE a,\n" .
        "    P_BUNDLED_FEATURE b\n" .
        "WHERE a.SUBSCRIBER_ID = " . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . " AND\n" .
        "    a.P_BUNDLED_FEATURE_ID = b.P_BUNDLED_FEATURE_ID {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_sub_bundledfeaturetariff.html";
$BlockToParse = "main";
...
//Include events file @1-4F66892E
include_once("./lov_sub_bundledfeaturetariff_events.php");
