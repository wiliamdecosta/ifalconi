<?php
//Include Common Files @1-20069991
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_sub_feature_type.php");
...
//Operation Method @3-5A7EB733
    function Operation()
    {
        ...
        $Redirect = "lov_sub_feature_type.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_sub_feature_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
//Class_Initialize Event @2-EAA1601D
...
//DataSource Variables @2-275C23AA
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-88FE9C14
...
//Open Method @2-789723B7
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT b.CODE FEATURE_TYPE_CODE,\n" .
        ...
        "(	b.CODE LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'))\n" .
        ") cnt";
        $this->SQL = "SELECT b.CODE FEATURE_TYPE_CODE,\n" .
        "    a.P_SERVICE_CATEGORY_ID,\n" .
        "    a.P_FEATURE_TYPE_ID\n" .
        "FROM P_SERVICE_CATEGORY a,\n" .
        "    P_FEATURE_TYPE b\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_sub_feature_type.html";
$BlockToParse = "main";
...
//Include events file @1-FFCB9EC2
include_once("./lov_sub_feature_type_events.php");
