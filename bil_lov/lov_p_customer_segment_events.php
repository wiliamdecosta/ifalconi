...
// -------------------------
	...
	$nilai=$P_CUSTOMER_SEGMENT->P_CUSTOMER_SEGMENT_ID->GetValue()."#~#".$P_CUSTOMER_SEGMENT->CODE->GetValue();
	$P_CUSTOMER_SEGMENT->Label1->SetValue("<input type=button value='PILIH' class=Button onclick=\"javascript:clickReturn('".$nilai."')\">");
// -------------------------
//End Custom Code
