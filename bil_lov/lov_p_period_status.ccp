...
WHERE P_STATUS_TYPE_ID = 1 AND
UPPER(CODE) LIKE UPPER('%{s_keyword}%')" name="P_PERIOD_STATUS" orderBy="P_PERIOD_STATUS_ID" pageSizeLimit="100" wizardCaption=" P PERIOD STATUS " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="no records">
			<Components>
				<Hidden id="9" fieldSourceType="DBColumn" dataType="Float" html="False" name="P_STATUS_LIST_ID" fieldSource="P_STATUS_LIST_ID" wizardCaption="ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="P_PERIOD_STATUSP_STATUS_LIST_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
