<?php
//Include Common Files @1-D6FD47D4
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_account_rep.php");
...
//Class_Initialize Event @2-1671B4DE
    function clsGridP_ACCOUNT_REP($RelativePath, & $Parent)
    {
        ...
        $this->P_ACCOUNT_REP_ID = & new clsControl(ccsHidden, "P_ACCOUNT_REP_ID", "P_ACCOUNT_REP_ID", ccsText, "", CCGetRequestParam("P_ACCOUNT_REP_ID", ccsGet, NULL), $this);
...
//DataSource Variables @2-11686169
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-8F710E53
    function clsP_ACCOUNT_REPDataSource(& $Parent)
    {
        ...
        $this->P_ACCOUNT_REP_ID = new clsField("P_ACCOUNT_REP_ID", ccsText, "");
...
//Open Method @2-5B1ECEF6
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_ACCOUNT_REP\n" .
        "WHERE (\n" .
        "UPPER(ACCOUNT_NAME) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') OR\n" .
        "UPPER(EMPLOYEE_NO) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        ")) cnt";
        $this->SQL = "SELECT * FROM P_ACCOUNT_REP\n" .
        "WHERE (\n" .
        "UPPER(ACCOUNT_NAME) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') OR\n" .
        "UPPER(EMPLOYEE_NO) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        ")";
...
//Operation Method @3-1995D08E
    function Operation()
    {
        ...
        $Redirect = "lov_p_account_rep.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_account_rep.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_account_rep.html";
$BlockToParse = "main";
...
//Include events file @1-8E72C053
include_once("./lov_p_account_rep_events.php");
...
//Go to destination page @1-63EC5CA5
if($Redirect)
{
