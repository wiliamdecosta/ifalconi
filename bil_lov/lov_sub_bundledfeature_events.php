...
//End BUNDLED_FEATURE_BeforeShowRow
  ...
  // -------------------------
  	...
  	$nilai=$BUNDLED_FEATURE->P_BUNDLED_FEATURE_ID->GetValue()."#~#".$BUNDLED_FEATURE->CODE->GetValue()."#~#".$BUNDLED_FEATURE->SERVICE_TYPE_CODE->GetValue()."#~#".$BUNDLED_FEATURE->TARIFF_LOCATION_CODE->GetValue();
