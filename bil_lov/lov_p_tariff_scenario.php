<?php
//Include Common Files @1-0697D556
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_tariff_scenario.php");
...
//Class_Initialize Event @2-DC8C7023
...
//DataSource Variables @2-F2AA11A1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-C42D1BF6
...
//Open Method @2-FEC7AF00
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT P_TARIFF_SCENARIO_ID,CODE,P_SERVICE_TYPE_ID,P_USAGE_TARIFF_SCENARIO_ID,P_ONETIME_TARIFF_SCENARIO_ID,P_RECURR_TARIFF_SCENARIO_ID,VALID_FROM,VALID_TO,DESCRIPTION,UPDATE_DATE,UPDATE_BY FROM P_TARIFF_SCENARIO WHERE UPPER(CODE)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        "AND P_SERVICE_TYPE_ID=" . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . ") cnt";
        $this->SQL = "SELECT P_TARIFF_SCENARIO_ID,CODE,P_SERVICE_TYPE_ID,P_USAGE_TARIFF_SCENARIO_ID,P_ONETIME_TARIFF_SCENARIO_ID,P_RECURR_TARIFF_SCENARIO_ID,VALID_FROM,VALID_TO,DESCRIPTION,UPDATE_DATE,UPDATE_BY FROM P_TARIFF_SCENARIO WHERE UPPER(CODE)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        "AND P_SERVICE_TYPE_ID=" . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . "";
...
//Operation Method @3-EF877B1F
    function Operation()
    {
        ...
        $Redirect = "lov_p_tariff_scenario.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_tariff_scenario.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_tariff_scenario.html";
$BlockToParse = "main";
...
//Include events file @1-9EFA7C52
include_once("./lov_p_tariff_scenario_events.php");
...
//Go to destination page @1-90BF0CDD
if($Redirect)
{
