...
">
			<Components>
				...
				<Hidden id="29" fieldSourceType="DBColumn" dataType="Text" name="P_REFERENCE_LIST_ID" PathID="P_TARIFF_LOCATIONP_REFERENCE_LIST_ID" fieldSource="P_REFERENCE_LIST_ID">
<Components/>
<Events/>
<Attributes/>
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_p_tariff_location_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_p_tariff_location.php" forShow="True" url="lov_p_tariff_location.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
