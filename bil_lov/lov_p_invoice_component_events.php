...
// -------------------------
	...
	$nilai=$P_INVOICE_COMPONENT->P_INVOICE_COMPONENT_ID->GetValue()."#~#".$P_INVOICE_COMPONENT->CODE->GetValue();
	$P_INVOICE_COMPONENT->Label1->SetValue("<input type=button value='PILIH' class=Button onclick=\"javascript:clickReturn('".$nilai."')\">");
// -------------------------
//End Custom Code
