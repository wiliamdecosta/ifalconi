...
// -------------------------
	...
	$nilai=$P_REGION->P_REGION_ID->GetValue()."#~#".$P_REGION->REGION_NAME->GetValue();
	$P_REGION->Label1->SetValue("<input type=button value='PILIH' class=Button onclick=\"javascript:clickReturn('".$nilai."')\">");
// -------------------------
//End Custom Code
