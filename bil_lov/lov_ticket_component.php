<?php
//Include Common Files @1-1A98450F
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_ticket_component.php");
...
//Class_Initialize Event @2-CB6299FF
...
//DataSource Variables @2-762AB962
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-622EE906
...
//Open Method @2-CFC5309D
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT CODE, P_TICKET_COMPONENT_ID\n" .
        "FROM P_TICKET_COMPONENT\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT CODE, P_TICKET_COMPONENT_ID\n" .
        "FROM P_TICKET_COMPONENT\n" .
...
//Operation Method @3-E7ABB64E
    function Operation()
    {
        ...
        $Redirect = "lov_ticket_component.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_ticket_component.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "TAMBAH", "BATCH_CONTROL_ID")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_ticket_component.html";
$BlockToParse = "main";
...
//Include events file @1-6EBB37F6
include_once("./lov_ticket_component_events.php");
