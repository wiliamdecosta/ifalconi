<?php
//Include Common Files @1-C571CF77
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_sub_featurepromotion.php");
...
//Class_Initialize Event @2-D44347E2
...
//DataSource Variables @2-F06C7A66
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-118207DD
...
//Open Method @2-86428446
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT a.CODE,a.P_FEATURE_PROMOTION_ID\n" .
        ...
        "               )\n" .
        ") cnt";
        $this->SQL = "SELECT a.CODE,a.P_FEATURE_PROMOTION_ID\n" .
        "        FROM P_FEATURE_PROMOTION a\n" .
        "        WHERE EXISTS\n" .
        "             (SELECT 1\n" .
        "              FROM P_FEATURE_PROMOTION_SERVICE b,\n" .
...
//Operation Method @3-BD623CCF
    function Operation()
    {
        ...
        $Redirect = "lov_sub_featurepromotion.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_sub_featurepromotion.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_sub_featurepromotion.html";
$BlockToParse = "main";
...
//Include events file @1-B65862E2
include_once("./lov_sub_featurepromotion_events.php");
