...
// -------------------------
	...
	$nilai=$P_SERVICE_TYPE->P_SERVICE_TYPE_ID->GetValue()."#~#".$P_SERVICE_TYPE->CODE->GetValue();
	$P_SERVICE_TYPE->Label1->SetValue("<input type=button value='PILIH' class=Button onclick=\"javascript:clickReturn('".$nilai."')\">");
// -------------------------
//End Custom Code
