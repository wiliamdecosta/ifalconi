<?php
//Include Common Files @1-4CFEB28B
define("RelativePath", "..");
...
class clsGridCUSTOMER_ACCOUNT { //CUSTOMER_ACCOUNT class @2-0D714E48
...
//Class_Initialize Event @2-52A09D7E
    function clsGridCUSTOMER_ACCOUNT($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "CUSTOMER_ACCOUNT";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid CUSTOMER_ACCOUNT";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsCUSTOMER_ACCOUNTDataSource($this);
...
} //End CUSTOMER_ACCOUNT Class @2-FCB6E20C

class clsCUSTOMER_ACCOUNTDataSource extends clsDBConn {  //CUSTOMER_ACCOUNTDataSource Class @2-D8129E84

//DataSource Variables @2-247A8EEB
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-290C08EE
    function clsCUSTOMER_ACCOUNTDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid CUSTOMER_ACCOUNT";
        $this->Initialize();
...
//Open Method @2-17F4BDD2
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT A.LAST_NAME, A.ACCOUNT_NO, A.CUSTOMER_ACCOUNT_ID FROM CUSTOMER_ACCOUNT A\n" .
        "WHERE UPPER(A.LAST_NAME) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT A.LAST_NAME, A.ACCOUNT_NO, A.CUSTOMER_ACCOUNT_ID FROM CUSTOMER_ACCOUNT A\n" .
        "WHERE UPPER(A.LAST_NAME) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')";
...
} //End CUSTOMER_ACCOUNTDataSource Class @2-FCB6E20C
...
//Operation Method @3-5DE67A74
    function Operation()
    {
        ...
        $Redirect = "lov_customer_account.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_customer_account.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
//Include events file @1-41CB3102
...
// Controls
$CUSTOMER_ACCOUNT = & new clsGridCUSTOMER_ACCOUNT("", $MainPage);
$P_SERVICE_TYPESearch = & new clsRecordP_SERVICE_TYPESearch("", $MainPage);
$MainPage->CUSTOMER_ACCOUNT = & $CUSTOMER_ACCOUNT;
$MainPage->P_SERVICE_TYPESearch = & $P_SERVICE_TYPESearch;
$CUSTOMER_ACCOUNT->Initialize();
...
//Go to destination page @1-FFB1AD1E
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($CUSTOMER_ACCOUNT);
