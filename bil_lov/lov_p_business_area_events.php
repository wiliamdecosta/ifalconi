...
// -------------------------
	...
	$nilai=$P_BUSINESS_AREA->P_BUSINESS_AREA_ID->GetValue()."#~#".str_replace(" ","",$P_BUSINESS_AREA->BUSINESS_AREA_NAME->GetValue());
	$P_BUSINESS_AREA->Label1->SetValue("<input type=button value=PILIH class=Button onclick=clickReturn('".$nilai."')>");
// -------------------------
//End Custom Code
