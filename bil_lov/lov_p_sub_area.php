<?php
//Include Common Files @1-DBC8E200
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_sub_area.php");
...
//Class_Initialize Event @2-5E5B4173
    function clsGridP_BUSINESS_AREA($RelativePath, & $Parent)
    {
        ...
        $this->P_SUB_BUSINESS_AREA_ID = & new clsControl(ccsHidden, "P_SUB_BUSINESS_AREA_ID", "P_SUB_BUSINESS_AREA_ID", ccsFloat, "", CCGetRequestParam("P_SUB_BUSINESS_AREA_ID", ccsGet, NULL), $this);
...
//Show Method @2-08BBD5AA
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            $this->ControlsVisible["P_SUB_BUSINESS_AREA_ID"] = $this->P_SUB_BUSINESS_AREA_ID->Visible;
...
//GetErrors Method @2-85819F71
    function GetErrors()
    {
        $errors = "";
        $errors = ComposeStrings($errors, $this->P_SUB_BUSINESS_AREA_ID->Errors->ToString());
...
//DataSource Variables @2-93FEB187
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-71F90B7E
...
//Prepare Method @2-07B8D451
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urlP_BUSINESS_AREA_ID", ccsFloat, "", "", $this->Parameters["urlP_BUSINESS_AREA_ID"], 0, false);
    }
//End Prepare Method

//Open Method @2-F18CAEAA
    function Open()
    {
        ...
        "WHERE \n" .
        "P_BUSINESS_AREA_ID = " . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . " AND\n" .
...
//Operation Method @3-FC9268F5
    function Operation()
    {
        ...
        $Redirect = "lov_p_sub_area.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_sub_area.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_sub_area.html";
$BlockToParse = "main";
...
//Include events file @1-4B0BD548
include_once("./lov_p_sub_area_events.php");
...
//Go to destination page @1-866C8CD4
if($Redirect)
{
