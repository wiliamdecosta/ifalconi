<?php
//Include Common Files @1-956C61E1
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_billing_period_unit.php");
...
//Class_Initialize Event @2-73D2DD65
...
//DataSourceClass_Initialize Event @2-8BDDE399
...
//Open Method @2-E258F842
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT P_BILLING_PERIOD_UNIT_ID,CODE,DAY_AMT,UPDATE_DATE,UPDATE_BY,DESCRIPTION FROM P_BILLING_PERIOD_UNIT WHERE UPPER(CODE)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') ) cnt";
        $this->SQL = "SELECT P_BILLING_PERIOD_UNIT_ID,CODE,DAY_AMT,UPDATE_DATE,UPDATE_BY,DESCRIPTION FROM P_BILLING_PERIOD_UNIT WHERE UPPER(CODE)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') ";
...
//Operation Method @3-A0B9961A
    function Operation()
    {
        ...
        $Redirect = "lov_p_billing_period_unit.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_billing_period_unit.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_billing_period_unit.html";
$BlockToParse = "main";
...
//Include events file @1-B8093FA6
include_once("./lov_p_billing_period_unit_events.php");
...
//Go to destination page @1-5E919550
if($Redirect)
{
