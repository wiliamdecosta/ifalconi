...
// -------------------------
	...
	$nilai=$P_BILL_COMPONENT->P_BILL_COMPONENT_ID->GetValue()."#~#".$P_BILL_COMPONENT->CODE->GetValue();
	$P_BILL_COMPONENT->Label1->SetValue("<input type=button value='PILIH' class=Button onclick=\"javascript:clickReturn('".$nilai."')\">");
// -------------------------
//End Custom Code
