<?php
//Include Common Files @1-744E2A94
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_customer_region.php");
...
//SetOrder Method @2-3DD6D221
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "REGION_NAME";
...
//Open Method @2-F7DDD9B3
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT REGION_NAME, P_REGION_ID\n" .
        "FROM P_REGION\n" .
        "WHERE P_REGION_LEVEL_ID IN (3,4)\n" .
        "AND REGION_NAME LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT REGION_NAME, P_REGION_ID\n" .
        "FROM P_REGION\n" .
        "WHERE P_REGION_LEVEL_ID IN (3,4)\n" .
        "AND REGION_NAME LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')  {SQL_OrderBy}";
...
//Operation Method @3-2E8F62A4
    function Operation()
    {
        ...
        $Redirect = "lov_p_customer_region.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_customer_region.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_customer_region.html";
$BlockToParse = "main";
...
//Include events file @1-573E47FB
include_once("./lov_p_customer_region_events.php");
