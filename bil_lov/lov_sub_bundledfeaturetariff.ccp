<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_lov" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		...
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" name="BUNDLED_FEATURE" connection="Conn" dataSource="SELECT b.CODE,
    b.P_BUNDLED_FEATURE_ID
FROM SUBSCRIBER_BUNDLED_FEATURE a,
    P_BUNDLED_FEATURE b
WHERE a.SUBSCRIBER_ID = {SUBSCRIBER_ID} AND
    a.P_BUNDLED_FEATURE_ID = b.P_BUNDLED_FEATURE_ID
ORDER BY b.CODE
" orderBy="CODE" pageSizeLimit="100" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			...
			<SQLParameters>
				...
				<SQLParameter id="34" variable="SUBSCRIBER_ID" parameterType="URL" dataType="Float" parameterSource="SUBSCRIBER_ID" defaultValue="0"/>
</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_sub_bundledfeaturetariff_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_sub_bundledfeaturetariff.php" forShow="True" url="lov_sub_bundledfeaturetariff.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
