<?php
//Include Common Files @1-56FBD29A
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_building_type.php");
...
class clsGridBUILDING_TYPE { //BUILDING_TYPE class @2-F41C0453
...
//Class_Initialize Event @2-0E693D18
    function clsGridBUILDING_TYPE($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "BUILDING_TYPE";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid BUILDING_TYPE";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsBUILDING_TYPEDataSource($this);
...
} //End BUILDING_TYPE Class @2-FCB6E20C

class clsBUILDING_TYPEDataSource extends clsDBConn {  //BUILDING_TYPEDataSource Class @2-29EE806F
...
//DataSourceClass_Initialize Event @2-4613C2CB
    function clsBUILDING_TYPEDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid BUILDING_TYPE";
        $this->Initialize();
...
//Open Method @2-B84B81B6
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_REFERENCE_LIST WHERE P_REFERENCE_TYPE_ID=6 AND UPPER(CODE)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_REFERENCE_LIST WHERE P_REFERENCE_TYPE_ID=6 AND UPPER(CODE)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')";
...
} //End BUILDING_TYPEDataSource Class @2-FCB6E20C
...
//Operation Method @3-0AD366D9
    function Operation()
    {
        ...
        $Redirect = "lov_building_type.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_building_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_building_type.html";
$BlockToParse = "main";
...
//Include events file @1-96B9550B
include_once("./lov_building_type_events.php");
...
//Go to destination page @1-F1FDA0C7
if($Redirect)
{
