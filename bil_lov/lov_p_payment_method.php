<?php
//Include Common Files @1-67E96BAA
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_payment_method.php");
...
//Class_Initialize Event @2-A77A91AC
...
//DataSource Variables @2-7ACA7FF6
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-67FB42E6
...
//Open Method @2-B8D2CA27
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT CODE, P_PAYMENT_METHOD_ID\n" .
        "FROM P_PAYMENT_METHOD\n" .
        "WHERE CODE LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT CODE, P_PAYMENT_METHOD_ID\n" .
        "FROM P_PAYMENT_METHOD\n" .
...
//Operation Method @3-85237B4A
    function Operation()
    {
        ...
        $Redirect = "lov_p_payment_method.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_payment_method.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_payment_method.html";
$BlockToParse = "main";
...
//Include events file @1-B33B044B
include_once("./lov_p_payment_method_events.php");
...
//Go to destination page @1-1E7A9B64
if($Redirect)
{
