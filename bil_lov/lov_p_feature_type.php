<?php
//Include Common Files @1-16C191B8
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_feature_type.php");
...
//Class_Initialize Event @2-43B0FB8C
...
//DataSourceClass_Initialize Event @2-7B0ACC65
...
//Open Method @2-5ABD9DAE
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select a.code, a.p_feature_type_id, a.listing_no \n" .
        "from p_feature_type a \n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "select a.code, a.p_feature_type_id, a.listing_no \n" .
        "from p_feature_type a \n" .
...
//Operation Method @3-0A414431
    function Operation()
    {
        ...
        $Redirect = "lov_p_feature_type.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_feature_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_feature_type.html";
$BlockToParse = "main";
...
//Include events file @1-3924AD1B
include_once("./lov_p_feature_type_events.php");
