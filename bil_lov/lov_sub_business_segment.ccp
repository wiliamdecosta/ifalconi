...
">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_sub_business_segment_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="lov_sub_business_segment.php" forShow="True" url="lov_sub_business_segment.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
