...
// -------------------------
	...
	$nilai=$P_PERIOD_STATUS->P_STATUS_LIST_ID->GetValue()."#~#".$P_PERIOD_STATUS->CODE->GetValue();
	$P_PERIOD_STATUS->Label1->SetValue("<input type=button value='PILIH' class=Button onclick=\"javascript:clickReturn('".$nilai."')\">");
// -------------------------
//End Custom Code
