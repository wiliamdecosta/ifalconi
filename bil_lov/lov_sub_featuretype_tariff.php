<?php
//Include Common Files @1-B8F43DA0
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_sub_featuretype_tariff.php");
...
//Operation Method @3-989532BF
    function Operation()
    {
        ...
        $Redirect = "lov_sub_featuretype_tariff.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_sub_featuretype_tariff.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
//Class_Initialize Event @2-7437FCA1
...
//DataSource Variables @2-A1E6B02E
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-2E7F82A4
...
//Open Method @2-A9346E5C
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT c.CODE,     c.P_FEATURE_TYPE_ID\n" .
        ...
        "	AND( UPPER(c.CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') )) cnt";
        $this->SQL = "SELECT c.CODE,     c.P_FEATURE_TYPE_ID\n" .
        "FROM SUBSCRIBER_FEATURE a,\n" .
        "    P_SERVICE_CATEGORY b,\n" .
        "    P_FEATURE_TYPE c\n" .
        "WHERE a.SUBSCRIBER_ID = " . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . " AND\n" .
        "    a.P_SERVICE_CATEGORY_ID = b.P_SERVICE_CATEGORY_ID AND\n" .
        "    b.P_FEATURE_TYPE_ID = c.P_FEATURE_TYPE_ID\n" .
        "	AND( UPPER(c.CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') ){SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_sub_featuretype_tariff.html";
$BlockToParse = "main";
...
//Include events file @1-FC611A28
include_once("./lov_sub_featuretype_tariff_events.php");
