...
// -------------------------
	...
	$nilai=$P_CUSTOMER_CLASS->CODE->GetValue()."#~#".$P_CUSTOMER_CLASS->P_REFERENCE_LIST_ID->GetValue();
	$P_CUSTOMER_CLASS->Label1->SetValue("<input type=button value='PILIH' class=Button onclick=\"javascript:clickReturn('".$nilai."')\">");
