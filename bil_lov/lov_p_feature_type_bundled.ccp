<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_lov" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" name="P_FEATURE_TYPE" orderBy="CODE" pageSizeLimit="100" wizardCaption=" P CUSTOMER SEGMENT " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList" dataSource="SELECT a.CODE FEATURE_TYPE_CODE,
...
WHERE (a.P_FEATURE_GROUP_ID = b.P_FEATURE_GROUP_ID AND
  ...
  c.P_SERVICE_TYPE_ID = {P_SERVICE_TYPE_ID})
  AND (UPPER(a.CODE) LIKE UPPER('%{s_keyword}%') 
  	OR UPPER(b.CODE) LIKE UPPER('%{s_keyword}%') )

ORDER BY a.CODE">
			<Components>
				<Label id="15" fieldSourceType="DBColumn" dataType="Text" html="False" name="FEATURE_TYPE_CODE" fieldSource="FEATURE_TYPE_CODE" wizardCaption="CODE" wizardSize="50" wizardMaxLength="64" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_FEATURE_TYPEFEATURE_TYPE_CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="16" fieldSourceType="DBColumn" dataType="Text" html="False" name="P_REFERENCE_LIST_ID" fieldSource="P_REFERENCE_LIST_ID" wizardCaption="OLD CODE" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_FEATURE_TYPEP_REFERENCE_LIST_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="21" fieldSourceType="DBColumn" dataType="Text" html="True" name="Label1" PathID="P_FEATURE_TYPELabel1">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="29" fieldSourceType="DBColumn" dataType="Text" name="P_FEATURE_TYPE_ID" PathID="P_FEATURE_TYPEP_FEATURE_TYPE_ID" fieldSource="P_FEATURE_TYPE_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<TextBox id="30" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="P_SERVICE_TYPE_ID" PathID="P_FEATURE_TYPEP_SERVICE_TYPE_ID">
<Components/>
<Events/>
<Attributes/>
<Features/>
</TextBox>
<Label id="32" fieldSourceType="DBColumn" dataType="Text" html="False" name="FEATURE_GROUP" PathID="P_FEATURE_TYPEFEATURE_GROUP" fieldSource="FEATURE_GROUP">
<Components/>
<Events/>
<Attributes/>
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_p_feature_type_bundled_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_p_feature_type_bundled.php" forShow="True" url="lov_p_feature_type_bundled.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
