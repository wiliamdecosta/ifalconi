<?php
//Include Common Files @1-2FCCE7D6
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_currency.php");
...
class clsGridP_ACCOUNT_CURRENCY { //P_ACCOUNT_CURRENCY class @2-FE8DD5E9
...
//Class_Initialize Event @2-473D96B9
    function clsGridP_ACCOUNT_CURRENCY($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "P_ACCOUNT_CURRENCY";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid P_ACCOUNT_CURRENCY";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsP_ACCOUNT_CURRENCYDataSource($this);
...
} //End P_ACCOUNT_CURRENCY Class @2-FCB6E20C

class clsP_ACCOUNT_CURRENCYDataSource extends clsDBConn {  //P_ACCOUNT_CURRENCYDataSource Class @2-E625296B

//DataSource Variables @2-1A670C5A
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F7D349A1
    function clsP_ACCOUNT_CURRENCYDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid P_ACCOUNT_CURRENCY";
        $this->Initialize();
...
//Open Method @2-4BFA1A8C
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT CODE, P_CURRENCY_ID\n" .
        "FROM P_CURRENCY\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT CODE, P_CURRENCY_ID\n" .
        "FROM P_CURRENCY\n" .
...
} //End P_ACCOUNT_CURRENCYDataSource Class @2-FCB6E20C
...
//Class_Initialize Event @3-C7A1F57B
...
//Operation Method @3-BDCBB6D7
    function Operation()
    {
        ...
        $Redirect = "lov_p_currency.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_currency.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "TAMBAH", "BATCH_CONTROL_ID")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_currency.html";
$BlockToParse = "main";
...
//Include events file @1-420ECE01
include_once("./lov_p_currency_events.php");
...
// Controls
$P_ACCOUNT_CURRENCY = & new clsGridP_ACCOUNT_CURRENCY("", $MainPage);
$P_SERVICE_TYPESearch = & new clsRecordP_SERVICE_TYPESearch("", $MainPage);
$MainPage->P_ACCOUNT_CURRENCY = & $P_ACCOUNT_CURRENCY;
$MainPage->P_SERVICE_TYPESearch = & $P_SERVICE_TYPESearch;
$P_ACCOUNT_CURRENCY->Initialize();
...
//Go to destination page @1-68491776
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($P_ACCOUNT_CURRENCY);
...
//Show Page @1-F5C59587
$P_ACCOUNT_CURRENCY->Show();
