<?php
//Include Common Files @1-634FA047
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_customer_class.php");
...
//Class_Initialize Event @2-B318043B
...
//DataSourceClass_Initialize Event @2-978B10AD
...
//Operation Method @3-14004DA4
    function Operation()
    {
        ...
        $Redirect = "lov_p_customer_class.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_customer_class.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_customer_class.html";
$BlockToParse = "main";
...
//Include events file @1-93649155
include_once("./lov_p_customer_class_events.php");
...
//Go to destination page @1-3913DFBE
if($Redirect)
{
