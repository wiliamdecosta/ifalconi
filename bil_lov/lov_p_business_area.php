<?php
//Include Common Files @1-58E7744C
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_business_area.php");
...
//Class_Initialize Event @2-F4841961
...
//DataSource Variables @2-39F71667
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-BAA0D030
...
//Open Method @2-067A4878
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT BUSINESS_AREA_NAME,P_BUSINESS_AREA_ID,NULL AS SUB_AREA_NAME,NULL AS P_SUB_AREA_ID FROM P_BUSINESS_AREA  WHERE UPPER(BUSINESS_AREA_NAME)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT BUSINESS_AREA_NAME,P_BUSINESS_AREA_ID,NULL AS SUB_AREA_NAME,NULL AS P_SUB_AREA_ID FROM P_BUSINESS_AREA  WHERE UPPER(BUSINESS_AREA_NAME)LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') {SQL_OrderBy}";
...
//Operation Method @3-7D84DCFB
    function Operation()
    {
        ...
        $Redirect = "lov_p_business_area.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_business_area.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_business_area.html";
$BlockToParse = "main";
...
//Include events file @1-4B174606
include_once("./lov_p_business_area_events.php");
