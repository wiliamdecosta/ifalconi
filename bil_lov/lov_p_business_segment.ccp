...
WHERE P_CUSTOMER_SEGMENT_ID ={P_CUSTOMER_SEGMENT_ID}AND
...
">
			...
			<SQLParameters>
				...
				<SQLParameter id="29" variable="P_CUSTOMER_SEGMENT_ID" parameterType="URL" defaultValue="0" dataType="Float" parameterSource="P_CUSTOMER_SEGMENT_ID"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
