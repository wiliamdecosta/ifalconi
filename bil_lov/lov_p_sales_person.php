<?php
//Include Common Files @1-F898B7F5
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_sales_person.php");
...
//Class_Initialize Event @2-4F06B006
    function clsGridP_SALES_PERSON($RelativePath, & $Parent)
    {
        ...
        $this->SALES_COMPANY = & new clsControl(ccsLabel, "SALES_COMPANY", "SALES_COMPANY", ccsText, "", CCGetRequestParam("SALES_COMPANY", ccsGet, NULL), $this);
...
//Show Method @2-884F3F5B
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["SALES_COMPANY"] = $this->SALES_COMPANY->Visible;
...
//GetErrors Method @2-C6F35C3C
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->SALES_COMPANY->Errors->ToString());
...
//DataSource Variables @2-11CCACC9
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-185E1D23
...
//Open Method @2-172E017A
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT a.P_SALES_PERSON_ID,\n" .
        "a.CODE,\n" .
        ...
        $this->SQL = "SELECT a.P_SALES_PERSON_ID,\n" .
        "a.CODE,\n" .
        "b.CODE SALES_COMPANY\n" .
        "FROM P_SALES_PERSON a,\n" .
        "P_COMPANY b \n" .
...
//Operation Method @3-7F672B24
    function Operation()
    {
        ...
        $Redirect = "lov_p_sales_person.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_sales_person.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_sales_person.html";
$BlockToParse = "main";
...
//Include events file @1-41736752
include_once("./lov_p_sales_person_events.php");
...
//Go to destination page @1-83E722E1
if($Redirect)
{
