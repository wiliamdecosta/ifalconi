<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="SELECT CODE, VALUE, TYPE_I, CASE IS_RANGE WHEN 'Y' THEN 'YES' ELSE 'NO' END AS IS_RANGE , VALUE_2 
FROM GLOBAL_PARAM
WHERE UPPER(CODE) LIKE UPPER('%{s_keyword}%')" name="P_GLOBAL_PARAM" orderBy="P_GLOBAL_PARAM_ID" pageSizeLimit="100" wizardCaption=" P GLOBAL PARAM " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions">
			<Components>
				...
				<Label id="22" fieldSourceType="DBColumn" dataType="Text" html="False" name="TYPE_I" fieldSource="TYPE_I" wizardCaption="TYPE 1" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_GLOBAL_PARAMTYPE_I">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="P_GLOBAL_PARAMSearch" wizardCaption=" P GLOBAL PARAM " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="p_global_param.ccp" PathID="P_GLOBAL_PARAMSearch" pasteActions="pasteActions">
			<Components>
				...
				<Button id="101" urlType="Relative" enableValidation="True" isDefault="False" name="Button_DoSearch" operation="Search" wizardCaption="Search" PathID="P_GLOBAL_PARAMSearchButton_DoSearch" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="FLAG;p_application_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE  CODE = '{CODE}'" customDeleteType="SQL" customDelete="DELETE FROM GLOBAL_PARAM WHERE CODE = '{CODE}'">
			<Components>
				...
				<ListBox id="38" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="IS_RANGE" fieldSource="IS_RANGE" required="False" caption="IS RANGE" wizardCaption="IS RANGE" wizardSize="1" wizardMaxLength="1" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_global_param1IS_RANGE" sourceType="ListOfValues" dataSource="Y;YES;N;NO">
<Components/>
					<Events/>
					<Attributes/>
					<Features/>
