...
(GENERATE_ID('BILLDB','P_FIRST_JOB','P_FIRST_JOB_ID'),{DATA_TYPE_ID},{P_JOB_ID},{LISTING_NO},'{DESCRIPTION}',sysdate,'{UPDATE_BY}')" customUpdateType="SQL" customUpdate="UPDATE P_FIRST_JOB SET 
	...
	UPDATE_DATE=sysdate, 
	UPDATE_BY='{UPDATE_BY}' 
	WHERE  P_FIRST_JOB_ID = {P_FIRST_JOB_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_FIRST_JOB WHERE P_FIRST_JOB_ID = {P_FIRST_JOB_ID}" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Button id="58" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardThemeItem="FooterIMG" wizardButtonImage="ButtonDeleteOn" PathID="P_FIRST_JOB1Button_Delete" removeParameters="TAMBAH;s_keyword;P_FIRST_JOB_ID">
					<Components/>
					<Events>
