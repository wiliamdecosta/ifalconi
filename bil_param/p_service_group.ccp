...
ORDER BY P_SERVICE_GROUP_ID" name="P_SERVICE_GROUP" orderBy="P_SERVICE_GROUP_ID" pageSizeLimit="100" wizardCaption=" P SERVICE GROUP " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				...
				<Label id="28" fieldSourceType="DBColumn" dataType="Date" html="False" name="UPDATE_DATE" fieldSource="UPDATE_DATE" wizardCaption="UPDATE DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_SERVICE_GROUPUPDATE_DATE" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<TableParameters>
				<TableParameter id="8" conditionType="Parameter" useIsNull="False" field="UPPER(CODE)" dataType="Text" logicOperator="Or" searchConditionType="Contains" parameterType="URL" orderNumber="1" leftBrackets="1" parameterSource="UPPER(s_keyword)"/>
				<TableParameter id="9" conditionType="Parameter" useIsNull="False" field="UPPER(DESCRIPTION)" dataType="Text" logicOperator="Or" searchConditionType="Contains" parameterType="URL" orderNumber="2" rightBrackets="1" parameterSource="UPPER(s_keyword)"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="90" tableName="p_service_group" posWidth="160" posHeight="168" posLeft="10" posTop="10"/>
			</JoinTables>
			<JoinLinks/>
			<Fields>
			</Fields>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="P_SERVICE_GROUPSearch" wizardCaption=" P SERVICE GROUP " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="p_service_group.ccp" PathID="P_SERVICE_GROUPSearch" pasteActions="pasteActions">
			<Components>
				...
				<Button id="4" urlType="Relative" enableValidation="True" isDefault="False" name="Button_DoSearch" operation="Search" wizardCaption="Search" PathID="P_SERVICE_GROUPSearchButton_DoSearch" removeParameters="TAMBAH;BATCH_CONTROL_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="32" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Conn" name="p_service_group1" dataSource="p_service_group" errorSummator="Error" wizardCaption=" P Service Group " wizardFormMethod="post" PathID="p_service_group1" pasteActions="pasteActions" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="USQLParameters" customInsert="INSERT INTO P_SERVICE_GROUP (P_SERVICE_GROUP_ID,CODE,DESCRIPTION, UPDATE_DATE, UPDATE_BY) 
VALUES
(GENERATE_ID('BILLDB','P_SERVICE_GROUP','P_SERVICE_GROUP_ID'),UPPER(TRIM('{CODE}')),INITCAP(TRIM('{DESCRIPTION}')), sysdate, '{UPDATE_BY}')" customUpdateType="SQL" customUpdate="UPDATE P_SERVICE_GROUP SET 
CODE=UPPER(TRIM('{CODE}')),
DESCRIPTION=INITCAP(TRIM('{DESCRIPTION}')),
UPDATE_DATE=sysdate,
UPDATE_BY='{UPDATE_BY}'
WHERE  P_SERVICE_GROUP_ID = {P_SERVICE_GROUP_ID}" customDeleteType="SQL" customDelete="DELETE FROM p_service_group 
WHERE  P_SERVICE_GROUP_ID = {P_SERVICE_GROUP_ID}">
			<Components>
				<TextBox id="39" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="CODE" fieldSource="CODE" required="True" caption="CODE" wizardCaption="CODE" wizardSize="50" wizardMaxLength="64" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_service_group1CODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								...
								<Action actionName="Confirmation Message" actionCategory="General" id="49" message="Save this record?" eventType="Client"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								...
								<Action actionName="Confirmation Message" actionCategory="General" id="52" message="Change this record?" eventType="Client"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
				...
				<Button id="53" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="p_service_group1Button_Delete" removeParameters="TAMBAH;P_APP_ROLE_ID;s_keyword;P_APP_ROLEPage">
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								<Action actionName="Confirmation Message" actionCategory="General" id="54" message="Delete this record?" eventType="Client"/>
			...
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="93" variable="P_SERVICE_GROUP_ID" parameterType="URL" dataType="Float" parameterSource="P_SERVICE_GROUP_ID" defaultValue="0"/>
			</DSQLParameters>
			<DConditions>
				<TableParameter id="92" conditionType="Parameter" useIsNull="False" field="P_SERVICE_GROUP_ID" dataType="Float" parameterType="URL" parameterSource="P_SERVICE_GROUP_ID" searchConditionType="Equal" logicOperator="And" orderNumber="1"/>
			</DConditions>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
