...
WHERE P_TICKET_COMPONENT_ID = {P_TICKET_COMPONENT_ID}" customDeleteType="SQL" customDelete="DELETE P_TICKET_COMPONENT WHERE P_TICKET_COMPONENT_ID = {P_TICKET_COMPONENT_ID}" parameterTypeListName="ParameterTypeList" activeCollection="SQLParameters">
			<Components>
				...
				<Button id="37" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardThemeItem="FooterIMG" wizardButtonImage="ButtonDeleteOn" PathID="P_TICKET_COMPONENT1Button_Delete" removeParameters="TAMBAH;s_keyword;P_TICKET_COMPONENT_ID">
					<Components/>
					<Events>
