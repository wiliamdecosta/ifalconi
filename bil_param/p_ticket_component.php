...
//Class_Initialize Event @22-D7037289
...
//CheckErrors Method @22-396BEB00
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-EE974C2F
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "s_keyword", "P_TICKET_COMPONENT_ID"));
