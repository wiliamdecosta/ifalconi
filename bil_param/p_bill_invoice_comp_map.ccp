<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="SELECT A.*,B.CODE AS P_BILL_COMPONENT_NAME,C.CODE AS P_SERVICE_TYPE_NAME,D.CODE AS P_INVOICE_COMPONENT_NAME  FROM P_BILL_INVOICE_COMP_MAP A,
P_BILL_COMPONENT B,
P_SERVICE_TYPE C,
...
<Label id="90" fieldSourceType="DBColumn" dataType="Text" html="False" name="DESCRIPTION" PathID="P_BILL_INVOICE_COMP_MAPDESCRIPTION" fieldSource="DESCRIPTION">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
WHERE P_BILL_INVOICE_COMP_MAP_ID = {P_BILL_INVOICE_COMP_MAP_ID}" customDeleteType="SQL" customDelete="DELETE P_BILL_INVOICE_COMP_MAP WHERE P_BILL_INVOICE_COMP_MAP_ID = {P_BILL_INVOICE_COMP_MAP_ID}">
			<Components>
				...
				<Button id="38" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="P_BILL_INVOICE_COMP_MAP1Button_Delete" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="TAMBAH;P_APPLICATION_ID;P_BILL_INVOICE_COMP_MAP_ID">
					<Components/>
					<Events>
