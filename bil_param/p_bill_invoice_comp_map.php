...
//Class_Initialize Event @2-B7E4AE01
...
//DataSource Variables @2-9289248F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-961F1F0E
...
//Class_Initialize Event @22-99C4BE9C
...
//CheckErrors Method @22-29A615A5
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-CCCCF5BA
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Update") {
            ...
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "P_APPLICATION_ID", "P_BILL_INVOICE_COMP_MAP_ID"));
