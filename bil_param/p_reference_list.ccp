<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="SELECT A.CODE,B.CODE as Ref_TYPE,A.REFERENCE_NAME as REFERENCE_TYPE,A.LISTING_NO,A.DESCRIPTION,A.P_REFERENCE_LIST_ID,B.P_REFERENCE_TYPE_ID FROM P_REFERENCE_LIST A
INNER JOIN P_REFERENCE_TYPE  B
ON A.P_REFERENCE_TYPE_ID = B.P_REFERENCE_TYPE_ID
where B.P_REFERENCE_TYPE_ID ={P_REFERENCE_TYPE_ID}
and (upper(A.CODE) like upper('%{s_keyword}%') OR
upper(B.CODE) like upper('%{s_keyword}%') OR
upper(A.REFERENCE_NAME) like upper('%{s_keyword}%'))" name="P_REFERENCE_LIST" orderBy="P_REFERENCE_LIST_ID" pageSizeLimit="100" wizardCaption=" P REFERENCE LIST " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				...
				<Label id="20" fieldSourceType="DBColumn" dataType="Text" html="False" name="REF_TYPE" fieldSource="REF_TYPE" wizardCaption="P REFERENCE TYPE ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="P_REFERENCE_LISTREF_TYPE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="22" fieldSourceType="DBColumn" dataType="Text" html="False" name="REFERENCE_TYPE" fieldSource="REFERENCE_TYPE" wizardCaption="REFERENCE NAME" wizardSize="50" wizardMaxLength="64" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_REFERENCE_LISTREFERENCE_TYPE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="P_REFERENCE_LIST_Insert" hrefSource="p_reference_list.ccp" removeParameters="P_REFERENCE_LIST_ID" wizardThemeItem="FooterA" wizardUseTemplateBlock="False" PathID="P_REFERENCE_LISTP_REFERENCE_LIST_Insert">
					...
					<LinkParameters>
						...
						<LinkParameter id="100" sourceType="URL" name="REFERENCE_TYPE_CODE" source="REFERENCE_TYPE_CODE"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
			...
			<SQLParameters>
				...
				<SQLParameter id="99" variable="P_REFERENCE_TYPE_ID" parameterType="URL" defaultValue="0" dataType="Float" parameterSource="P_REFERENCE_TYPE_ID"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
...
and a.P_REFERENCE_LIST_ID={P_REFERENCE_LIST_ID}" errorSummator="Error" wizardCaption=" P Reference List " wizardFormMethod="post" PathID="p_reference_list1" pasteActions="pasteActions" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="DSQLParameters" customInsert="INSERT INTO P_REFERENCE_LIST(P_REFERENCE_LIST_ID, CODE, P_REFERENCE_TYPE_ID, REFERENCE_NAME, LISTING_NO, DESCRIPTION, UPDATE_DATE, UPDATE_BY)
VALUES
(GENERATE_ID('BILLDB','P_REFERENCE_LIST','P_REFERENCE_LIST_ID'),UPPER('{CODE}'),{P_REFERENCE_TYPE_ID},UPPER('{REFERENCE_NAME}'),{LISTING_NO},'{DESCRIPTION}',sysdate, '{UPDATE_BY}')" customUpdateType="SQL" customUpdate="UPDATE P_REFERENCE_LIST SET 
CODE=UPPER(TRIM('{CODE}')),
P_REFERENCE_TYPE_ID={P_REFERENCE_TYPE_ID},
REFERENCE_NAME=UPPER('{REFERENCE_NAME}'),
...
WHERE  P_REFERENCE_LIST_ID = {P_REFERENCE_LIST_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_REFERENCE_LIST WHERE P_REFERENCE_LIST_ID = {P_REFERENCE_LIST_ID}">
			<Components>
				...
				<Button id="48" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardThemeItem="FooterIMG" wizardButtonImage="ButtonDeleteOn" PathID="p_reference_list1Button_Delete" removeParameters="TAMBAH;s_keyword;P_REFERENCE_LIST_ID">
					<Components/>
					<Events>
			...
			<ISQLParameters>
				...
				<SQLParameter id="77" variable="UPDATE_BY" parameterType="Control" dataType="Text" parameterSource="UPDATE_BY"/>
			</ISQLParameters>
			<IFormElements>
			...
			<USQLParameters>
				...
				<SQLParameter id="93" variable="UPDATE_BY" parameterType="Session" dataType="Text" parameterSource="UserName"/>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="P_REFERENCE_LISTSearch" returnPage="p_reference_list.ccp" PathID="P_REFERENCE_LISTSearch">
<Components>
<TextBox id="5" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="s_keyword" PathID="P_REFERENCE_LISTSearchs_keyword">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
<TextBox id="103" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="P_REFERENCE_TYPE_ID" PathID="P_REFERENCE_LISTSearchP_REFERENCE_TYPE_ID">
<Components/>
<Events/>
<Attributes/>
<Features/>
