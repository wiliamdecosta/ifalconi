<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="select * from P_STATUS_LIST 
WHERE P_STATUS_TYPE_ID = {P_STATUS_TYPE_ID}
and 
(upper(code) like upper('%{s_keyword}%') OR
upper(description) like upper('%{s_keyword}%'))" name="P_STATUS_LIST" orderBy="P_STATUS_LIST_ID" pageSizeLimit="100" wizardCaption=" P STATUS LIST " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				<Label id="16" fieldSourceType="DBColumn" dataType="Text" html="False" name="CODE" fieldSource="CODE" wizardCaption="P STATUS TYPE ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="P_STATUS_LISTCODE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Navigator id="92" size="10" type="Centered" pageSizes="1;5;10;25;50" name="Navigator" wizardPagingType="Custom" wizardFirst="True" wizardPrev="True" wizardNext="True" wizardLast="True" wizardPageNumbers="Centered" wizardSize="10" wizardTotalPages="False" wizardHideDisabled="False" wizardPageSize="False" wizardImages="Images" wizardUsePageScroller="True">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="P_STATUS_LISTSearch" wizardCaption=" P STATUS LIST " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="p_status_list.ccp" PathID="P_STATUS_LISTSearch" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Hidden id="83" fieldSourceType="DBColumn" dataType="Text" name="P_STATUS_TYPE_ID" PathID="P_STATUS_LISTSearchP_STATUS_TYPE_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
and a.P_STATUS_LIST_ID={P_STATUS_LIST_ID}" errorSummator="Error" wizardCaption=" P Status List " wizardFormMethod="post" PathID="p_status_list1" pasteActions="pasteActions" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="DSQLParameters" customInsert="INSERT INTO P_STATUS_LIST(P_STATUS_LIST_ID,P_STATUS_TYPE_ID, CODE, LISTING_NO,DESCRIPTION,UPDATE_DATE, UPDATE_BY)
VALUES
(GENERATE_ID('BILLDB','P_STATUS_LIST','P_STATUS_LIST_ID'),{P_STATUS_TYPE_ID},UPPER('{CODE}'),{LISTING_NO},INITCAP(TRIM('{DESCRIPTION}')),sysdate, '{UPDATE_BY}')" customUpdateType="SQL" customUpdate="UPDATE P_STATUS_LIST SET 
...
WHERE  P_STATUS_LIST_ID = {P_STATUS_LIST_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_STATUS_LIST WHERE P_STATUS_LIST_ID = {P_STATUS_LIST_ID}">
			<Components>
				...
				<Button id="40" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardThemeItem="FooterIMG" wizardButtonImage="ButtonDeleteOn" PathID="p_status_list1Button_Delete" removeParameters="TAMBAH;P_STATUS_LIST_ID">
					<Components/>
					<Events>
				...
				<TextBox id="90" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="LISTING_NO" PathID="p_status_list1LISTING_NO" fieldSource="LISTING_NO">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="63" variable="UPDATE_BY" parameterType="Session" dataType="Text" parameterSource="UserName"/>
