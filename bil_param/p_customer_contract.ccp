...
(UPPER(CONTRACT_NO) LIKE UPPER('%{s_keyword}%') OR
UPPER(CUSTOMER_PIC) LIKE UPPER('%{s_keyword}%') OR
UPPER(CONTRACT_DATE) LIKE UPPER('%{s_keyword}%') OR
UPPER(ACCOUNT_NAME) LIKE UPPER('%{s_keyword}%') OR 
UPPER(EMPLOYEE_NO) LIKE UPPER('%{s_keyword}%') OR
UPPER(DESCRIPTION) LIKE UPPER('%{s_keyword}%')
			...
			<Components>
				...
				<Link id="139" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="CustomerContractGridDLink" hrefSource="p_customer_contract.ccp" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="FLAG" html="True" wizardUseTemplateBlock="True">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="CustomerContractSearch" wizardCaption=" V CUSTOMER " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="p_customer_contract.ccp" PathID="CustomerContractSearch" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				<Button id="4" urlType="Relative" enableValidation="True" isDefault="False" name="Button_DoSearch" operation="Search" PathID="CustomerContractSearchButton_DoSearch">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<TextBox id="136" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="s_keyword" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" PathID="CustomerContractSearchs_keyword" wizardTheme="sikm" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="404" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="CUSTOMER_ID" PathID="CustomerContractSearchCUSTOMER_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE  CUSTOMER_CONTRACT_ID = {CUSTOMER_CONTRACT_ID}">
			<Components>
				<Button id="98" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" PathID="CustomerContractRecordButton_Insert" removeParameters="TAMBAH;s_keyword" returnPage="p_customer_contract.ccp">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Button id="100" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" PathID="CustomerContractRecordButton_Delete" removeParameters="TAMBAH" returnPage="p_customer_contract.ccp">
					<Components/>
					<Events>
				...
				<TextBox id="105" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="VALID_FROM" caption="VALID_FROM" fieldSource="VALID_FROM" required="True" PathID="CustomerContractRecordVALID_FROM" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="338" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="DESCRIPTION" PathID="CustomerContractRecordDESCRIPTION" fieldSource="DESCRIPTION" caption="Description" required="False">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="449" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="CONTRACT_DATE" PathID="CustomerContractRecordCONTRACT_DATE" fieldSource="CONTRACT_DATE" format="dd-mmm-yyyy" required="True">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Action actionName="Custom Code" actionCategory="General" id="523"/>
			...
			<USQLParameters>
				...
				<SQLParameter id="485" variable="CUSTOMER_CONTRACT_ID" dataType="Float" parameterType="URL" parameterSource="CUSTOMER_CONTRACT_ID" defaultValue="0"/>
...
WHERE  P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_INPUT_FILE_DESC WHERE P_INPUT_FILE_DESC_ID = {P_INPUT_FILE_DESC_ID}" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Label id="503" fieldSourceType="DBColumn" dataType="Text" html="False" name="LAST_NAME" PathID="Customer_InfLAST_NAME" fieldSource="LAST_NAME">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="504" fieldSourceType="DBColumn" dataType="Text" html="False" name="CUSTOMER_NUMBER" PathID="Customer_InfCUSTOMER_NUMBER" fieldSource="CUSTOMER_NUMBER">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="505" variable="P_SERVICE_TYPE_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="P_SERVICE_TYPE_ID"/>
				<SQLParameter id="92" variable="PROCEDURE_NAME" parameterType="Control" dataType="Text" parameterSource="PROCEDURE_NAME"/>
				<SQLParameter id="506" variable="START_POSITION_NAME" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="START_POSITION_NAME"/>
				...
				<SQLParameter id="507" variable="DESCRIPTION" parameterType="Control" dataType="Text" parameterSource="DESCRIPTION"/>
				<SQLParameter id="508" variable="CREATED_BY" parameterType="Control" dataType="Text" parameterSource="CREATED_BY"/>
				<SQLParameter id="509" variable="UPDATED_BY" parameterType="Control" dataType="Text" parameterSource="UPDATED_BY"/>
			</ISQLParameters>
			<IFormElements>
			...
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="519" variable="P_INPUT_FILE_DESC_ID" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="P_INPUT_FILE_DESC_ID"/>
			</DSQLParameters>
			<DConditions/>
			<SecurityGroups/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_customer_contract_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="p_customer_contract.php" forShow="True" url="p_customer_contract.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
