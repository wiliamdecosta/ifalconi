...
a.DESCRIPTION,
to_char(a.UPDATE_DATE,'DD-MON-YYYY'),
a.UPDATE_BY,
b.CODE AS SERVICE_GROUP_NAME
from 
p_service_type a , p_service_group b
where a.P_SERVICE_GROUP_ID = b.P_SERVICE_GROUP_ID
and a.P_SERVICE_GROUP_ID = {P_SERVICE_GROUP_ID}
AND (UPPER(a.CODE) LIKE UPPER('%{s_keyword}%')
OR UPPER(a.SERVICE_NAME) LIKE UPPER('%{s_keyword}%')
OR UPPER(a.DESCRIPTION) LIKE UPPER('%{s_keyword}%')
OR UPPER(b.CODE) LIKE UPPER('%{s_keyword}%'))" name="P_SERVICE_TYPE" orderBy="P_SERVICE_TYPE_ID" pageSizeLimit="100" wizardCaption=" P SERVICE TYPE " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
			...
			<SQLParameters>
				...
				<SQLParameter id="129" variable="P_SERVICE_GROUP_ID" parameterType="URL" defaultValue="0" dataType="Float" parameterSource="P_SERVICE_GROUP_ID"/>
</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
...
to_char(a.VALID_TO,'DD-MON-YYYY') AS VALID_TO,
a.DESCRIPTION,
to_char(a.UPDATE_DATE,'DD-MON-YYYY') AS UPDATED_DATE,
a.UPDATE_BY,
b.CODE AS SERVICE_GROUP_NAME
from 
p_service_type a , p_service_group b
...
UPDATE_DATE=sysdate,
UPDATE_BY='{UPDATE_BY}'
WHERE  P_SERVICE_TYPE_ID={P_SERVICE_TYPE_ID}" customDelete="DELETE P_SERVICE_TYPE WHERE P_SERVICE_TYPE_ID={P_SERVICE_TYPE_ID}" customDeleteType="SQL" customUpdateType="SQL" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="ISQLParameters">
			<Components>
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								...
								<Action actionName="Confirmation Message" actionCategory="General" id="66" message="Save this record?" eventType="Client"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								...
								<Action actionName="Confirmation Message" actionCategory="General" id="69" message="Change this record?" eventType="Client"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
				...
				<Button id="70" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="p_service_type1Button_Delete" removeParameters="TAMBAH;P_APP_ROLE_ID;s_keyword;P_APP_ROLEPage">
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								<Action actionName="Confirmation Message" actionCategory="General" id="71" message="Delete this record?" eventType="Client"/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="105" variable="UPDATE_BY" parameterType="Session" dataType="Text" parameterSource="UserName"/>
			</ISQLParameters>
			<IFormElements>
