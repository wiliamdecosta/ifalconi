...
// -------------------------
	...
	global $FileName;
  	...
  	$P_FINANCE_PERIOD->P_FINANCE_PERIOD_Insert->Parameters = CCRemoveParam($P_FINANCE_PERIOD->P_FINANCE_PERIOD_Insert->Parameters, "P_YEAR_PERIOD_ID");
...
// -------------------------
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
        ...
        $P_FINANCE_PERIOD1->DataSource->Parameters["urlP_YEAR_PERIOD_ID"] = $selected_id;
...
//Page_OnInitializeView @1-F565FD8F
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_year_periode; //Compatibility
