...
WHERE P_INVOICE_COMPONENT_ID = {P_INVOICE_COMPONENT_ID}" customDeleteType="SQL" customDelete="DELETE P_INVOICE_COMPONENT WHERE P_INVOICE_COMPONENT_ID = {P_INVOICE_COMPONENT_ID}" parameterTypeListName="ParameterTypeList" activeCollection="DSQLParameters">
			<Components>
				...
				<Button id="38" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="P_INVOICE_COMPONENT1Button_Delete" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="TAMBAH;P_APPLICATION_ID;P_INVOICE_COMPONENT_ID">
					<Components/>
					<Events>
				...
				<Hidden id="63" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="P_INVOICE_COMPONENT_ID" fieldSource="P_INVOICE_COMPONENT_ID" caption="P_INVOICE_COMPONENT_ID" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="P_INVOICE_COMPONENT1P_INVOICE_COMPONENT_ID" required="False">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
