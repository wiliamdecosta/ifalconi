...
//Class_Initialize Event @25-8830B839
...
//CheckErrors Method @25-F6B74F58
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @25-AD24B7E8
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "s_keyword", "P_ONETIME_TARIFF_SCENARIO_ID"));
