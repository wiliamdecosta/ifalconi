...
//Class_Initialize Event @2-69FBBB54
...
//Class_Initialize Event @28-EA5F7D13
...
//CheckErrors Method @28-4C86240E
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @28-D003A43A
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "s_keyword", "P_TARIFF_SCENARIO_ID"));
