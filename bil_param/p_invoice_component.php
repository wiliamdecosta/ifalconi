...
//Class_Initialize Event @2-FE14AA16
...
//Class_Initialize Event @22-BEE0444A
    function clsRecordP_INVOICE_COMPONENT1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->P_INVOICE_COMPONENT_ID = & new clsControl(ccsHidden, "P_INVOICE_COMPONENT_ID", "P_INVOICE_COMPONENT_ID", ccsText, "", CCGetRequestParam("P_INVOICE_COMPONENT_ID", $Method, NULL), $this);
            if(!$this->FormSubmitted) {
...
//CheckErrors Method @22-2E1AD25F
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-D87D3804
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Update") {
            ...
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "P_APPLICATION_ID", "P_INVOICE_COMPONENT_ID"));
