...
UPPER(DESCRIPTION) LIKE UPPER('%{s_keyword}%')" name="P_PAYMENT_METHOD" orderBy="P_PAYMENT_METHOD_ID" pageSizeLimit="100" wizardCaption=" P PAYMENT METHOD " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="no record" pasteActions="pasteActions">
			<Components>
				...
				<Navigator id="76" size="5" type="Centered" pageSizes="1;5;10;25;50" name="Navigator" wizardPagingType="Custom" wizardFirst="True" wizardPrev="True" wizardNext="True" wizardLast="True" wizardPageNumbers="Centered" wizardSize="10" wizardTotalPages="False" wizardHideDisabled="False" wizardPageSize="False" wizardImages="Images" wizardUsePageScroller="True">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
...
WHERE P_PAYMENT_METHOD_ID = {P_PAYMENT_METHOD_ID}" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Button id="52" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" wizardCaption="Add" PathID="p_payment_method1Button_Insert" removeParameters="TAMBAH;s_keyword;;P_PAYMENT_METHODPage" wizardTheme="sikm" wizardThemeVersion="3.0">
					<Components/>
					<Events>
						<Event name="OnClick" type="Client">
<Actions>
<Action actionName="Confirmation Message" actionCategory="General" id="78" message="Are you sure want to save this record?"/>
</Actions>
</Event>
</Events>
					<Attributes/>
				...
				<Button id="53" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Update" operation="Update" wizardCaption="Submit" PathID="p_payment_method1Button_Update" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="TAMBAH">
					...
					<Events>
						<Event name="OnClick" type="Client">
<Actions>
<Action actionName="Confirmation Message" actionCategory="General" id="79" message="Are you sure want to update this record?"/>
</Actions>
</Event>
</Events>
					<Attributes/>
				...
				<Button id="54" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="p_payment_method1Button_Delete" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="TAMBAH;P_APPLICATION_ID;P_PAYMENT_METHOD_ID;P_PAYMENT_METHODPage;s_keyword">
					<Components/>
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								<Action actionName="Confirmation Message" actionCategory="General" id="55" eventType="Client" message="Are you sure want to delete this record ?"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
				...
				<Button id="56" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Cancel" operation="Cancel" wizardCaption="Cancel" PathID="p_payment_method1Button_Cancel" removeParameters="TAMBAH;s_keyword;P_PAYMENT_METHODPage">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
