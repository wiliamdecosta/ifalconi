...
//Operation Method @37-8C8410D1
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "s_keyword", "P_FIRST_JOB_ID"));
...
//Delete Method @37-B24903E6
    function Delete()
    {
        ...
        if (!strlen($this->cp["P_FIRST_JOB_ID"]->GetText()) and !is_bool($this->cp["P_FIRST_JOB_ID"]->GetValue(true))) 
            $this->cp["P_FIRST_JOB_ID"]->SetText(0);
        $this->SQL = "DELETE FROM P_FIRST_JOB WHERE P_FIRST_JOB_ID = " . $this->SQLValue($this->cp["P_FIRST_JOB_ID"]->GetDBValue(), ccsFloat) . "";
