...
OR UPPER(DESCRIPTION) LIKE UPPER('%{s_keyword}%')" name="P_ORGANIZATION_LEVEL" orderBy="P_ORGANIZATION_LEVEL_ID" pageSizeLimit="100" wizardCaption=" P ORGANIZATION LEVEL " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="no record" pasteActions="pasteActions">
			<Components>
...
VALUES (GENERATE_ID('BILLDB','P_ORGANIZATION_LEVEL','P_ORGANIZATION_LEVEL_ID'),UPPER('{CODE}'),{HIERARCHY_LEVEL},INITCAP(TRIM('{DESCRIPTION}')),SYSDATE,'{UPDATE_BY}')" customUpdateType="SQL" customUpdate="UPDATE P_ORGANIZATION_LEVEL SET
CODE = UPPER('{CODE}'),
...
WHERE P_ORGANIZATION_LEVEL_ID = {P_ORGANIZATION_LEVEL_ID}" parameterTypeListName="ParameterTypeList" activeCollection="ISQLParameters" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Button id="47" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" wizardCaption="Add" PathID="P_ORGANIZATION_LEVEL1Button_Insert" removeParameters="TAMBAH;s_keyword;P_ORGANIZATION_LEVELPage" wizardTheme="sikm" wizardThemeVersion="3.0">
					<Components/>
					<Events>
						<Event name="OnClick" type="Client">
<Actions>
<Action actionName="Confirmation Message" actionCategory="General" id="87" message="Are you sure want to save this record?"/>
</Actions>
</Event>
</Events>
					<Attributes/>
				...
				<Button id="48" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Update" operation="Update" wizardCaption="Submit" PathID="P_ORGANIZATION_LEVEL1Button_Update" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="TAMBAH">
					...
					<Events>
						<Event name="OnClick" type="Client">
<Actions>
<Action actionName="Confirmation Message" actionCategory="General" id="88" message="Are you sure want to update this record?"/>
</Actions>
</Event>
</Events>
					<Attributes/>
				...
				<Button id="40" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="P_ORGANIZATION_LEVEL1Button_Delete" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="TAMBAH;P_APPLICATION_ID;P_ORGANIZATION_LEVEL_ID;P_ORGANIZATION_LEVELPage;s_keyword">
					<Components/>
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								<Action actionName="Confirmation Message" actionCategory="General" id="49" eventType="Client" message="Are you sure want to delete this record ?"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
				...
				<Button id="50" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Cancel" operation="Cancel" wizardCaption="Cancel" PathID="P_ORGANIZATION_LEVEL1Button_Cancel" removeParameters="TAMBAH;P_ORGANIZATION_LEVELPage;s_keyword">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="74" variable="UPDATE_BY" parameterType="Session" dataType="Text" parameterSource="UserName"/>
			</ISQLParameters>
			<IFormElements>
