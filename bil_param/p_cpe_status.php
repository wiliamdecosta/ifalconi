<?php
//Include Common Files @1-A0E75349
define("RelativePath", "..");
...
//Open Method @2-315AB417
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT P_CPE_STATUS_ID, CODE, LISTING_NO, CASE IS_AVAILABLE WHEN 'Y' THEN 'YES' ELSE 'NO' END AS IS_AVAILABLE, DESCRIPTION \n" .
        "FROM P_CPE_STATUS\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT P_CPE_STATUS_ID, CODE, LISTING_NO, CASE IS_AVAILABLE WHEN 'Y' THEN 'YES' ELSE 'NO' END AS IS_AVAILABLE, DESCRIPTION \n" .
        "FROM P_CPE_STATUS\n" .
...
//Class_Initialize Event @22-E96D92D2
    function clsRecordP_CPE_STATUS1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->IS_AVAILABLE->Values = array(array("Y", "YES"), array("N", "NO"));
