<?php
//Include Common Files @1-DD5FD4D9
define("RelativePath", "..");
...
//Class_Initialize Event @2-B6A606C2
...
//Class_Initialize Event @25-5EDB8AC6
...
//CheckErrors Method @25-CEC77831
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @25-52744602
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Update") {
            ...
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "P_APPLICATION_ID", "P_PAYMENT_METHOD_ID", "P_PAYMENT_METHODPage", "s_keyword"));
            if(!CCGetEvent($this->Button_Delete->CCSEvents, "OnClick", $this->Button_Delete) || !$this->DeleteRow()) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "Button_Cancel") {
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "s_keyword", "P_PAYMENT_METHODPage"));
...
//Insert Method @25-62FDE970
    function Insert()
    {
        ...
        "VALUES (GENERATE_ID('BILLDB','P_PAYMENT_METHOD','P_PAYMENT_METHOD_ID'),UPPER('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "'),UPPER('" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "'),SYSDATE,'" . $this->SQLValue($this->cp["UPDATE_BY"]->GetDBValue(), ccsText) . "')";
