...
ORDER BY CUSTOMER_ID ASC" name="V_CUSTOMER" pageSizeLimit="100" wizardCaption=" V CUSTOMER " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data tidak ditemukan." pasteActions="pasteActions" pasteAsReplace="pasteAsReplace" activeCollection="TableParameters">
			<Components>
				...
				<Link id="139" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="V_CUSTOMERDLink" hrefSource="p_customer_master.ccp" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="FLAG" html="True" wizardUseTemplateBlock="True">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="145" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="P_CUSTOMER_Insert" hrefSource="p_customer_master.ccp" wizardThemeItem="FooterA" wizardUseTemplateBlock="False" PathID="V_CUSTOMERP_CUSTOMER_Insert" removeParameters="CUSTOMER_ID">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
...
CUSTOMER_NUMBER='{CUSTOMER_NUMBER}',
 ...
 WHERE  
 CUSTOMER_ID = {CUSTOMER_ID}" returnPage="p_customer_master.ccp">
			<Components>
				<Button id="98" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" PathID="CustomerFormButton_Insert" removeParameters="TAMBAH;s_keyword" returnPage="p_customer_master.ccp">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Button id="100" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" PathID="CustomerFormButton_Delete" removeParameters="TAMBAH" returnPage="p_customer_master.ccp">
					<Components/>
					<Events>
				...
				<Hidden id="148" fieldSourceType="DBColumn" dataType="Float" name="P_DEBTOR_SEGMENT_ID" fieldSource="P_DEBTOR_SEGMENT_ID" PathID="CustomerFormP_DEBTOR_SEGMENT_ID">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Action actionName="Custom Code" actionCategory="General" id="334"/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="p_customer_master.php" forShow="True" url="p_customer_master.php" comment="//" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="p_customer_master_events.php" forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
