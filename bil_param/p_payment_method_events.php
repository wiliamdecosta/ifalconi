...
function BindEvents()
{
    ...
    $P_PAYMENT_METHOD->Navigator->CCSEvents["BeforeShow"] = "P_PAYMENT_METHOD_Navigator_BeforeShow";
...
//P_PAYMENT_METHOD_Navigator_BeforeShow @76-72A9F320
function P_PAYMENT_METHOD_Navigator_BeforeShow(& $sender)
{
    $P_PAYMENT_METHOD_Navigator_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $P_PAYMENT_METHOD; //Compatibility
//End P_PAYMENT_METHOD_Navigator_BeforeShow
...
//Close P_PAYMENT_METHOD_Navigator_BeforeShow @76-4EDD9830
    return $P_PAYMENT_METHOD_Navigator_BeforeShow;
}
//End Close P_PAYMENT_METHOD_Navigator_BeforeShow
