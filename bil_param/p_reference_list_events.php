...
function BindEvents()
{
    ...
    $p_reference_list1->ds->CCSEvents["BeforeExecuteInsert"] = "p_reference_list1_ds_BeforeExecuteInsert";
    $p_reference_list1->ds->CCSEvents["AfterExecuteInsert"] = "p_reference_list1_ds_AfterExecuteInsert";
...
//p_reference_list1_ds_BeforeExecuteInsert @28-CB265E7E
function p_reference_list1_ds_BeforeExecuteInsert(& $sender)
{
    $p_reference_list1_ds_BeforeExecuteInsert = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_reference_list1; //Compatibility
//End p_reference_list1_ds_BeforeExecuteInsert
...
//Close p_reference_list1_ds_BeforeExecuteInsert @28-020FDC7D
    return $p_reference_list1_ds_BeforeExecuteInsert;
}
//End Close p_reference_list1_ds_BeforeExecuteInsert

//p_reference_list1_ds_AfterExecuteInsert @28-80828388
function p_reference_list1_ds_AfterExecuteInsert(& $sender)
{
    $p_reference_list1_ds_AfterExecuteInsert = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_reference_list1; //Compatibility
//End p_reference_list1_ds_AfterExecuteInsert

//Custom Code @102-2A29BDB7
// -------------------------
    // Write your own code here.
	ob_end_clean();
	if(is_array($p_reference_list1->DataSource->Provider->Error)) {
		$error_msg = $p_reference_list1->DataSource->Provider->Error['message'];
		$p_reference_list1->Errors->addError($error_msg);
	};
// -------------------------
//End Custom Code

//Close p_reference_list1_ds_AfterExecuteInsert @28-3772D91F
    return $p_reference_list1_ds_AfterExecuteInsert;
}
//End Close p_reference_list1_ds_AfterExecuteInsert
