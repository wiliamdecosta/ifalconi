...
UPDATE_DATE = SYSDATE,
UPDATE_BY = '{UPDATE_BY}'
WHERE P_BILL_COMPONENT_ID = {P_BILL_COMPONENT_ID}" customDeleteType="SQL" customDelete="DELETE P_BILL_COMPONENT WHERE P_BILL_COMPONENT_ID = {P_BILL_COMPONENT_ID}" parameterTypeListName="ParameterTypeList" activeCollection="ISQLParameters">
			<Components>
				...
				<Button id="42" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardThemeItem="FooterIMG" wizardButtonImage="ButtonDeleteOn" PathID="P_BILL_COMPONENT1Button_Delete" removeParameters="TAMBAH;s_keyword;P_BILL_COMPONENT_ID">
					<Components/>
					<Events>
