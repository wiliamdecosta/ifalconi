...
WHERE P_ONETIME_TARIFF_SCENARIO_ID={P_ONETIME_TARIFF_SCENARIO_ID}" customDeleteType="SQL" customDelete="DELETE P_ONETIME_TARIFF_SCENARIO WHERE P_ONETIME_TARIFF_SCENARIO_ID={P_ONETIME_TARIFF_SCENARIO_ID}">
			<Components>
				...
				<Button id="47" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardThemeItem="FooterIMG" wizardButtonImage="ButtonDeleteOn" PathID="P_ONETIME_TARIFF_SCENARIO1Button_Delete" removeParameters="TAMBAH;s_keyword;P_ONETIME_TARIFF_SCENARIO_ID">
					<Components/>
					<Events>
