<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="7" connection="Conn" dataSource="SELECT * 
FROM P_REFERENCE_TYPE
WHERE ( UPPER(CODE) LIKE UPPER('%{s_keyword}%')
OR UPPER(REFERENCE_NAME) LIKE UPPER('%{s_keyword}%') ) 
ORDER BY P_REFERENCE_TYPE_ID" name="P_REFERENCE_TYPEGrid" orderBy="P_REFERENCE_TYPE_ID" pageSizeLimit="100" wizardCaption=" P REFERENCE TYPE " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions" activeCollection="TableParameters">
			<Components>
...
WHERE  P_REFERENCE_TYPE_ID = {P_REFERENCE_TYPE_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_REFERENCE_TYPE WHERE P_REFERENCE_TYPE_ID = {P_REFERENCE_TYPE_ID}">
			<Components>
				...
				<TextBox id="38" visible="Yes" fieldSourceType="DBColumn" dataType="Float" name="LISTING_NO" fieldSource="LISTING_NO" required="True" caption="LISTING NO" wizardCaption="LISTING NO" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="P_REFERENCE_TYPEFormLISTING_NO">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="78" variable="UPDATE_BY" parameterType="Session" dataType="Text" parameterSource="UserName"/>
			...
			<USQLParameters>
				...
				<SQLParameter id="91" variable="UPDATE_BY" parameterType="Session" dataType="Text" parameterSource="UserName"/>
