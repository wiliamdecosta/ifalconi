...
//Class_Initialize Event @2-1309FC9A
...
//Class_Initialize Event @25-E954EF35
...
//Operation Method @25-5CC40C76
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "TAMBAH", "s_keyword", "P_BILL_COMPONENT_ID"));
