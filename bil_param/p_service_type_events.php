...
function BindEvents()
{
    ...
    $p_service_type1->ds->CCSEvents["BeforeExecuteInsert"] = "p_service_type1_ds_BeforeExecuteInsert";
    $p_service_type1->ds->CCSEvents["AfterExecuteInsert"] = "p_service_type1_ds_AfterExecuteInsert";
...
//p_service_type1_ds_BeforeExecuteInsert @44-5428614E
function p_service_type1_ds_BeforeExecuteInsert(& $sender)
{
    $p_service_type1_ds_BeforeExecuteInsert = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_service_type1; //Compatibility
//End p_service_type1_ds_BeforeExecuteInsert
...
//Close p_service_type1_ds_BeforeExecuteInsert @44-24AF5AFC
    return $p_service_type1_ds_BeforeExecuteInsert;
}
//End Close p_service_type1_ds_BeforeExecuteInsert

//p_service_type1_ds_AfterExecuteInsert @44-4D7CEB3A
function p_service_type1_ds_AfterExecuteInsert(& $sender)
{
    $p_service_type1_ds_AfterExecuteInsert = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_service_type1; //Compatibility
//End p_service_type1_ds_AfterExecuteInsert
...
// -------------------------
	...
	ob_end_clean();
	//exit;
	if(is_array($p_service_type1->DataSource->Provider->Error)) {
		$error_msg = $p_service_type1->DataSource->Provider->Error['message'];
		$p_service_type1->Errors->addError($error_msg);
	};
// -------------------------
//End Custom Code

//Close p_service_type1_ds_AfterExecuteInsert @44-4EC4F42F
    return $p_service_type1_ds_AfterExecuteInsert;
}
//End Close p_service_type1_ds_AfterExecuteInsert
