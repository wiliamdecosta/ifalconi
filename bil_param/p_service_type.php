...
//Prepare Method @2-71887A9F
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urlP_SERVICE_GROUP_ID", ccsFloat, "", "", $this->Parameters["urlP_SERVICE_GROUP_ID"], 0, false);
    }
//End Prepare Method

//Open Method @2-6B64D431
    function Open()
    {
        ...
        "and a.P_SERVICE_GROUP_ID = " . $this->SQLValue($this->wp->GetDBValue("2"), ccsFloat) . "\n" .
        "AND (UPPER(a.CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        "OR UPPER(a.SERVICE_NAME) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
...
//Class_Initialize Event @44-CE9855B2
...
//CheckErrors Method @44-0EB50743
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @44-78F229DD
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @44-EEAF38D8
