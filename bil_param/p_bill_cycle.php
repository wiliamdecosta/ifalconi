<?php
//Include Common Files @1-26D28F52
define("RelativePath", "..");
...
//Class_Initialize Event @2-70B27768
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->DLink->Parameters = CCGetQueryString("QueryString", array("klik", "ccsForm"));
...
//DataSource Variables @2-83D4AEB1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-262407DD
...
//Open Method @2-2999D78D
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT *FROM P_BILL_CYCLE\n" .
        "where upper(code) like upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') or\n" .
        "	day_treshold like upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') or\n" .
        "	day_2 like upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') or\n" .
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_bill_cycle.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
//Update Method @38-18FEC5D3
    function Update()
    {
        ...
        "DAY_TRESHOLD = " . $this->SQLValue($this->cp["DAY_TRESHOLD"]->GetDBValue(), ccsFloat) . ",\n" .
        "DAY_2 = " . $this->SQLValue($this->cp["DAY_2"]->GetDBValue(), ccsFloat) . ",\n" .
        "UPDATE_DATE=sysdate,\n" .
