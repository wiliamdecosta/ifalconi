<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\bil_param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Apricot" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" dataSource="SELECT *FROM P_BILL_CYCLE
where upper(code) like upper('%{s_keyword}%') or
	day_treshold like upper('%{s_keyword}%') or
	day_2 like upper('%{s_keyword}%') or
	upper(description) like upper('%{s_keyword}%')" name="P_BILL_CYCLE" orderBy="P_BILL_CYCLE_ID" pageSizeLimit="100" wizardCaption=" P BILL CYCLE " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data Tidak Ditemukan" pasteActions="pasteActions">
			<Components>
				...
				<Label id="34" fieldSourceType="DBColumn" dataType="Date" html="False" name="UPDATE_DATE" fieldSource="UPDATE_DATE" wizardCaption="UPDATED DATE" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="P_BILL_CYCLEUPDATE_DATE" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Link id="107" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" dataType="Text" wizardDefaultValue="DLink" hrefSource="p_bill_cycle.ccp" wizardThemeItem="GridA" PathID="P_BILL_CYCLEDLink" removeParameters="klik">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="108" sourceType="DataField" format="yyyy-mm-dd" name="P_BILL_CYCLE_ID" source="P_BILL_CYCLE_ID"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="P_BILL_CYCLESearch" wizardCaption=" P BILL CYCLE " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="p_bill_cycle.ccp" PathID="P_BILL_CYCLESearch" pasteActions="pasteActions">
			<Components>
				...
				<Button id="109" urlType="Relative" enableValidation="True" isDefault="False" name="Button_DoSearch" operation="Search" wizardCaption="Search" PathID="P_BILL_CYCLESearchButton_DoSearch" wizardTheme="sikm" wizardThemeVersion="3.0" removeParameters="FLAG;p_application_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE  P_BILL_CYCLE_ID = {P_BILL_CYCLE_ID}" customDeleteType="SQL" customDelete="DELETE FROM P_BILL_CYCLE WHERE P_BILL_CYCLE_ID = {P_BILL_CYCLE_ID}">
			...
			<USQLParameters>
				...
				<SQLParameter id="101" variable="DAY_TRESHOLD" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="DAY_TRESHOLD"/>
				<SQLParameter id="102" variable="DAY_2" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="DAY_2"/>
