<?php
//BindEvents Method @1-E9D3E057
function BindEvents()
{
    global $V_T_BILL_ON_DEMAND_UNPROCESSEDGrid;
    global $CCSEvents;
    $V_T_BILL_ON_DEMAND_UNPROCESSEDGrid->CCSEvents["BeforeShowRow"] = "V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow";
...
//V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow @282-42528313
function V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow(& $sender)
{
    $V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_T_BILL_ON_DEMAND_UNPROCESSEDGrid; //Compatibility
//End V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow
...
//Close V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow @282-EF1BA736
    return $V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow;
}
//End Close V_T_BILL_ON_DEMAND_UNPROCESSEDGrid_BeforeShowRow

//Page_BeforeShow @1-EC3FD6C2
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_T_BILL_ON_DEMAND_UNPROCESSED; //Compatibility
//End Page_BeforeShow
