<?php
//Include Common Files @1-62693A1C
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_process/");
define("FileName", "V_T_BILL_ON_DEMAND_CANCELLED.php");
...
class clsGridV_T_BILL_ON_DEMAND_CANCELLEDGrid { //V_T_BILL_ON_DEMAND_CANCELLEDGrid class @282-BF6E6D28
...
//Class_Initialize Event @282-69AFE6A3
    function clsGridV_T_BILL_ON_DEMAND_CANCELLEDGrid($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "V_T_BILL_ON_DEMAND_CANCELLEDGrid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid V_T_BILL_ON_DEMAND_CANCELLEDGrid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsV_T_BILL_ON_DEMAND_CANCELLEDGridDataSource($this);
...
} //End V_T_BILL_ON_DEMAND_CANCELLEDGrid Class @282-FCB6E20C

class clsV_T_BILL_ON_DEMAND_CANCELLEDGridDataSource extends clsDBConn {  //V_T_BILL_ON_DEMAND_CANCELLEDGridDataSource Class @282-B9992A16
...
//DataSourceClass_Initialize Event @282-0F505565
    function clsV_T_BILL_ON_DEMAND_CANCELLEDGridDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid V_T_BILL_ON_DEMAND_CANCELLEDGrid";
        $this->Initialize();
...
} //End V_T_BILL_ON_DEMAND_CANCELLEDGridDataSource Class @282-FCB6E20C

//Initialize Page @1-13876253
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "V_T_BILL_ON_DEMAND_CANCELLED.html";
$BlockToParse = "main";
...
//Include events file @1-C6B673B7
include_once("./V_T_BILL_ON_DEMAND_CANCELLED_events.php");
...
// Controls
$V_T_BILL_ON_DEMAND_CANCELLEDGrid = & new clsGridV_T_BILL_ON_DEMAND_CANCELLEDGrid("", $MainPage);
$MainPage->V_T_BILL_ON_DEMAND_CANCELLEDGrid = & $V_T_BILL_ON_DEMAND_CANCELLEDGrid;
$V_T_BILL_ON_DEMAND_CANCELLEDGrid->Initialize();
...
//Go to destination page @1-ABA082D1
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($V_T_BILL_ON_DEMAND_CANCELLEDGrid);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-E8272E5A
$V_T_BILL_ON_DEMAND_CANCELLEDGrid->Show();
$Tpl->block_path = "";
