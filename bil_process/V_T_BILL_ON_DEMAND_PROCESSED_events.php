<?php
//BindEvents Method @1-3AD5E1BA
function BindEvents()
{
    global $V_T_BILL_ON_DEMAND_PROCESSEDGrid;
    global $CCSEvents;
    $V_T_BILL_ON_DEMAND_PROCESSEDGrid->CCSEvents["BeforeShowRow"] = "V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow";
...
//V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow @282-A0035921
function V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow(& $sender)
{
    $V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_T_BILL_ON_DEMAND_PROCESSEDGrid; //Compatibility
//End V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow
...
//Close V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow @282-6AA6C168
    return $V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow;
}
//End Close V_T_BILL_ON_DEMAND_PROCESSEDGrid_BeforeShowRow

//Page_BeforeShow @1-58DC2E68
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_T_BILL_ON_DEMAND_PROCESSED; //Compatibility
//End Page_BeforeShow
