<?php
//Include Common Files @1-9B6EFF52
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_process/");
define("FileName", "process_billing_period.php");
...
//Operation Method @3-1D141FF8
    function Operation()
    {
        ...
        $Redirect = "process_billing_period.php" . "?" . CCGetQueryString("All", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "process_billing_period.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "TAMBAH", "BATCH_CONTROL_ID")), CCGetQueryString("QueryString", array("s_keyword", "ccsForm", "TAMBAH", "BATCH_CONTROL_ID")));
...
//Class_Initialize Event @19-33FA2ECC
...
//CheckErrors Method @19-7B4DB8DA
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @19-781C3B00
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @19-2EBC0655
...
//Class_Initialize Event @282-0EC33582
    function clsGridV_INPUT_DATA_CONTROL_BILL($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "process_billing_period.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "process_billing_period.php";
        ...
        $this->BATCH_Insert1->Page = "process_billing_period.php";
    }
//End Class_Initialize Event
...
//Show Method @282-B4AC36A0
    function Show()
    {
        ...
        $this->BATCH_Insert1->Parameters = CCGetQueryString("QueryString", array("T_BUDGET_ID", "FLAG", "s_keyword", "ccsForm"));
...
//Prepare Method @282-C9B6DC45
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urls_keyword", ccsFloat, "", "", $this->Parameters["urls_keyword"], "", false);
        $this->wp->AddParameter("2", "urls_keyword", ccsFloat, "", "", $this->Parameters["urls_keyword"], "", false);
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "BILL_AMT", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsFloat),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "FINANCE_PERIOD_CODE", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "process_billing_period.html";
$BlockToParse = "main";
...
//Include events file @1-1DAABD08
include_once("./process_billing_period_events.php");
