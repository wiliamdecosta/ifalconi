...
WHERE  INPUT_DATA_CONTROL_ID = {INPUT_DATA_CONTROL_ID}">
			<Components>
				...
				<TextBox id="218" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="FINANCE_PERIOD_CODE" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="BATCH1FINANCE_PERIOD_CODE" fieldSource="FINANCE_PERIOD_CODE" required="False">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Link id="395" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="BATCH_Close" hrefSource="closing_billing.ccp" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="BATCH1BATCH_Close" fieldSource="INPUT_DATA_CONTROL_ID">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
					...
					<LinkParameters>
						<LinkParameter id="397" sourceType="DataField" name="INPUT_DATA_CONTROL_ID" source="INPUT_DATA_CONTROL_ID"/>
						<LinkParameter id="398" sourceType="Expression" name="actionClose" source="1"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
		...
		<Grid id="282" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Conn" name="V_INPUT_DATA_CONTROL_BILL" pageSizeLimit="100" wizardCaption=" V INPUT DATA CONTROL BILL " wizardGridType="Tabular" wizardAllowInsert="False" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="Data not found" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="SELECT * 
FROM v_idc_bill_close
WHERE BATCH_TYPE LIKE '%{s_keyword}%' OR
	FINANCE_PERIOD_CODE LIKE '%{s_keyword}%' OR
	to_char(INVOICE_DATE,'dd-MON-yyyy') LIKE '%{s_keyword}%' OR
	BILL_CYCLE_CODE LIKE '%{s_keyword}%' OR
	BILL_STATUS LIKE '%{s_keyword}%' OR
	BILL_AMT = '{s_keyword}' OR
	TO_CHAR(CLOSING_DATE,'dd-MON-yyyy') LIKE '%{s_keyword}%'
">
			<Components>
				...
				<Link id="52" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="V_INPUT_DATA_CONTROL_BILLDLink" hrefSource="closing_billing.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="INPUT_DATA_CONTROL_ID">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="54" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="V_INPUT_DATA_CONTROL_BILLADLink" hrefSource="closing_billing.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="INPUT_DATA_CONTROL_ID">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="318" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="BATCH_Insert1" hrefSource="closing_billing.ccp" removeParameters="INPUT_DATA_CONTROL_ID;FLAG;s_keyword" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="V_INPUT_DATA_CONTROL_BILLBATCH_Insert1" fieldSource="INPUT_DATA_CONTROL_ID">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="closing_billing_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="closing_billing.php" forShow="True" url="closing_billing.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
